...
glabel DrawBackground__25tScreenCarSelectTwoPlayer
  ...
  .L8003E71C:
    ...
    /* 2EF34 8003E734 0580023C */  lui        $v0, %hi(showRoomFlag)
    /* 2EF38 8003E738 601240AC */  sw         $zero, %lo(showRoomFlag)($v0)
  ...
  .L8003E77C:
    ...
    /* 2EFAC 8003E7AC 0580023C */  lui        $v0, %hi(showRoomFlag)
    /* 2EFB0 8003E7B0 601240AC */  sw         $zero, %lo(showRoomFlag)($v0)
