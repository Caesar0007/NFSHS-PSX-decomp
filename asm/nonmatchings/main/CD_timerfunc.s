...
glabel CD_timerfunc
    ...
    /* EA470 800F9C70 1080043C */  lui        $a0, %hi(CD_systaskfunc)
    /* EA474 800F9C74 E89A8424 */  addiu      $a0, $a0, %lo(CD_systaskfunc)
    ...
    /* EA488 800F9C88 1080043C */  lui        $a0, %hi(CD_timerfunc)
    /* EA48C 800F9C8C 12AC030C */  jal        deltimer
    /* EA490 800F9C90 449C8424 */   addiu     $a0, $a0, %lo(CD_timerfunc)
  .L800F9C94:
