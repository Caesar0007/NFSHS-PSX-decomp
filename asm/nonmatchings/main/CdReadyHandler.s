...
nonmatching CdReadyHandler, 0x4B0

glabel CdReadyHandler
    ...
    /* EA4E8 800F9CE8 1080043C */  lui        $a0, %hi(CD_timerfunc)
    /* EA4EC 800F9CEC 12AC030C */  jal        deltimer
    /* EA4F0 800F9CF0 449C8424 */   addiu     $a0, $a0, %lo(CD_timerfunc)
    /* EA4F4 800F9CF4 1080043C */  lui        $a0, %hi(CD_systaskfunc)
    /* EA4F8 800F9CF8 E89A8424 */  addiu      $a0, $a0, %lo(CD_systaskfunc)
  ...
  .L800F9F48:
    ...
    /* EA764 800F9F64 1080043C */  lui        $a0, %hi(CD_timerfunc)
    /* EA768 800F9F68 0C00228E */  lw         $v0, 0xC($s1)
    /* EA76C 800F9F6C 449C8424 */  addiu      $a0, $a0, %lo(CD_timerfunc)
  ...
  .L800FA12C:
    /* EA92C 800FA12C 1080043C */  lui        $a0, %hi(CdReadyHandler)
    /* EA930 800FA130 28DE030C */  jal        CdReadyCallback
    /* EA934 800FA134 A49C8424 */   addiu     $a0, $a0, %lo(CdReadyHandler)
  .L800FA138:
