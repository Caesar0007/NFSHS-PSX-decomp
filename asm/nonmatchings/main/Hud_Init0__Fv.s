...
glabel Hud_Init0__Fv
    ...
    /* C3310 800D2B10 BC1882AF */  sw         $v0, %gp_rel(gSprite0)($gp)
    /* C3314 800D2B14 1180023C */  lui        $v0, %hi(GameSetup_gData+0xc)
    /* C3318 800D2B18 F831438C */  lw         $v1, %lo(GameSetup_gData+0xc)($v0)
    ...
    /* C3338 800D2B38 C01882AF */  sw         $v0, %gp_rel(gSprite1)($gp)
  .L800D2B3C:
