...
glabel Hud_Kill__Fv
    ...
    /* C32B4 800D2AB4 BC18848F */  lw         $a0, %gp_rel(gSprite0)($gp)
  ...
  .L800D2ACC:
    /* C32CC 800D2ACC C018848F */  lw         $a0, %gp_rel(gSprite1)($gp)
    /* C32D0 800D2AD0 BC1880AF */  sw         $zero, %gp_rel(gSprite0)($gp)
  ...
  .L800D2AE4:
    ...
    /* C32E8 800D2AE8 C01880AF */  sw         $zero, %gp_rel(gSprite1)($gp)
