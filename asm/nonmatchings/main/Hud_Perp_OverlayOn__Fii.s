...
glabel Hud_Perp_OverlayOn__Fii
    ...
    /* CA128 800D9928 1480023C */  lui        $v0, %hi(PerpOverlayOn)
    /* CA12C 800D992C 38DE4224 */  addiu      $v0, $v0, %lo(PerpOverlayOn)
    /* CA130 800D9930 21108200 */  addu       $v0, $a0, $v0
    /* CA134 800D9934 01000324 */  addiu      $v1, $zero, 0x1
    /* CA138 800D9938 000043AC */  sw         $v1, 0x0($v0)
    /* CA13C 800D993C 1480023C */  lui        $v0, %hi(PerpOverlayMessage)
    /* CA140 800D9940 40DE4224 */  addiu      $v0, $v0, %lo(PerpOverlayMessage)
