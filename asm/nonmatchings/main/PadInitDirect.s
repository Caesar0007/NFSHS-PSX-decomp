...
glabel PadInitDirect
    ...
    /* EE560 800FDD60 1080023C */  lui        $v0, %hi(_pad_failall)
    /* EE564 800FDD64 F0DE4224 */  addiu      $v0, $v0, %lo(_pad_failall)
    /* EE568 800FDD68 1380013C */  lui        $at, %hi(_padFuncNextPort)
    /* EE56C 800FDD6C 787C22AC */  sw         $v0, %lo(_padFuncNextPort)($at)
    /* EE570 800FDD70 1080023C */  lui        $v0, %hi(_pad_reset_state)
    /* EE574 800FDD74 88DE4224 */  addiu      $v0, $v0, %lo(_pad_reset_state)
    /* EE578 800FDD78 1380013C */  lui        $at, %hi(_padFuncClrInfo)
    /* EE57C 800FDD7C 7C7C22AC */  sw         $v0, %lo(_padFuncClrInfo)($at)
    /* EE580 800FDD80 1080023C */  lui        $v0, %hi(_pad_getbyte)
    /* EE584 800FDD84 F4DF4224 */  addiu      $v0, $v0, %lo(_pad_getbyte)
    /* EE588 800FDD88 1380013C */  lui        $at, %hi(_padFuncGetTxd)
    /* EE58C 800FDD8C 807C22AC */  sw         $v0, %lo(_padFuncGetTxd)($at)
    /* EE590 800FDD90 1080023C */  lui        $v0, %hi(_pad_filter)
    /* EE594 800FDD94 B0E04224 */  addiu      $v0, $v0, %lo(_pad_filter)
    /* EE598 800FDD98 1380013C */  lui        $at, %hi(_padFuncCurrLimit)
    /* EE59C 800FDD9C 847C22AC */  sw         $v0, %lo(_padFuncCurrLimit)($at)
    /* EE5A0 800FDDA0 1080023C */  lui        $v0, %hi(_pad_port_to_slot)
    /* EE5A4 800FDDA4 2CE34224 */  addiu      $v0, $v0, %lo(_pad_port_to_slot)
    /* EE5A8 800FDDA8 1380013C */  lui        $at, %hi(_padFuncPtr2Port)
    /* EE5AC 800FDDAC 887C22AC */  sw         $v0, %lo(_padFuncPtr2Port)($at)
    /* EE5B0 800FDDB0 1080023C */  lui        $v0, %hi(_pad_get_port)
    /* EE5B4 800FDDB4 64E34224 */  addiu      $v0, $v0, %lo(_pad_get_port)
    /* EE5B8 800FDDB8 1380013C */  lui        $at, %hi(_padFuncPort2Info)
    /* EE5BC 800FDDBC 8C7C22AC */  sw         $v0, %lo(_padFuncPort2Info)($at)
    /* EE5C0 800FDDC0 1080023C */  lui        $v0, %hi(_pad_shift)
    /* EE5C4 800FDDC4 E4DF4224 */  addiu      $v0, $v0, %lo(_pad_shift)
