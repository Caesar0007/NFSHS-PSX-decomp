...
glabel _padInitDirSeq
    /* FA8B0 8010A0B0 1180023C */  lui        $v0, %hi(_dirSendAuto)
    /* FA8B4 8010A0B4 E4A04224 */  addiu      $v0, $v0, %lo(_dirSendAuto)
    /* FA8B8 8010A0B8 1380013C */  lui        $at, %hi(_padFuncSendAuto)
    /* FA8BC 8010A0BC 907C22AC */  sw         $v0, %lo(_padFuncSendAuto)($at)
    /* FA8C0 8010A0C0 1180023C */  lui        $v0, %hi(_dirCheck)
    /* FA8C4 8010A0C4 10A54224 */  addiu      $v0, $v0, %lo(_dirCheck)
    /* FA8C8 8010A0C8 1380013C */  lui        $at, %hi(_padFuncChkEng)
    /* FA8CC 8010A0CC 947C22AC */  sw         $v0, %lo(_padFuncChkEng)($at)
    /* FA8D0 8010A0D0 1180023C */  lui        $v0, %hi(_dirRecvAuto)
    /* FA8D4 8010A0D4 E4A14224 */  addiu      $v0, $v0, %lo(_dirRecvAuto)
