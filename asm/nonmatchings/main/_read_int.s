...
glabel _read_int
    ...
    /* F9134 80108934 1180043C */  lui        $a0, %hi(_read_data_int)
    /* F9138 80108938 2CDF030C */  jal        CdDataCallback
    /* F913C 8010893C 248B8424 */   addiu     $a0, $a0, %lo(_read_data_int)
  ...
  .L80108A18:
    ...
    /* F923C 80108A3C FD22040C */  jal        _read_issue
  ...
  .L80108AC8:
    /* F92C8 80108AC8 1180043C */  lui        $a0, %hi(_read_sync)
    /* F92CC 80108ACC 23DE030C */  jal        CdSyncCallback
    /* F92D0 80108AD0 7C888424 */   addiu     $a0, $a0, %lo(_read_sync)
