...
nonmatching func_800F9AE8, 0x15C

glabel func_800F9AE8
  ...
  .L800F9B78:
    ...
    /* EA37C 800F9B7C 1080043C */   lui       $a0, %hi(func_800F9AE8)
    /* EA380 800F9B80 EA9A030C */  jal        delsystemtask
    /* EA384 800F9B84 E89A8424 */   addiu     $a0, $a0, %lo(func_800F9AE8)
    ...
    /* EA3EC 800F9BEC 1080043C */  lui        $a0, %hi(func_800F9CA4)
    /* EA3F0 800F9BF0 28DE030C */  jal        CdReadyCallback
    /* EA3F4 800F9BF4 A49C8424 */   addiu     $a0, $a0, %lo(func_800F9CA4)
    ...
    /* EA408 800F9C08 1080043C */  lui        $a0, %hi(func_800F9C44)
    /* EA40C 800F9C0C C4DC438C */  lw         $v1, %lo(timerhz)($v0)
    /* EA410 800F9C10 449C8424 */  addiu      $a0, $a0, %lo(func_800F9C44)
