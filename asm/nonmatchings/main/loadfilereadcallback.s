...
nonmatching loadfilereadcallback, 0xD4

glabel loadfilereadcallback
  ...
  .L800F0DCC:
    ...
    /* E15E4 800F0DE4 0F80053C */  lui        $a1, %hi(loadfileclosecallback)
    /* E15E8 800F0DE8 8FC30308 */  j          .L800F0E3C
    /* E15EC 800F0DEC 240DA524 */   addiu     $a1, $a1, %lo(loadfileclosecallback)
  .L800F0DF0:
    ...
    /* E1634 800F0E34 0F80053C */  lui        $a1, %hi(loadfilereadcallback)
    /* E1638 800F0E38 800DA524 */  addiu      $a1, $a1, %lo(loadfilereadcallback)
  .L800F0E3C:
