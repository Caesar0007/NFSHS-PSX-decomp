/* eaclib/psx/eacpsxz/asintbl.c -- data-only archive member proven by NFS4 SYM. */
#include "../eaclib_types.h"
#include "eac_types.h"
#include "asintbl.h"

/* 513 entries: index 512 = asin(1.0) = 0x100, which wraps to 0x00 in a byte -- retail asintbl.obj .data is 0x204 bytes
 * (sintbl follows at 0x80137464), the last entry was a filler word before 2026-09-21. */
unsigned char asintbl[513] = { /* @0x80137260 */
