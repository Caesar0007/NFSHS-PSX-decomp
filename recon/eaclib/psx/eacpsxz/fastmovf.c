...
extern int DAT_801486e8;   /* @0x801486E8 : draw-origin X (int view) */
extern int DAT_801486ec;   /* @0x801486EC : draw-origin Y (int view) */
extern int DAT_801486fc;   /* @0x801486FC : clip window left   */
extern int DAT_80148700;   /* @0x80148700 : clip window top    */
extern int DAT_80148704;   /* @0x80148704 : clip window right  */
extern int DAT_80148708;   /* @0x80148708 : clip window bottom */
...
extern int fastmovfxya(int shape, int x, int y)
{
    ...
    if ((0 < w) && (0 < h)) {
        ...
        __asm__ volatile(
            ...
            "\tswl\t$t6,2(%1)\n"
            "\tswl\t$t7,2(%0)"
            : : "r"(ret), "r"(p), "r"(*(char *volatile *)&nextprim)
            : "$14", "$15", "memory");
        nextprim = p;
    }
    return ret;
