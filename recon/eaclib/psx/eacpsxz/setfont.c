...
extern int      DAT_80135c1c;   /* @0x80135C1C : +0x7c  (=100, default tab/space metric) */
extern int      DAT_80135bac;   /* @0x80135BAC : +0x0c  metric i8[0x10] */
extern int      DAT_80135bb0;   /* @0x80135BB0 : +0x10  metric i8[0x11] */
extern int      DAT_80135bbc;   /* @0x80135BBC : +0x1c  metric i8[0x12] */
extern int      DAT_80135bc0;   /* @0x80135BC0 : +0x20  metric i8[0x13] */
extern int      DAT_80135bc4;   /* @0x80135BC4 : +0x24  i8[0x13]+i8[0x12] */
extern int      DAT_80135bc8;   /* @0x80135BC8 : +0x28  i8[0x13]+i8[0x12] */
extern int      DAT_80135bb8;   /* @0x80135BB8 : +0x18  (=1) */
extern int      DAT_80135c50;   /* @0x80135C50 : +0xb0 */
extern int      DAT_80135c4c;   /* @0x80135C4C : +0xac */
extern int      DAT_80135c20;   /* @0x80135C20 : +0x80  font header ptr */
extern unsigned char *DAT_80135c28; /* @0x80135C28 : +0x88  glyph bitmap (shape) ptr */
extern int      DAT_80135c14;   /* @0x80135C14 : +0x74  glyph count */
extern int      DAT_80135c24;   /* @0x80135C24 : +0x84  glyph table base */
extern int      DAT_80135bb4;   /* @0x80135BB4 : +0x14  bitmap depth (bits/pixel) */
extern int      DAT_80135c18;   /* @0x80135C18 : +0x78  bitmap row stride (bytes) */
extern int      DAT_80135bcc;   /* @0x80135BCC : +0x2c */
extern int      DAT_80135bd0;   /* @0x80135BD0 : +0x30 */
extern int      DAT_80135c54;   /* @0x80135C54 : +0xb4 */
extern DecodeFn DAT_80135c40;   /* @0x80135C40 : +0xa0  selected glyph decoder */
DecodeFn DAT_80135c40;              /* definition (runtime-set; NULL at load). Owned here (DecodeFn TU-local). */
extern int      DAT_80135c44;   /* @0x80135C44 : +0xa4 */
extern unsigned char DAT_80135bd4[0x40]; /* @0x80135BD4 : +0x34  0x40-byte blit state buffer */

extern DecodeFn setfont(int fontId);   /* @0x800F2E94 */

/* setfont @0x800F2E94 : install font header `fontId` as the current text font; returns its glyph decoder. */
extern DecodeFn setfont(int fontId)
{
    unsigned char *shape;
    DecodeFn       decode;
    int            depth;
