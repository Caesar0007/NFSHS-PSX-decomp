 ...
 */
extern "C" const int sintbl[257];   /* @0x80137464 : quarter-sine table, 16.16 (blob-owned) */
...
extern "C" int intsin(int a)   /* @0x800F18E8 */
{
    int pos = a & 0xFF;
    if (a & 0x200) {                          /* quad 2/3 */
...
extern "C" int intcos(int a)   /* @0x800F18E4 : a += 90deg, fall into sin */
{
    return intsin(a + 0x100);
}
extern "C" int fastintcos(int a) __attribute__((alias("intcos")));
extern "C" int fastintsin(int a) __attribute__((alias("intsin")));
#endif
