...
extern int *iSNDmulu64(int *out, unsigned int a, unsigned int b);             /* @0x80103424 */
extern int  iSNDdivu64(unsigned int hi, unsigned int lo, unsigned int div);   /* @0x801034C0 */

/* iSNDmulu64 @0x80103424 : out[0..1] = a * b (64-bit), via 16-bit partial products. */
extern int *iSNDmulu64(int *out, unsigned int a, unsigned int b)
{
...
extern int iSNDdivu64(unsigned int hi, unsigned int lo, unsigned int div)
{
    int q = 0;
    int i = 0x1f;
    do {
