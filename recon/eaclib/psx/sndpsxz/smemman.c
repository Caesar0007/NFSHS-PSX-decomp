...
extern int            sndmm;            /* pool base (byte address) */
extern short          DAT_80148784;     /* live allocation count    */
extern short          DAT_80148786;     /* pool size in words       */
extern int            DAT_80148788;     /* high-water mark (words)   */
extern unsigned short DAT_8014878c;     /* {block,size}[] entry table */
extern void           trap(unsigned int code);

extern int  iSNDmemconstrain(int *block, int *size);   /* @0x801061A8 */
...
extern int iSNDmemconstrain(int *block, int *size)
{
