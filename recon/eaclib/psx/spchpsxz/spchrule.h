...
extern int  iSPCH_GetRuleDataAddr(VoxEvent *event);                            /* @0x8010B140 : rule bytes after the sentence table */
extern int  iSPCH_SentenceUsesParm(VoxSentence *sentence, unsigned int paramIdx); /* @0x8010B158 */
extern unsigned int iSPCH_GetRuleID(VoxEvent *event, int index);               /* @0x8010B220 */
