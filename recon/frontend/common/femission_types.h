/* Owner-specific type surface for FEMission.obj, reconstructed from the
 * retail SYM graph.  The object retains the common drawing/header graph plus
 * the mission, garage, menu-base, and front-end records below. */
...
struct GameSetup_tUserSetting {
    ...
    int engineLevel, speechLevel, ambientLevel, interactive, numplaylistsongs;
    int playlist[40];
};
...
struct GameSetup_tControllerData {
    int controllerConfig[2], deadSpot[2], steeringRange[2], IImaxRange[2];
    int ImaxRange[2], J1MIN[2], J1MAX[2], J2MIN[2], J2MAX[2];
