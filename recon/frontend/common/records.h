/* frontend/common/records.h -- header for the essentially-empty Records translation unit.
 * Records.obj contributes no real code/data (only a 4-byte PSYLINK module-boundary marker);
