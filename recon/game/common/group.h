 ...
 * method-form `Name__15SerializedGroup...`, so they are NOT free functions.
 * Call them as `group->LocateGroupType(type, index)` etc. This header is kept
 * only for the include-path convention; there are no free-fn prototypes. */
