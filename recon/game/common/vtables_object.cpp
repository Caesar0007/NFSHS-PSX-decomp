...
/* Retail object.obj .rdata order (g++ finish_file walks the vtable list newest
 * class first = REVERSE declaration order): ObjectSignAnim 0x80056088,
 * ObjectFinishedSignAnim 0x800560a0, ObjectMultiAnim 0x800560b8,
 * ObjectFinishedMultiAnim 0x800560d0, ObjectAnim 0x800560e8.  Definition order
 * here IS the emission order (initialized globals are emitted at their
 * definition point), so keep it. */
