...
__vtbl_ptr_type tListIteratorCarColor_vtable[6] = {   /* @0x800101d8 */
  ...
  {0, 0, (int (*)(...))&___21tListIteratorCarColor},    /* @0x800101e0  ~tListIteratorCarColor */
...
__vtbl_ptr_type tListIteratorCar_vtable[6] = {   /* @0x80010208 */
  ...
  {0, 0, (int (*)(...))&___16tListIteratorCar},    /* @0x80010210  ~tListIteratorCar */
...
__vtbl_ptr_type tListIteratorTrack_vtable[6] = {   /* @0x80010fe8 */
  ...
  {0, 0, (int (*)(...))&___18tListIteratorTrack},    /* @0x80010ff0  ~tListIteratorTrack */
