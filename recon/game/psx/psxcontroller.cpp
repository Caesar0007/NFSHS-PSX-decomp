...
int mappings[3][13][3] = {
  { {0x800000,-0x80000000,0x80}, {0x200000,0x20000000,0x20}, {0x4000,0x4000,0x4000}, {0x8000,0x8000,0x8000},
    {0x2000,0x2000,0x2000}, {0x10,0x800,0x800}, {0x40,0x200,0x200}, {0x1000,0x1000,0x1000}, {0x800,0x100,0x100},
    {0x80,0x10,0x10}, {0x10,0x10,0x10}, {0x400,0x400,0x400}, {0x20,0x1,0x1} },
  { {0x800000,-0x80000000,0x80}, {0x200000,0x20000000,0x20}, {0x4000,0x10000000,0x8000}, {0x8000,0x40000000,0x4000},
    {0x2000,0x2000,0x2000}, {0x10,0x100000,0x800}, {0x40,0x400000,0x200}, {0x1000,0x1000,0x1000}, {0x20,0x100,0x100},
    {0x80,0x10,0x10}, {0x10,0x10,0x10}, {0x400,0x400,0x400}, {0x800,0x1,0x1} },
  { {0x800000,-0x80000000,0x80}, {0x200000,0x20000000,0x20}, {0x8000,0x4000,0x4000}, {0x4000,0x8000,0x8000},
    {0x2000,0x2000,0x2000}, {0x10,0x200,0x200}, {0x40,0x100,0x100}, {0x1000,0x1000,0x1000}, {0x800,0x800,0x800},
    {0x80,0x10,0x10}, {0x10,0x10,0x10}, {0x400,0x400,0x400}, {0x20,0x1,0x1} },
};
static int hoff[2] = { 0x4d, 1 };
