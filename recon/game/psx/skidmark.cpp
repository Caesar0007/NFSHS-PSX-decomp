...
/* Retail skidmark.obj opens .rodata with this unreferenced class tag. */
...
/* SYM-STORAGE-PROOF (P439): the former Skid_gCtrlPoint_*, Skid_gCtrlScratch_*,
   and Skid_gScratchPos* declarations were Ghidra names for Draw_kCtrlSkidmark's
   literal 0x1f8000xx scratchpad fields, not Skidmark.obj storage.  They have no
   SYM/MAP/config record and no compiled reference; the fixed-address Draw_DCache
   views in draww.cpp now own every real access.  Do not recreate BSS aliases here. */
