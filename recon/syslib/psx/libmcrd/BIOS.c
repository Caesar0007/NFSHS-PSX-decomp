...
extern int funcEvSpIOE(void)      { _card_evflag[0] = 1; return 0; }   /* @0x80109550 */
extern int funcEvSpError(void)    { _card_evflag[1] = 1; return 0; }   /* @0x80109564 */
extern int funcEvSpTimeout(void)  { _card_evflag[2] = 1; return 0; }   /* @0x80109578 */
extern int funcEvSpNewcard(void)  { _card_evflag[3] = 1; return 0; }   /* @0x8010958C */
extern int funcEvSpIOEx(void)     { _card_evflag[4] = 1; return 0; }   /* @0x801095A0 */
extern int funcEvSpErrorx(void)   { _card_evflag[5] = 1; return 0; }   /* @0x801095B4 */
extern int funcEvSpTimeoutx(void) { _card_evflag[6] = 1; return 0; }   /* @0x801095C8 */
extern int funcEvSpNewcardx(void) { _card_evflag[7] = 1; return 0; }   /* @0x801095DC */
