/* NFS4-R-AU CHANGED @80017C0C | base 80017A9C AdjustPosition__16tListIteratorCar7tPlayers */
/* callers: Increment__16tListIteratorCar7tPlayer, Decrement__16tListIteratorCar7tPlayer */
s32 func_800174A4(void *, ?);                       /* extern */
s32 func_8001823C(void *, s32, u8);                 /* extern */

void func_80017C0C(void *arg0, u16 arg1, s32 arg2) {
    u8 sp10;
    u8 sp18;
    s32 temp_s3;
    s32 temp_v1;
    ...
    if (temp_v1 & 0x89) {
        ...
        var_s5 = temp_a0->unk0;
        if (((s16) var_s3 == 1) && ((func_800174A4(temp_a0, 1) << 0x10) <= 0)) {
            var_s1 = arg0->unk14 + 8;
        }
        var_s4_2 = 0;
        if (*var_s1 >= 0) {
...
block_43:
        ...
        if (((sp10 != temp_v1_22) || (((s8) temp_v1_22 < arg0->unk14->unk0) && ((*var_s0 + temp_s3 + 0x801158E4)->unkC0 != sp18))) && ((func_8001823C(arg0, (s32) arg1, *temp_a1_2) ^ 1) != 0)) {
            goto loop_25;
        }
    }
}
