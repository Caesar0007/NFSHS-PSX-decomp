/* NFS4-R-AU CHANGED @80038D58 | base 80038B68 DrawBackground__16tScreenPinkSlips */
? func_80021318(s16, s16, s16, ?, s32, s32);        /* extern */
? func_80021C3C(s32, u8, s8 *);                     /* extern */
s16 func_80021F6C(s32, ?);                          /* extern */
? func_800224E4(void *);                            /* extern */
? func_80025E60(void *, void *);                    /* extern */
? func_80026024(void *, ?);                         /* extern */
? func_800395F4(void *, s8 *);                      /* extern */
? func_800396A0(void *);                            /* extern */
? func_8004C498(?, s16 *, ?);                       /* extern */
? func_8004DBD0(?);                                 /* extern */
? func_8004EC18(?, ?, s32, s16, s32, s32, s32);     /* extern */
? func_8004F1E4(?, ?, ?, s32, s32);                 /* extern */
? func_8004F470(s32, s16, s16, ?, s32, s32);        /* extern */
? func_80051438(s32, ? *);                          /* extern */
? func_80051494(s32);                               /* extern */
s32 func_80051538(s32);                             /* extern */
s32 func_800515E0(s32, ?, u32);                     /* extern */
...
loop_3:
    ...
    if (var_s2 < (s32) (void *)0x801158E4->unk47) {
        ...
        if (var_a1 != 0) {
            temp_v0 = *(s32 *)0x80053140 + 1;
            *(s32 *)0x80053140 = temp_v0;
            if (temp_v0 >= 0x3D) {
                *(s32 *)0x80053140 = 0;
            }
            var_v1 = *(s32 *)0x80053140;
            ...
            if (temp_lo > 0) {
                ...
                func_8004EC18(0x38, 0, sp20 - 0x12, sp22, (s32) arg0->unk5C, 1, 0);
            }
            var_s0 = 2;
        }
        func_80021C3C(0x80115D34, (var_s2 + 0x801158E4)->unk23, &sp28);
        (void *)0x801158E4->unk46 = (u8) var_s2;
        func_80021318(func_80021F6C(*(s32 *)0x80051F98 + 0xC88, -1), (s16) ((u16) sp20 + 0xA), (s16) ((u16) sp22 + 3), 0, var_s0, 1);
        func_8004C498(-1, &sp20, 1);
        var_s2 += 1;
        sp22 = (u16) sp22 + 0xE;
        goto loop_3;
    }
    ...
    func_80021C3C(0x80115D34, ((void *)0x801158E4->unk46 + 0x801158E4)->unk23, &sp28);
    func_800395F4(arg0, &sp28);
    func_80025E60(arg0, arg0 + 0x28);
    if ((arg0->unk2C != 0) && (arg0->unk80 >= 0)) {
        func_80026024(arg0, 4);
        arg0->unk80 = 1;
    ...
    spA8 = temp_s0;
    if (func_80051538(arg0->unk68) != 0) {
        var_s3 = 0;
        if (func_800515E0(arg0->unk68, 0x200, (u32) (temp_s0 << 0x10) >> 0x10) != 0) {
...
loop_27:
        ...
        if ((u32) (*(void *)0x8013EFB8 - arg0->unk7C) >= 0x101U) {
            ...
            func_80051438(arg0->unk68, &sp58);
            var_s2_3 = 0xF0;
            func_80051494(arg0->unk68);
        }
    }
    do {
        func_8004F470(0x303030, var_s2_3, 0xF, 2, 0x81, 1);
        temp_v0_4 = var_s2_3 + 0x50;
        var_s2_3 = temp_v0_4;
    } while (temp_v0_4 < 0x1E0);
    var_s2_4 = 0x4F;
    do {
        func_8004F470(0x202020, 0xA0, var_s2_4, 0x141, 1, 1);
    ...
    var_s2_5 = 0;
    do {
        func_800224E4(arg0 + ((var_s2_5 * 0x30) + 0x84));
