/* NFS4-R-AU CHANGED @800419D8 | base 80041600 DrawBackground__18tScreenTrackSelect */
? func_80021C3C(?, u8, ? *);                        /* extern */
s16 func_80021F6C(s32, ?);                          /* extern */
? func_80025E60(void *, void *);                    /* extern */
? func_80026024(void *, ?);                         /* extern */
? func_800370F8(void *);                            /* extern */
? func_80042148(void *, ?);                         /* extern */
? func_80042178(void *, ? *);                       /* extern */
? func_80042268(void *, ? *);                       /* extern */
? func_800422DC(void *);                            /* extern */
? func_8004C498(s16, s16 *, ?);                     /* extern */
...
void func_800419D8(void *arg0) {
    ...
    sp16 = 0xC;
    sp12 = 0xD0;
    func_8004C498(func_80021F6C(*(s32 *)0x80051F98 + 0xC88, -1), &sp10, 0);
    func_80021C3C(0x80115D34, *(u8 *)0x80115907, &sp18);
    func_80042178(arg0, &sp18);
    func_80042268(arg0, &sp18);
    func_80025E60(arg0, arg0 + 0x28);
    temp_s0 = arg0 + 0x260;
    if ((arg0->unk2C != 0) && (temp_s0->unk14 != -1) && (arg0->unk70 == 0)) {
        func_80026024(arg0, 0xA);
        func_800370F8(temp_s0);
    }
    temp_s0_2 = ((arg0->unk68 & 1) == 0) << 7;
    var_s6 = temp_s0_2;
    temp_v0 = func_80051538(arg0->unk64);
    if (temp_v0 == 1) {
        sp4C = 0xAA;
        sp48 = 0x200;
        sp4A = 0;
        ...
        if (func_800515E0(arg0->unk64, 0x200, (u32) (temp_s0_2 << 0x10) >> 0x10) != 0) {
        ...
        if (arg0->unk72 >= arg0->unk70) {
            ...
            func_80042148(arg0, var_a1);
        }
        func_800E5094(&sp50, 0x80011EA4, *(s32 *)0x801177F0, arg0->unk6E);
        func_80051438(arg0->unk64, &sp50);
        func_80051494(arg0->unk64);
    }
    if (arg0->unk70 > 0) {
