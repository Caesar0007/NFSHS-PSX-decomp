/* NFS4-R-AU CHANGED @800493E4 | base 80048F64 DrawCongratsMessage__23tScreenTournamentTrophy */
? func_80020EE4(? *, ?, s16, ?, s32, s32);          /* extern */
? func_800218D8(s16, ? *, s16 *, ?, s32);           /* extern */
s32 func_80021A60(s16, ? *);                        /* extern */
? func_80026D38(? *, s32);                          /* extern */
? func_80033A88(?, ? *);                            /* extern */
? *func_800B9F1C(s32, s32);                         /* extern */
s32 func_800B9F7C(?);                               /* extern */
? func_800E5094(? *, ? *, ? *);                     /* extern */

void func_800493E4(void *arg0) {
    s16 sp18;
    u16 sp1A;
    s16 sp1C;
    s16 sp1E;
...
block_7:
        ...
        if (var_s2 != 0) {
            func_800218D8(arg0->unk5C, &sp68, &sp18, 2, 0xA);
            sp1A = sp1A - 0xE + func_80021A60(sp1C, &sp68);
        }
        if (var_s3 != 0) {
            sp1C = 0xC8;
            func_800218D8(arg0->unk5C, &sp260, &sp18, 2, 0xA);
        }
        func_80033A88(0x80115DBC, &sp20);
        if (sp40 != 0) {
            sp18 = 0x104;
            sp1A = 0xC8;
            sp1C = 0xF0;
            func_80026D38(&sp558, sp44);
            func_800E5094(&sp458, func_800B9F1C(0x40), &sp558);
            func_800218D8(arg0->unk5C, func_800B9F1C(0x40), &sp18, 1, 0xA);
        }
    } else {
        temp_s0_2 = func_800B9F7C(0x321) + 6;
        func_80020EE4(func_800B9F1C(0x321), 0x120, temp_s0_2, 0x414141, 3, 2);
    }
}
