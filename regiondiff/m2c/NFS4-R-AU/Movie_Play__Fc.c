/* NFS4-R-AU CHANGED @8004D1CC | base 8004CCE4 Movie_Play__Fc */
/* callers: play_movie__Fc */
? func_8004CAF0(s32);                               /* extern */
? func_8004CCC0();                                  /* extern */
? func_8004CE6C(s32);                               /* extern */
s32 func_8004D018();                                /* extern */
? func_8004D14C();                                  /* extern */
? func_8004D15C();                                  /* extern */
s32 func_8004D16C();                                /* extern */
...
s16 func_8004D1CC(s32 arg0) {
    ...
    temp_s0 = arg0 & 0xFF;
    func_8004CAF0(temp_s0);
    func_8004CE6C(temp_s0);
loop_1:
    if ((func_8004D16C() ^ 1) != 0) {
        func_800DCED0();
        if (func_8004D018() != -1) {
            temp_s0_2 = (((void *)0x80053278->unk20 == 0) * 8) + 0x80053278;
            ...
            *(s16 *)0x80052F80 = 1;
            ...
            if ((temp_s0_4 != 0) && ((func_8004D15C(), (*(u8 *)0x80052F7E != 0)) || (temp_s0_4 == 8))) {
                *(s16 *)0x80052F7C = 1;
            }
            goto loop_1;
        }
    ...
    func_8004CCC0();
    func_800EE348(0x80053288, 0, 0, 0);
    func_800EE348(0x80053290, 0, 0, 0);
    func_800EE1C4(0);
    return *(void *)0x80052F7C;
}
