/* NFS4-R-AU CHANGED @80032FF8 | base 80032E30 UpdateTrackFinishPoints__18tTournamentManager */
/* callers: AdvanceToNextTrack__18tTournamentManager */
s16 func_80033740();                                /* extern */
? func_800E6964(void *, s16, ?, ?);                 /* extern */

void func_80032FF8(void *arg0) {
    s16 temp_t0;
    s16 var_a3;
    s32 temp_a1;
    s32 temp_a2;
    ...
    func_800E6964(arg0 + 0x237, temp_t0, 1, 0x80032C18);
    var_a0_4 = 0;
    var_v0_2 = arg0;
    do {
        var_a0_4 += 1;
