/* NFS4-R-FR-DE CHANGED @8003CB4C | base 8003C7D8 DrawForeground__16tScreenCarSelect */
...
block_9:
    ...
    do {
        ...
        if (temp_a0 != NULL) {
            if (temp_a0->unk16 != *(0x800527FC + (s32) (temp_a2_2 + (arg0->unk11C * 4)))) {
                temp_a0->unk14 = -1;
                var_v0_4 = var_s0 + 1;
...
block_35:
            temp_v1_5 = *(0x800527FC + (s32) (temp_a2_2 + (arg0->unk11C * 4)));
            if (temp_v1_5 >= 0) {
...
block_37:
    ...
    if ((*(0x800532C0 + ((*(void *)0x80051D70)->unk22C * 4)))->unk8D8 != 0) {
    ...
    if ((u32) ((u16) arg0->unk11C - 5) >= 2U) {
        *(s32 *)0x80051B10 = 0;
        ...
        if ((temp_t0 >= 0) && (spF1 >= 0)) {
            ...
            var_s2 = *(0x80051F18 + (((func_800B9F3C(temp_s4, temp_a1_4) * 6) + 0x80051E68)->unk4 * 4));
            if (temp_s1 < 0x80U) {
                var_a1 = 0x80 - temp_s1;
                goto block_52;
            }
...
block_52:
        ...
        if ((arg0->unk3A & 1) && (var_t1 < 0x80)) {
            func_8004EF28(0xA, 0x200, 0, 0, var_t1, 0, &sp100);
        }
...
loop_61:
        ...
        (void *)0x80053470->unk0 = 0;
        if ((s16) var_a1_2 >= 7) {
            var_a1_2 -= 5;
            (void *)0x80053470->unk0 = 0x04000000;
        }
        temp_v0_7 = var_a1_2 + 1;
        var_a2 = temp_v0_7;
        temp_v1_7 = (void *)0x80053470->unk0;
        (void *)0x80053470->unk4 = temp_v1_7;
        if (temp_v0_7 >= 7) {
            var_a2 = var_a1_2 - 4;
            (void *)0x80053470->unk4 = (s32) (temp_v1_7 + 0x04000000);
        }
        temp_v0_8 = var_a2 + 1;
        var_a3 = temp_v0_8;
        temp_v1_8 = (void *)0x80053470->unk4;
        (void *)0x80053470->unk8 = temp_v1_8;
        if (temp_v0_8 >= 7) {
            var_a3 = var_a2 - 4;
            (void *)0x80053470->unk8 = (s32) (temp_v1_8 + 0x04000000);
        }
        temp_v0_9 = var_a3 + 1;
        var_t1_2 = temp_v0_9;
        temp_v1_9 = (void *)0x80053470->unk8;
        (void *)0x80053470->unkC = temp_v1_9;
        if (temp_v0_9 >= 7) {
            var_t1_2 = var_a3 - 4;
            (void *)0x80053470->unkC = (s32) (temp_v1_9 + 0x04000000);
        }
