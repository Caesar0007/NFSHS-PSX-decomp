/* NFS4-R-FR-DE CHANGED @8001D824 | base 8001D63C Draw__20tMenuItemSlidingMenuiib */
...
? func_8004EF28(?, ?, s16, s16, s32, s32, s16 *);   /* extern */
...
void func_8001D824(void *arg0, s32 arg1, s32 arg2, ? arg3) {
    ...
    *(s32 *)0x80051E60 = -1;
    sp40 = temp_v0_2 + arg2;
    sp44 = *(s32 *)0x800532BC + 0x3C0;
    temp_v1 = arg0->unk1C == (*(s32 *)0x800522A8 + 0x2758);
    sp48 = temp_v1;
    temp_a2 = arg0->unk2C;
    if ((temp_a2 != 0x80) && (temp_v1 != 0)) {
        func_8001C188(sp40, arg0->unk8, temp_a2, 0x80051E58);
    }
    if ((arg0->unk1C != 0) || (sp48 != 0)) {
        ...
        func_8004EF28(0x39, 0x18, (temp_s1 - sp44->unk10) - 0xA, var_a3, 0, 1, &sp20);
        var_a3_2 = sp40 + 4;
        if (sp48 != 0) {
            var_a3_2 = sp40 + 3;
        }
        func_8004EF28(0x3A, 0x18, (temp_s1 - sp44->unk10) - 0xA, var_a3_2, 0, 1, &sp20);
    }
    if (arg0->unk1C != 0) {
        temp_s8 = arg0->unk24;
        ...
        *temp_a2_2 = (*temp_a2_2 & 0xFF000000) | ((s32) temp_a0 & 0xFFFFFF);
        ...
        if ((arg0->unk40 != 0) && (temp_s7->unk12 < temp_s2_2)) {
            func_8004EF28(0x1F, 0xC, temp_s4, temp_s5, 0, 0, NULL);
            temp_s1_2 = temp_s4 + temp_s8;
            func_8004EF28(0x1F, 8, temp_s1_2 - temp_s7->unk10, temp_s5, 0, 0, NULL);
            temp_s0_2 = temp_s5 + temp_s2_2;
            func_8004EF28(0x20, 0xC, temp_s4, temp_s0_2 - temp_s3->unk12, 0, 0, NULL);
            func_8004EF28(0x20, 8, temp_s1_2 - temp_s3->unk10, temp_s0_2 - temp_s3->unk12, 0, 0, NULL);
        }
        temp_a3 = temp_s7->unk10;
        func_8004F4F4(0, temp_s4 + temp_a3 + 5, temp_s5, ((temp_s8 - temp_a3) - temp_s3->unk10) - 0xA, temp_s2_2);
        temp_v1_3 = temp_s7->unk12;
        temp_a0_2 = temp_s3->unk12;
        if ((temp_v1_3 + temp_a0_2) < temp_s2_2) {
            func_8004F4F4(0, temp_s4, temp_s5 + temp_v1_3, temp_s8, (temp_s2_2 - temp_v1_3) - temp_a0_2);
        }
        ...
        *temp_a2_3 = (*temp_a2_3 & 0xFF000000) | ((s32) temp_a0_3 & 0xFFFFFF);
        ...
        temp_a0_4 = *(void *)0x80051E60;
        if (temp_a0_4 != -1) {
            temp_s1_3 = func_800B9F1C(temp_a0_4);
            temp_s0_3 = func_800B9F5C(*(void *)0x80051E60);
            func_80020F3C(temp_s1_3, temp_s0_3, func_800B9F7C(*(void *)0x80051E60), *(s32 *)0x80051E5C, 0, 2);
        }
        ...
        temp_s0_4 = sp40 - 2;
        func_8004EF28(0x1E, 8, (sp3C + arg0->unk24) - sp44->unk10, temp_s0_4, (s32) arg0->unk2C, 0, NULL);
        if (arg0->unk40 != 0) {
            func_8004F4F4(0, (s16) sp3C, temp_s0_4, arg0->unk24 - sp44->unk10, (s32) sp44->unk12);
        }
    }
}
