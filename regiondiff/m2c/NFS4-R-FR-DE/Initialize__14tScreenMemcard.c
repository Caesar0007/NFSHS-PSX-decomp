/* NFS4-R-FR-DE CHANGED @800480F8 | base 80047C30 Initialize__14tScreenMemcard */
...
void func_800480F8(void *arg0) {
    ...
    *(s32 *)0x8005317C = 6;
    *(s32 *)0x80053184 = 0x18;
    *(s32 *)0x80053188 = 0x150;
    *(s32 *)0x80053180 = 0x150;
    arg0->unk598 = 0;
    *(s32 *)0x8005318C = 0xBC;
    *(s32 *)0x80053190 = func_800E5F14(0x800121D8, 0x21C0, 0);
    arg0->unk590 = 0;
    arg0->unk588 = 0;
    arg0->unk58A = 0;
    temp_v0 = (*(void **)0x80051D70)->unk22D;
    var_a3 = 0x288;
