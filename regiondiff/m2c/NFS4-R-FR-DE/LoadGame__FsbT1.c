/* NFS4-R-FR-DE CHANGED @80034FDC | base 80034E18 LoadGame__FsbT1 */
...
loop_15:
    if (var_s1 == 0) {
        func_800DCED0();
        temp_s0 = func_80050730(temp_s4);
        func_800E77DC(0);
        func_800F2CA4(0);
        switch (temp_s0) {
        case 22:
            func_8004FF68(temp_s4, &sp1658, 0);
            break;
        case 15:
            if (func_80034518(&sp10) != 0) {
                ...
                temp_s0_2 = func_80050AF4(temp_s6 + 1);
...
block_35:
        ...
        case 16:
        case 23:
            temp_s0_4 = func_80050AF4(temp_s6 + 1);
            func_80018AC4(*(void *)0x80051D70 + 0x2D0);
            temp_s0_5 = *temp_s0_4;
            if (temp_s0_5 == -2) {
                goto block_31;
...
loop_36:
    ...
    if (arg2 != 0) {
        if (*(void *)0x800522C8 == 0) {
            func_80018AC4(*(void *)0x80051D70 + 0x2D0);
            func_80018AC4(*(void *)0x80051D70 + 0x238);
            temp_s0_6 = *(void *)0x80051D70 + 0x238;
            temp_s0_6->unk90 = func_800B9F1C(var_s2 + (s16) (u16) sp1688);
            func_80018A00(*(void *)0x80051D70 + 0x238);
loop_43:
            temp_a0 = *(void *)0x80051D70;
