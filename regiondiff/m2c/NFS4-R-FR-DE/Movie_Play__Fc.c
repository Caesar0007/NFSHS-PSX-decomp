/* NFS4-R-FR-DE CHANGED @8004D23C | base 8004CCE4 Movie_Play__Fc */
...
loop_1:
    if ((func_8004D1DC() ^ 1) != 0) {
        func_800DCED0();
        if (func_8004D088() != -1) {
            temp_s0_2 = (((void *)0x80053580->unk20 == 0) * 8) + 0x80053580;
            ...
            *(s16 *)0x80053288 = 1;
            ...
            if ((temp_s0_4 != 0) && ((func_8004D1CC(), (*(u8 *)0x80053286 != 0)) || (temp_s0_4 == 8))) {
                *(s16 *)0x80053284 = 1;
            }
            goto loop_1;
        }
    ...
    func_800EE348(0x80053598, 0, 0, 0);
    func_800EE1C4(0);
    return *(void *)0x80053284;
}
