/* NFS4-R-FR-DE CHANGED @80034B34 | base 80034988 SaveGame__Fs */
/* callers: GenericMenuSaveGame__Fi */
? func_8001390C(void *);                            /* extern */
? func_80016CB8(?, ? *);                            /* extern */
? func_80018A00(? *);                               /* extern */
? func_80018AC4(? *);                               /* extern */
? func_80021C6C(?, ? *);                            /* extern */
? func_800237F8(? *);                               /* extern */
? func_800260CC(? *, void *, s32, ?);               /* extern */
? func_80026124(? *, ?);                            /* extern */
? func_80033708(?, ? *);                            /* extern */
? func_800344A0(? *);                               /* extern */
? func_800345F0();                                  /* extern */
? func_80034614();                                  /* extern */
? func_80034AB4(? *, s16, ?);                       /* extern */
s32 func_80050730(s16);                             /* extern */
s32 *func_80050AF4(s32);                            /* extern */
...
static ? *jtbl_800116F4[3] = { &.L80034DF0, &.L80034E48, &.L80034E78 }; /* const */

s32 func_80034B34(s16 arg0) {
    ? sp10;
    ? sp14;
    ? sp18;
    ? sp468;
    ...
    *(s32 *)0x800522CC = 1;
    ...
    func_800260CC(&sp15C0, var_a1, var_a2, 0x73);
    sp1620 = 0x800105A8;
    sp1630 = 0;
    sp162E = 0;
    sp1642 = 0;
...
loop_5:
    ...
    *(s32 *)0x800522C8 = 0;
    func_800345F0();
    func_80034AB4(&sp1658, temp_s0, 0);
    sp166C = &sp10;
loop_8:
    if (func_80050730(temp_s0) == 0x15) {
        func_800DCED0(0x80110000);
        func_800F2CA4(0);
        goto loop_8;
    }
    func_800E6EB4(0x801158E4, &sp18, 0x450);
    func_80033708(0x80115DBC, &sp558);
    func_80021C6C(0x80115D34, &sp548);
    func_80016CB8(0x80115558, &sp468);
...
loop_11:
    if (var_s3 == 0) {
        func_800DCED0();
        temp_s0_2 = func_80050730((s16) (u16) sp16C8);
        func_800E77DC(0);
        func_800F2CA4(0);
        ...
        if (temp_s0_3 < 0x16U) {
            ...
            case 8:
            case 9:
                temp_v1 = *func_80050AF4(((s32) (arg0 << 0x10) >> 0xE) + 1);
                var_s2 = 0x29E;
                if (temp_v1 != -3) {
                    var_s2 = 0x326;
                    if (temp_v1 == -1) {
...
loop_22:
    if (func_80050730((s16) (u16) sp16C8) != 0x16) {
        func_800DCED0();
        func_800F2CA4(0);
        goto loop_22;
    }
    ...
    func_80034614();
    if (*(void *)0x800522C8 == 0) {
        func_80018AC4(*(void *)0x80051D70 + 0x2D0);
        temp_s0_4 = *(void *)0x80051D70 + 0x238;
        temp_s0_4->unk90 = func_800B9F1C(var_s2 + arg0);
        func_80018A00(*(void *)0x80051D70 + 0x238);
loop_26:
