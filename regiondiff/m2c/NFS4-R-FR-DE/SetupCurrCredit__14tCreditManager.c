/* NFS4-R-FR-DE CHANGED @80035F88 | base 80035D68 SetupCurrCredit__14tCreditManager */
...
void func_80035F88(void *arg0) {
    ...
    if (((*(s32 *)0x8013EFB8 - *(s32 *)0x800522F4) >= 0xD) && (arg0->unk8 == 0)) {
        var_s1 = 0;
        if (arg0->unk20 == arg0->unk1C) {
            ...
            if (var_s1 != 0) {
                ...
                *(void *)0x800522F4 = (s32) *(void *)0x8013EFB8;
            }
    ...
    temp_a0 = arg0->unk34;
    if ((temp_a0 != 0) && (*(s32 *)0x800522F0 < (*(void *)0x8013EFB8 - temp_a0))) {
    ...
    if ((arg0->unk8 == 0x80) && (arg0->unk24 == 0)) {
        ...
        if ((temp_a0_2 == ((arg0->unk20 / 3) * 3)) || (((var_a1 * 0x144) + arg0->unk0)->unk1C != -1)) {
            func_80037180(*(s32 *)0x800526B0, ((var_a1 * 0x144) + arg0->unk0)->unk1C, arg0->unk20 / 3);
            *(void *)0x800522F8 = (s32) *(void *)0x8013EFB8;
        } else {
            *(s32 *)0x800522F8 = 0;
        }
    }
    var_a0 = 0;
    if ((arg0->unk28 == 0) && (arg0->unk24 != 0) && ((*(void *)0x8013EFB8 - *(void *)0x800522F8) >= 0x81)) {
        var_a0 = func_8003733C(*(void *)0x800526B0) != 0;
    }
    if (var_a0 != 0) {
        arg0->unk28 = 1;
