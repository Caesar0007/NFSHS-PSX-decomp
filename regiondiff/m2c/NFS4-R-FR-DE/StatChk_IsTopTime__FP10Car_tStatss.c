/* NFS4-R-FR-DE CHANGED @8004A20C | base 80049D0C StatChk_IsTopTime__FP10Car_tStatss */
...
s32 func_8004A20C(void *arg0, s16 arg1) {
    s32 sp10;
    s32 sp18;
    s32 sp1C;
    s32 sp20;
...
loop_6:
    if ((var_s1 << 0x10) < ((u16) sp28 << 0x10)) {
        ...
        temp_a0 = func_80016464(0x80115558, ((var_s1 * 0xA0) + arg0)->unk60);
        if (!(temp_a1 & 0x200)) {
