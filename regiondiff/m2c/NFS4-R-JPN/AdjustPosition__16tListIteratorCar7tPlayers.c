/* NFS4-R-JPN CHANGED @80017A2C | base 80017A9C AdjustPosition__16tListIteratorCar7tPlayers */
/* callers: Increment__16tListIteratorCar7tPlayer, Decrement__16tListIteratorCar7tPlayer */
s32 func_800172C4(void *, ?);                       /* extern */
s32 func_8001805C(void *, s32, u8);                 /* extern */

void func_80017A2C(void *arg0, u16 arg1, s32 arg2) {
    u8 sp10;
    u8 sp18;
    s32 temp_s3;
    s32 temp_v1;
    ...
    if (temp_v1 & 0x89) {
        ...
        var_s5 = temp_a0->unk0;
        if (((s16) var_s3 == 1) && ((func_800172C4(temp_a0, 1) << 0x10) <= 0)) {
            var_s1 = arg0->unk14 + 8;
        }
        var_s4_2 = 0;
        if (*var_s1 >= 0) {
...
block_15:
    ...
    if (var_s5 < var_s4) {
        ...
        if (temp_a0_2 < (u32) temp_a2->unk0) {
            ...
            sp18 = (*var_s0 + ((s16) var_s3 * 0x30) + 0x801156A4)->unkC0;
        } else {
            sp18 = 0;
        }
...
loop_25:
        ...
        if (temp_v1_6 < (u32) temp_a1->unk0) {
            ...
            if (var_s0->unk2 == 7) {
                temp_v1_7 = var_s0->unk0 + temp_s3 + 0x801156A4;
                temp_v1_7->unkC0 = (u8) (arg2 + temp_v1_7->unkC0);
                temp_v1_8 = var_s0->unk0 + temp_s3 + 0x801156A4;
                ...
                temp_v1_13 = var_s0->unk0 + temp_s3 + 0x801156A4;
                if ((arg2 << 0x10) <= 0) {
                    temp_v1_13->unkC0 = 4;
                } else {
                    temp_v1_13->unkC0 = 0;
...
block_39:
                    ...
                    (*var_s0 + temp_s3 + 0x801156A4)->unkC0 = 0;
                } else if (var_v0_3 < 0) {
...
block_43:
                        ...
                        (*var_s0 + temp_s3 + 0x801156A4)->unkC0 = 4;
                    }
                }
            }
        } else {
        ...
        if (((sp10 != temp_v1_22) || (((s8) temp_v1_22 < arg0->unk14->unk0) && ((*var_s0 + temp_s3 + 0x801156A4)->unkC0 != sp18))) && ((func_8001805C(arg0, (s32) arg1, *temp_a1_2) ^ 1) != 0)) {
            goto loop_25;
        }
    }
}
