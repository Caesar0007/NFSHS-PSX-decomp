/* NFS4-R-JPN CHANGED @800754C8 | base 80074BE8 AudioClc_CalcAzimuth__FP17DRender_tCalcViewP8coorddef */
...
s32 func_800754C8(void *arg0, void *arg1) {
    ...
    if (*(s32 *)0x8013D754 != 0) {
        ...
        return (func_800E6510(var_v1 >> 8, (s32) ((temp_t2 * (var_v0 >> 8)) + (temp_t1 * ((s32) arg0->unk28 / 256)) + (temp_a2 * (var_v0_2 >> 8))) >> 8, temp_a2, temp_a3) << 6) & 0xFFC0;
    }
    return 0;
}
