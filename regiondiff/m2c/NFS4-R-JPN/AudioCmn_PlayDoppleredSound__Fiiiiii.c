/* NFS4-R-JPN CHANGED @80078AF8 | base 80078140 AudioCmn_PlayDoppleredSound__Fiiiiii */
/* callers: AudioCmn_PlaySound__Fiiiii, AudioCmn_PlaySFX__Fiiiiii, AudioCmn_PlaySFX__Fiiiiii */
s8 func_80077300(s32, s32, ?);                      /* extern */
? func_800E720C(s32 *);                             /* extern */
s32 func_800E8408(s32 *);                           /* extern */
...
s32 func_80078AF8(s8 arg0, s32 arg1, s16 arg2, s32 arg3, s32 arg4, s32 arg5) {
    ...
    if (arg1 == 0x7D) {
        ...
        temp_v1 = (void *)0x8010F958->unk18;
        if (arg0 == temp_v1) {
            var_v1 = saved_reg_gp->unk118;
            var_v0_3 = arg3 * 0x28;
            goto block_18;
        }
        if (arg0 == (void *)0x8010F958->unk3C) {
            var_v1 = saved_reg_gp->unk118;
            var_v0_4 = arg3 * 0x82;
            goto block_19;
        }
        ...
        case 3:
            var_v0_3 = arg3 << 7;
            if ((arg0 != (void *)0x8010F958->unk0) && (arg0 != temp_v1)) {
                if (arg1 == 0) {
                case 0:
