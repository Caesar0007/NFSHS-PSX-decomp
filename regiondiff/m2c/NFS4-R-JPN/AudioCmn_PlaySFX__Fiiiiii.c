/* NFS4-R-JPN CHANGED @80078D88 | base 800783CC AudioCmn_PlaySFX__Fiiiiii */
...
? func_800E725C(s32, s32);                          /* extern */
? func_800E746C(s32, s32);                          /* extern */
? func_800E83A8(s32, s32);                          /* extern */
s32 func_800E84EC(s32);                             /* extern */
? func_800E8858(s32);                               /* extern */
? func_800E88E0(s32, s32);                          /* extern */
? func_800E8ABC(s32, s32, ?);                       /* extern */
...
block_31:
                            var_s2 = *(s32 *)0x8010F97C;
                        } else {
block_34:
block_35:
                            var_s2 = *(0x8010F958 + (*(0x8010F580 + (arg0 * 4)) * 0xC));
                        }
                    } else {
                        goto block_32;
                    }
...
block_32:
block_33:
        var_s2 = *(s32 *)0x8010F994;
    }
    if (arg0 == 0x31) {
        (void *)0x8010F9AC->unk188 = func_80078AF8(var_s2, arg1, arg5, var_v1_2, var_a0, arg3);
        (void *)0x8010F9AC->unk18C = arg1;
        saved_reg_gp->unk128 = (s32) (saved_reg_gp->unk128 - 1);
    } else {
        temp_v1 = arg0 * 8;
        temp_s1 = temp_v1 + 0x8010F9AC;
        if (temp_s1->unk4 == arg1) {
            if (func_800E84EC(*(0x8010F9AC + temp_v1)) != 0) {
                *(0x8010F9AC + temp_v1) = -1;
                temp_s1->unk4 = -1;
            }
            if (var_s2 < -1) {
                temp_v0 = func_80077300(var_s2 == -3, arg1, 0);
                if (temp_v0 == -1) {
                    *(0x8010F9AC + temp_v1) = temp_v0;
                    temp_s1->unk4 = temp_v0;
                }
            }
            temp_v1_2 = arg0 * 8;
            temp_v1_3 = temp_v1_2 + 0x8010F9AC;
            if (temp_v1_3->unk4 != arg1) {
                goto block_46;
            }
            var_a0_2 = *(0x8010F9AC + temp_v1_2);
            if (var_a0_2 != -1) {
                if (arg1 == 0x7D) {
                    var_a1 = (s32) (saved_reg_gp->unk10C * var_v1_2) >> 7;
                } else {
                    temp_v1_4 = (void *)0x8010F958->unk18;
                    if (var_s2 == temp_v1_4) {
                        var_lo = saved_reg_gp->unk118 * (var_v1_2 * 0x27);
                    } else if (var_s2 == (void *)0x8010F958->unk3C) {
                        ...
                        case 0x63:
                            ...
                            break;
                        case 0x3:
                            if ((var_s2 == (void *)0x8010F958->unk0) || (var_s2 == temp_v1_4)) {
                ...
                func_800E746C(var_a0_2, var_a1);
                if (*(void *)0x8013E5D0 != 0) {
                    func_800E8ABC(*(0x8010F9AC + (arg0 * 8)), arg5, 0);
                    ...
                    func_800E725C(*(0x8010F9AC + (arg0 * 8)), var_v0_5 >> 8);
                }
                temp_s0 = arg0 * 8;
                func_800E83A8(*(0x8010F9AC + temp_s0), var_a0);
                func_800E88E0(*(0x8010F9AC + temp_s0), arg3 >> 4);
            } else {
...
block_46:
            temp_v1_5 = arg0 * 8;
            temp_s1_2 = temp_v1_5 + 0x8010F9AC;
            temp_a0 = *(0x8010F9AC + temp_v1_5);
            if (temp_a0 != -1) {
            ...
            if (temp_v0_2 != -1) {
                *(0x8010F9AC + temp_v1_5) = temp_v0_2;
                temp_s1_2->unk4 = arg1;
            } else {
                *(0x8010F9AC + temp_v1_5) = temp_v0_2;
