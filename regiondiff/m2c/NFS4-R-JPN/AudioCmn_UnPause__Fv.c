...
void func_8007A6A0(void) {
    ...
    func_8007CED4();
    (void *)0x80114290->unkF4 = (s32) saved_reg_gp->unk10C;
    (void *)0x80114290->unkF0 = (s32) saved_reg_gp->unk108;
}
