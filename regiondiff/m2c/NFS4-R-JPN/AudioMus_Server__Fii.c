/* NFS4-R-JPN CHANGED @8007AE4C | base 8007A3D0 AudioMus_Server__Fii */
...
s32 func_800E8DC4(s32);                             /* extern */
? func_800EA3A0(s32);                               /* extern */
? func_800EA4D4(s32, ?);                            /* extern */
? func_800EA530(s32, ?, s32);                       /* extern */
s32 func_800EA654(?);                               /* extern */
? func_800EA820(s32, ?);                            /* extern */
...
s32 func_8007AE4C(void) {
    ...
    if (saved_reg_gp->unk1D8->unk88 != 0) {
        ...
        if (temp_v0 != 0) {
            if (temp_v0 == 2) {
                ...
                if (temp_a3->unk8C != 0) {
                    if (temp_a3->unk84 < temp_a3->unkA4) {
                        ...
                        func_800EA530(var_a0, 0x7D0, var_a2);
            ...
            if ((temp_a3->unk8C == 0) || (func_800E8DC4(temp_a3->unk70) == 0)) {
                temp_a0_2 = saved_reg_gp->unk1D8->unk70;
                if (temp_a0_2 >= 0) {
                    func_800EA3A0(temp_a0_2);
                }
        ...
        if (temp_a3->unk8C == 0) {
            ...
            if (temp_v1_2 >= 0) {
                ...
                if (temp_s0 >= 2) {
                    if (temp_a3->unk24 != 0) {
                        if (func_800EA654(0) > 0) {
                            var_v0 = func_800EA654(0);
                        } else {
                            var_v0 = -func_800EA654(0);
                        }
                ...
                func_800EA820(saved_reg_gp->unk1D8->unk70, 0);
                func_8007ACE4();
