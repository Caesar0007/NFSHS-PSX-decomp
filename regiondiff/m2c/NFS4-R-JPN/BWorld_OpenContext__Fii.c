/* NFS4-R-JPN CHANGED @8007EEA8 | base 8007E4AC BWorld_OpenContext__Fii */
...
s32 func_8007EEA8(s32 arg0, s32 arg1) {
    ...
    temp_a0_2 = ((void *)0x8010FF5C->unk4 * 0x9C) + ((void *)0x8010FF5C + 8);
    temp_a0_2->unk4 = 0;
    temp_a0_2->unk0 = arg1;
...
block_8:
    ...
    temp_a0 = (void *)0x8010FF5C->unk4;
    (void *)0x8010FF5C->unk4 = (s32) (temp_a0 + 1);
    return temp_a0;
}
