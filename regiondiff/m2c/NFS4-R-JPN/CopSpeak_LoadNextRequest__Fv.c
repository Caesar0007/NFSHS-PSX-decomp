/* NFS4-R-JPN CHANGED @8009B21C | base 8009A634 CopSpeak_LoadNextRequest__Fv */
s32 func_80077300(s8, s32, ?);                      /* extern */
s32 func_8007A9C4();                                /* extern */
s32 func_8007AA48();                                /* extern */
? func_8009A168(void *);                            /* extern */
? func_8009B030();                                  /* extern */
s32 func_8009B1EC(void *);                          /* extern */
s32 func_800EC564(s32);                             /* extern */
s32 func_800ECC34(s32, s32, s32, s32, s32, s32);    /* extern */

void func_8009B21C(void) {
    s32 temp_a1;
    s32 temp_a1_2;
    s32 temp_s0;
    s32 temp_t0;
...
loop_1:
        ...
        if ((temp_a1 != saved_reg_gp->unkB60) && (((temp_a1 - (saved_reg_gp->unkB74 - 0x40)) & 0x3F) < 8)) {
            temp_s0_2 = (temp_a1 << 5) + 0x80112FD4;
...
block_15:
                if ((saved_reg_gp->unkB80 == 0) || (func_8009B1EC(temp_s0_2) == 0) || (temp_v0 = temp_s0_2->unkC, (temp_v0 == 0)) || (temp_v0 >= 0x7FFD) || ((*(s32 *)0x8013E4C4 >= 2) && (*(s32 *)0x801180D4 == 3))) {
                    goto block_21;
                }
                func_8009A168(temp_s0_2);
                temp_v0_2 = temp_s0_2->unk4;
                if (temp_v0_2 >= 0) {
                    temp_t0 = saved_reg_gp->unkB80;
                    *(temp_t0 + temp_v0_2) = 0x4C494146;
                    temp_s0_2->unk14 = func_800ECC34(temp_s0_2->unk10, temp_s0_2->unk8, temp_t0 + temp_s0_2->unk4, temp_s0_2->unkC, 0x64, 0);
                    saved_reg_gp->unkB38 = (u8) (saved_reg_gp->unkB38 + 1);
                    var_v1 = 0;
                    if (func_800EC564(temp_s0_2->unk14) <= 0) {
block_25:
