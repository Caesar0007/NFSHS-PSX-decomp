/* NFS4-R-JPN CHANGED @8009A29C | base 800997AC CopSpeak_ReadyNextRequest__Fv */
? func_80077174(s8, s32, s32, s32);                 /* extern */
s32 func_80077300(s8, s32, ?);                      /* extern */
? func_8009A1E8(void *);                            /* extern */
s32 func_800EC50C(s32);                             /* extern */
? func_800EC564(s32);                               /* extern */
s32 func_800EC9F8(s32);                             /* extern */
...
void func_8009A29C(void) {
    ...
    temp_s0 = (saved_reg_gp->unkB74 << 5) + 0x80112FD4;
    var_s1 = 1;
    if (temp_s0->unk4 >= 0) {
        temp_a0 = temp_s0->unk14;
        if (temp_a0 != -1) {
            temp_v0 = func_800EC50C(temp_a0);
            if (temp_v0 != 0) {
                var_s1 = (u32) (temp_v0 ^ 1) < 1U;
                temp_v0_2 = func_800EC9F8(temp_s0->unk14);
                temp_s0->unk14 = -1;
...
block_5:
            ...
            if (var_s1 == 0) {
                ...
                temp_s0->unk14 = func_800ECC34(temp_s0->unk10, temp_s0->unk8, saved_reg_gp->unkB80 + temp_s0->unk4, temp_s0->unkC, 0, 0);
                saved_reg_gp->unkB38 = (u8) (saved_reg_gp->unkB38 + 1);
                func_800EC564(temp_s0->unk14);
                goto block_29;
            }
