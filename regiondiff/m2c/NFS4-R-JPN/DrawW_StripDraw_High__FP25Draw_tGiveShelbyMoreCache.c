/* NFS4-R-JPN CHANGED @800C7A1C | base 800C6EB8 DrawW_StripDraw_High__FP25Draw_tGiveShelbyMoreCache */
/* callers: DrawW_DoTrough__FP13DRender_tViewP11tBuildEntry, DrawW_DoTrough__FP13DRender_tViewP11tBuildEntry */
? func_800C7074(void *, u16 *);                     /* extern */

void func_800C7A1C(void *arg0) {
    u16 sp10;
    s8 sp12;
    s8 sp13;
    s8 sp14;
