/* NFS4-R-JPN CHANGED @800C79B4 | base 800C6E38 DrawW_kCtrlWorld_High__FP25Draw_tGiveShelbyMoreCache */
...
? func_800C7074(void *, s32);                       /* extern */

void func_800C79B4(void *arg0) {
    s32 var_s0;
    s32 var_s1;
