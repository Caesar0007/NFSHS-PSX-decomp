/* NFS4-R-JPN CHANGED @800644B4 | base 80063CC4 HighExecute__10AIHigh_Cop */
...
? func_80087088(void *, ?, ?);                      /* extern */
void *func_8009834C(void *);                        /* extern */
    ...
    case 1:                                         /* switch 1 */
        ...
        if (temp_v1_4 == 2) {
            ...
            if (var_v0_2 != NULL) {
                ...
                var_v1->unk4 = (s32) var_v0_2->unk4;
                if (*(s32 *)0x8013D8E0 == 2) {
                    var_v0_3 = func_80073998(*(void **)0x80110AF8, ((void **)0x80110000 + 0xAF8)->unk4);
                    if (var_v0_3 < 0) {
                        var_v0_3 = -var_v0_3;
                    }
                ...
                func_800736F0(*(s32 *)0x8013D6C4, &sp28);
                ...
                case 3:                             /* switch 2 */
                    ...
                    break;
                case 1:                             /* switch 2 */
                    temp_lo = *(s32 *)0x8013E1C0 * *(s32 *)0x8013E1C8;
                    *(s32 *)0x8013E1C4 = temp_lo;
                    *(void *)0x8013E1C0 = (s32) (temp_lo & 0xFFFF);
                    var_s3 = -1;
                    if (*(void *)0x801142C0 == 0) {
                        var_s3 = 1;
                    }
                    if (sp38 != 0) {
                        func_80066008(arg0, 0);
    ...
    case 2:                                         /* switch 1 */
        ...
        if (temp_v0_8 != 1) {
            ...
            if ((temp_v1_9 != 1) && (temp_v1_9 != 4) && (func_80065DA8(arg0, 1) != 0)) {
                ...
                temp_s0_2 = func_800704DC(func_800702E4(0x94), arg0->unk0, arg0->unk58->unk0, &sp28, ((arg0->unk68 * 0x14) + 0x8010D8EC)->unk10, *(0x8010DA0C + (arg0->unk18 * 8)), ((arg0->unk18 * 8) + 0x8010DA0C)->unk4, arg0->unk68, *(0x8010D928 + (*(s32 *)0x80114298 * 4)));
                if (temp_v1_10 != NULL) {
                ...
                arg0->unk4 = temp_s0_2;
                arg0->unk8 = 4U;
                temp_v0_11 = func_8009834C(arg0->unk0);
        ...
        if ((arg0->unk5C != 0) || (func_80067E50(arg0->unk0) != 0)) {
            arg0->unk5C = 0;
            temp_v0_12 = func_8009834C(arg0->unk0);
    ...
    case 4:                                         /* switch 1 */
        ...
        if (arg0->unk58 != NULL) {
            if (temp_s2->unk90 >= 0xA1) {
                ...
                arg0->unk4 = temp_s0_4;
                arg0->unk8 = 9U;
                temp_v0_16 = func_8009834C(arg0->unk0);
            ...
            arg0->unk64 = -1;
            var_a0 = 0;
            if ((void *)0x8011F150->unk4 >= temp_s2->unk8C) {
                var_a0 = ~func_80065B94(arg0) != 0;
            }
            if (var_a0 != 0) {
                temp_s2->unk8C = (s32) ((void *)0x8011F150->unk4 + 0x3C0);
            }
            func_8005D218(arg0);
            var_s0_5 = 0;
            ...
            temp_v0_18 = temp_v0_17 + 0x8010D8EC;
            var_a1 = 0;
            if (*(0x8010D8EC + temp_v0_17) < temp_s2->unk78) {
            ...
            if (var_a1 != 0) {
                func_8007074C(temp_s2, 1, ((arg0->unk68 * 0x14) + 0x8010D8EC)->unkC);
            }
            var_s0_6 = 0;
...
block_130:
    ...
    case 3:                                         /* switch 1 */
        ...
        if (arg0->unk5C != 0) {
            arg0->unk5C = 0;
            temp_v0_26 = func_8009834C(arg0->unk0);
        ...
        if (arg0->unk20 == 2) {
            ...
            var_s2 = 0;
            if (arg0->unk64 != -1) {
                if ((void *)0x8010DF94->unk0 == 0) {
                    temp_v1_27 = *(void *)0x80114298;
                    if (temp_v1_27 != 0) {
                        var_s0_7 = 0xE666;
                        if (temp_v1_27 == 1) {
                            var_s0_7 = 0xCCCC;
                    ...
                    temp_v0_28 = (arg0->unk64 << 5) + *(s32 *)0x8013D8A0;
                    temp_v1_28 = (arg0->unk64 << 5) + *(void *)0x8013D8A0;
                    temp_s0_8 = func_800E4D00((temp_v0_28->unk1E << 0xF) * ((u8) temp_v0_28->unk1D >> 4), var_s0_7, 1);
                    temp_v0_29 = func_800E4D00((temp_v1_28->unk1F << 0xF) * (temp_v1_28->unk1D & 0xF), var_s0_7);
                    temp_a1 = -temp_s0_8;
                    (void *)0x8010DF94->unk8 = temp_a1;
                    (void *)0x8010DF94->unkC = temp_v0_29;
                    (void *)0x8010DF94->unk0 = 1;
                    (void *)0x8010DF94->unk4 = (s32) arg0->unk64;
                    (void *)0x8010DF94->unk10 = (s32) *(s32 *)0x8011F154;
                    func_8007E26C(arg0->unk64, temp_a1, temp_s0_8 + temp_v0_29, 0x80110000);
                }
            }
            *(s32 *)0x8013D650 = 1;
            if ((arg0->unk64 != -1) && ((void *)0x8010DF94->unk4 == arg0->unk64)) {
                (void *)0x8010DF94->unk10 = (s32) *(void *)0x8011F154;
            }
            if (arg0->unk28 != 0) {
                if (*(s32 *)0x8013E8F0 != 0) {
                    *(void *)0x8013E904 = func_800E4E84(*(s32 *)0x8013E904);
                    *(void *)0x8013E8F0 = 0;
                    func_8005CF80(arg0, arg0 + 0x20);
                    *(void *)0x8013E904 = func_800E4E84(*(void *)0x8013E904);
                    *(void *)0x8013E8F0 = 1;
                } else {
                    func_8005CF80(arg0, arg0 + 0x20);
                }
            ...
            var_v1_2 = temp_s0_9->unk10->unk24 * *(s32 *)0x8013D6D4;
            if (var_v1_2 < 0) {
                var_v1_2 += 0xFFFF;
            }
            ...
            if (temp_v1_30 == 4) {
block_158:
                temp_s0_9->unk1C = func_800E4D00(temp_lo_2, var_a1_3);
            }
            func_80066094(arg0, &sp28);
            ...
            if (var_a1_4 > 0x31FFFF) {
                if (var_a1_4 <= 0x012BFFFF) {
                    ...
                    if (var_v1_3 > 0x471C7) {
                        temp_v0_31 = func_800E4DDC(temp_v0_30, arg0->unk58->unk0->unk564);
...
block_173:
                ...
                temp_s0_10 = func_800704DC(func_800702E4(0x94), arg0->unk0, arg0->unk58->unk0, &sp28, ((arg0->unk68 * 0x14) + 0x8010D8EC)->unk10, *(0x8010DA0C + (arg0->unk18 * 8)), ((arg0->unk18 * 8) + 0x8010DA0C)->unk4, arg0->unk68, *(0x8010D928 + (*(void *)0x80114298 * 4)));
                if (temp_v1_31 != NULL) {
            ...
            if ((func_80065DA8(arg0, -3, 1) != 0) && (temp_v1_32 = arg0->unk20, (temp_v1_32 != 1)) && (temp_v1_32 != 4)) {
                ...
                temp_s0_11 = func_800704DC(func_800702E4(0x94), arg0->unk0, arg0->unk58->unk0, &sp28, ((arg0->unk68 * 0x14) + 0x8010D8EC)->unk10, *(0x8010DA0C + (arg0->unk18 * 8)), ((arg0->unk18 * 8) + 0x8010DA0C)->unk4, arg0->unk68, *(0x8010D928 + (*(void *)0x80114298 * 4)));
                if (temp_v1_33 != NULL) {
                ...
                arg0->unk8 = 4U;
                temp_v0_35 = func_8009834C(arg0->unk0);
    ...
    case 5:                                         /* switch 1 */
        ...
        arg0->unk64 = -1;
        var_s2_2 = 0;
        var_s0_8 = (void **)0x80110AB0;
loop_193:
        if (var_s2_2 < *(s32 *)0x8013D8D8) {
            temp_a1_3 = *var_s0_8;
            if ((*(0x8010D780 + (temp_a1_3->unk254 * 4)))->unk78 != 0) {
        ...
        temp_a2_3 = arg0->unk0;
        temp_a0_5 = (temp_a2_3->unk8 << 5) + *(void *)0x8013D8A0;
