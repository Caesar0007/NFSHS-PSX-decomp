/* NFS4-R-JPN CHANGED @800D5830 | base 800D4E70 Hud_BuildNumbers__Fi */
/* callers: Hud_RenderHudView__Fv */
? func_800D28B8(?, s32 *, ?, ?);                    /* extern */
? func_800D2C48(void *, void *, s32, s32, s32);     /* extern */
? func_800D4704(void *, s32, s32, s32 *);           /* extern */
s32 func_800E4D00(s32, s32);                        /* extern */

void func_800D5830(s32 arg0, s32 arg2, s32 *arg3) {
    s32 sp18;
    s32 sp1C;
    s32 sp20;
    s32 sp24;
    ...
    var_s1 = (void *)0x8013F544;
    if (arg0 != 0) {
        var_s1 = (void *)0x8013F5EC;
    }
    var_s0 = (void *)0x8013F824;
    if (arg0 != 0) {
        var_s0 = (void *)0x8013F8B4;
    }
    var_s6 = 0;
    if (arg0 != 0) {
        var_s6 = -0xF;
    }
    if (((arg0 * 0xB4) + 0x80114290)->unk45C != 0) {
        var_a0 = 0x80114290;
        if (saved_reg_gp->unk13E0 == 0) {
            var_a2 = 0x14;
            if ((void *)0x801137D4->unk3C != 1) {
                var_s5->unk19C = (s32) *(0x80111D20 + ((void *)0x801137D4->unk38 * 4));
                var_a0_2 = var_s5 + 0x190;
                var_s5->unk1C4 = (s32) *(0x80111D20 + ((void *)0x801137D4->unk3C * 4));
...
block_18:
    ...
    if (((arg0 * 0xB4) + var_a0)->unk458 != 0) {
        temp_a1_3 = (void *)0x801137D4->unk5C;
        if ((temp_a1_3 != 0) && (temp_a1_3 <= 0x95FF) && (saved_reg_gp->unk13E0 == 0) && (saved_reg_gp->unk1914 == 0) && ((void *)0x801137D4->unk3C != 1)) {
            if (((void *)0x801137D4->unk14 == 0) || !(*(s32 *)0x8011F154 & 0x10)) {
                func_800D4704(var_s5 + 0x1CC, temp_a1_3, var_a2, var_a3);
            }
            var_a1 = 0x17;
    ...
    if ((((arg0 * 0xB4) + 0x80114290)->unk460 != 0) && (saved_reg_gp->unk13E0 == 0) && ((void *)0x801137D4->unk58 >= 2)) {
        temp_v0 = saved_reg_gp->unk18D0;
        var_s5->unk2EC = (s16) ((temp_v0->unk38 + temp_v0->unk28 + ((void *)0x80111D48->unk380 - 2)) - ((((void *)0x801137D4->unk54 + 0x2C) * 0x14) + 0x80111D48)->unk10);
        var_s5->unk2F0 = (s32) (((void *)0x801137D4->unk54 * 0x14) + 0x80111D48)->unk370;
        var_t0 = 0x25;
        var_s5->unk2F4 = (u16) ((((void *)0x801137D4->unk54 + 0x2C) * 0x14) + 0x80111D48)->unk10;
        var_s5->unk318 = (s32) (((void *)0x801137D4->unk58 * 0x14) + 0x80111D48)->unk424;
        temp_a1_5 = *(void *)0x1F800000;
        var_a0_6 = var_s5 + 0x2E4;
        var_s5->unk31C = (u16) ((((void *)0x801137D4->unk58 + 0x35) * 0x14) + 0x80111D48)->unk10;
        do {
            var_t0 += 1;
        ...
        if (((arg0 * 0xB4) + 0x80114290)->unk450 != 0) {
            func_800D28B8(0, temp_a1_5, 0x80111D48, 0xFFFFFF);
            ...
            *temp_a1_6 = (*temp_a1_6 & 0xFF000000) | ((s32) (var_s5 + 0x320) & 0xFFFFFF);
            func_800D28B8(1, temp_a1_6, 0xFFFFFF, 0xFF000000);
        }
    }
    func_800D28B8(0);
    if (((arg0 * 0xB4) + 0x80114290)->unk44C != 0) {
        temp_v1_3 = *(s32 *)0x8011381C;
...
block_46:
        ...
        default:
            ...
            temp_v1_4 = ((void *)0x801137D4->unk48 * 0x14) + var_s5;
            temp_v1_4->unk30C = (s32) ((temp_v1_4->unk30C & 0xFF000000) | (*temp_a2 & 0xFFFFFF));
            *temp_a2 = (*temp_a2 & 0xFF000000) | ((s32) (((void *)0x801137D4->unk48 * 0x14) + var_s5 + 0x30C) & 0xFFFFFF);
            break;
        }
        if (((arg0 * 0xB4) + 0x80114290)->unk444 == 0) {
    ...
    func_800D28B8(1);
    if (((arg0 * 0xB4) + 0x80114290)->unk44C != 0) {
        var_s4 = func_800E4D00(((arg0 * 0xB4) + 0x80114290)->unk448, *(s32 *)0x80113820);
        if (var_s4 < 0) {
            var_s4 += 0xFFFF;
        }
        sp24 = 0xC8C8C8;
        ...
        *(void **)0x1F800004 = temp_s1 + 0x34;
        ...
        temp_s3 = (s16) (void *)0x80111D48->unk380 + 1;
        temp_s7 = (s32) (temp_s3 + (void *)0x80111D48->unk40C) >> 1;
        ...
        *temp_t2 = (*temp_t2 & 0xFF000000) | ((s32) temp_s1 & 0xFFFFFF);
        temp_s4 = (s32) (temp_s3 + (void *)0x80111D48->unk394) >> 1;
        temp_v1_5 = var_s4 / 655360;
        temp_s0 = var_s4 / 6553600;
        temp_s6 = temp_v1_5 - (temp_s0 * 0xA);
        func_800D2C48(temp_s1, (((var_s4 >> 0x10) - (temp_v1_5 * 0xA)) * 0x14) + ((void *)0x80111D48 + 0x370), temp_s2, sp18, 0xC8C8C8);
        ...
        if ((temp_s0 != 0) || (temp_s6 != 0)) {
            ...
            *temp_t0 = (*temp_t0 & 0xFF000000) | ((s32) temp_s1_2 & 0xFFFFFF);
            func_800D2C48(temp_s1_2, (temp_s6 * 0x14) + 0x801120B8, var_s2, sp18, sp24);
        ...
        if (temp_s0 != 0) {
            ...
            *temp_t0_2 = (*temp_t0_2 & 0xFF000000) | ((s32) temp_s1_3 & 0xFFFFFF);
            func_800D2C48(temp_s1_3, (temp_s0 * 0x14) + 0x801120B8, (var_s2 - 1) - (((temp_s0 + 0x2C) * 0x14) + 0x80111D48)->unk10, sp18, sp24);
            temp_s1_3->unk28 = sp20;
            temp_s1_3->unk1C = sp20;
        }
    }
    if ((((arg0 * 4) + 0x801137D4)->unk2C != 0) && (((s32) *(void *)0x8011F154 >> 5) & 1)) {
