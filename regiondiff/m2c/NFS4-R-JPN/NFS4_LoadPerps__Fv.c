/* NFS4-R-JPN CHANGED @800A4A6C | base 800A3F08 NFS4_LoadPerps__Fv */
/* callers: Nfs2_GameModuleStartUp__FPi */
? func_800E4E94(? *, ?, s32, s32);                  /* extern */
? func_800E5F18(u32 *, s32);                        /* extern */
u32 *func_800E61C0(? *, ?);                         /* extern */

void func_800A4A6C(void) {
    ? sp10;
    s16 temp_a1;
    s16 var_t4;
    s32 *var_t3;
    ...
    if ((void *)0x80114290->unk1AC > 0) {
        if (((void *)0x80114290->unkC != 1) && ((void *)0x80114290->unk18 <= 0)) {
            var_a3 = 0x800567AC;
        } else {
            var_a3 = 0x800567B8;
        }
        func_800E4E94(&sp10, 0x8013E35C, (void *)0x8011750C->unk94, var_a3);
        temp_s0 = func_800E61C0(&sp10, 0x10);
        func_800E4E94(&sp10, 0x8013E35C, *(s32 *)0x801175A0, 0x800567C4);
        var_a1 = (void *)0x80114290;
        var_t3 = (s32 *)0x8011444C;
        var_t4 = 0;
        temp_s1 = func_800E61C0(&sp10, 0x10);
        temp_t1 = *temp_s1;
        var_t0 = &(temp_s0 + 0xC)[temp_s0->unk0] + (temp_s0->unk4 * 0x14) + ((void *)0x80114290->unk1B0 * 0x2C);
        if ((void *)0x80114290->unk1AC > 0) {
            temp_t2 = temp_s1 + 4;
            var_a2 = (void *)0x80114290 + 0x1C8;
            var_a3_2 = var_t0 + 1;
            do {
                var_a0 = 0;
                if (temp_t1 != 0) {
...
block_13:
                ...
                *var_t3 = (s32) (((var_v0_2 + var_a0) * 0x44) + temp_t2)->unk1;
                ...
                var_a1 = (void *) (temp_a1 < (void *)0x80114290->unk1AC);
                var_a2 += 0x34;
            } while (var_a1 != NULL);
        }
        func_800E5F18(temp_s0, (s32) var_a1);
        func_800E5F18(temp_s1);
    }
}
