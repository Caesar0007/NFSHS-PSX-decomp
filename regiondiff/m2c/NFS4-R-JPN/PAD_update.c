/* NFS4-R-JPN CHANGED @800E4BF4 | base 800E4210 PAD_update */
...
? func_800E6CB4(u8 *, s32, ?);                      /* extern */
? func_800F22C4(s32, ?, ?);                         /* extern */
...
void func_800E4BF4(void) {
    ...
    var_s3 = 0x8013F99C;
    var_s1 = 0x8013F994;
    var_s0 = (u8 *)0x8013F9E4;
    do {
        var_a0 = var_s1;
        if (*var_s0 != 0) {
            var_a1 = 0x20;
        } else {
            func_800E6CB4(var_s0, var_s1, 8);
            var_a0 = var_s3;
            var_a1 = 0x18;
        }
        func_800F22C4(var_a0, var_a1, 0xFF);
        var_s3 += 0x20;
        var_s1 += 0x20;
        var_s2 += 1;
        var_s0 += 0x22;
    ...
    var_s2_2 = 0;
    var_a0_2 = (void *)0x8013F990;
    var_a2 = (void *)0x8013F990;
    do {
