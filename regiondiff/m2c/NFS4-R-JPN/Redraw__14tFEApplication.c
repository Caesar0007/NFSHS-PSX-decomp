/* NFS4-R-JPN CHANGED @800136AC | base 8001373C Redraw__14tFEApplication */
...
? func_8001348C(void *);                            /* extern */
? func_800158B8(?);                                 /* extern */
? func_800186A8();                                  /* extern */
? func_8001B0F0(void *, ?, s32 *, ? *);             /* extern */
? func_80025ED4(s32, ?);                            /* extern */
? func_80026530(s32);                               /* extern */
void *func_800BE970(s32, s32);                      /* extern */
? func_800BEB98(s32);                               /* extern */
? func_800BEC88(s32);                               /* extern */
? func_800BEE30();                                  /* extern */
? func_800BEEDC();                                  /* extern */
? func_800EEA5C(s32 *, s16 *, s32 *, ?);            /* extern */

void func_800136AC(void *arg0) {
    s16 sp10;
    u16 sp12;
    s16 sp14;
    u16 sp16;
    ...
    func_800158B8(0);
    func_800BEE30();
    func_800BEB98(*(s32 *)0x8013E49C);
    temp_s5 = func_800BE970(*(s32 *)0x8013E49C, *(s32 *)0x8013E888);
    if (arg0->unk8 != 0) {
        temp_v0 = *(u32 *)0x8013ED58;
        var_s4 = (u32) (temp_v0 + (temp_v0 >> 0x1F)) >> 1;
    } else {
        var_s4 = (u32) (u16) *(void *)0x8013ED58;
    }
    func_800186A8();
    func_8001348C(arg0);
    if (((void *)0x8013F990->unk4 != 0) || ((void *)0x8013F990->unk24 != 0) || ((void *)0x8013F990->unk5 == 0x23) || ((void *)0x8013F990->unk25 == 0x23)) {
        temp_a1 = *(void *)0x800519A8;
        temp_a1->unk2C = (s32) (temp_a1->unk2C | 1);
        temp_a0 = arg0->unk4;
        sp20 = 0x200;
        if ((temp_a0 + (temp_a0->unk8 * 4))->unk10 == (temp_a1 + 0x2C)) {
            func_8001B0F0(temp_a1 + 0xB0, 0, &sp20, &sp18);
        }
    } else {
        temp_a0_2 = *(void **)0x800519A8;
        temp_a0_2->unk2C = (s32) (temp_a0_2->unk2C & ~1);
    }
    if (((void *)0x8013F990->unk4 != 0) || ((void *)0x8013F990->unk5 == 0x23)) {
        ...
        if (temp_v1_2 == temp_a0_3) {
            func_8001B0F0(temp_v1_2 + 0xB0, 0, &sp24, &sp18);
        }
    } else {
        temp_a0_4 = *(void *)0x800519A8;
    ...
    *temp_a2 = (*temp_a2 & 0xFF000000) | ((s32) temp_a0_5 & 0xFFFFFF);
    func_800EEA5C(temp_a0_5, &sp10, temp_a2, 0xFFFFFF);
    var_v0 = var_s4 << 0x10;
    do {
        arg0->unk22C = var_s3;
...
block_33:
        ...
        *temp_a2_2 = (*temp_a2_2 & 0xFF000000) | ((s32) temp_a0_9 & 0xFFFFFF);
        func_800EEA5C(temp_a0_9, &sp10, temp_a2_2, 0xFF000000);
        temp_v0_2 = var_s3 - 1;
        var_s3 = temp_v0_2;
        var_v0 = var_s4 << 0x10;
    } while (!(temp_v0_2 & 0x8000));
    arg0->unk22C = temp_s6;
    func_800BEC88(*(void *)0x8013E49C);
    func_800BEEDC();
}
