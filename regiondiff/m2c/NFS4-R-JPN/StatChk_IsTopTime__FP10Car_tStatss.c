/* NFS4-R-JPN CHANGED @80049C5C | base 80049D0C StatChk_IsTopTime__FP10Car_tStatss */
...
s32 func_80049C5C(void *arg0, s16 arg1) {
    ...
    var_s7 = 0;
    temp_s3 = func_80027C4C();
    func_800E4CF0(&sp10, 0, 8);
    func_800E4CF0(&sp18, 0, 8);
    func_800E4CF0(&sp20, 0, 8);
    temp_s8 = func_800E5D14(0x80012490, 0x168, 0x10);
    sp30 = func_800E5D14(0x8001249C, arg1 * 4, 0x10);
    var_a0 = 0;
    temp_s2 = func_800E5D14(0x800124A8, arg1 * 2, 0x10);
    sp28 = arg1;
    if (arg1 > 0) {
        var_v1 = 0 << 0x10;
        do {
...
loop_6:
    if ((var_s1 << 0x10) < ((u16) sp28 << 0x10)) {
        ...
        temp_a0 = func_8001622C(0x80115318, ((var_s1 * 0xA0) + arg0)->unk60);
        if (!(temp_a1 & 0x200)) {
            if ((u32) (temp_a0->unk2 - 7) >= 2U) {
                if (((u8) *(u8 *)0x801156A7 < 3U) && (temp_a1 & 4) && (temp_v1->unk80 == 2)) {
                    var_s7 = 1;
                }
                if (var_s7 == 1) {
        ...
        func_800E5F18(temp_s8, temp_a1);
        func_800E5F18(sp30);
        func_800E5F18(temp_s2);
        return 0;
    }
    if (sp10 != 0) {
        if (sp14 != 0) {
