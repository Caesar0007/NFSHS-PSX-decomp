/* NFS4-R-JPN CHANGED @8004A108 | base 8004A1B8 StatChk_SaveTopTime__FP10Car_tStatss */
/* callers: MenuExtended_FinishedPlayer1GetName__FR12tMenuCommand, MenuExtended_FinishedPlayer2GetName__FR12tMenuCommand */
void *func_8001622C(?, s16);                        /* extern */
s32 func_80027C4C();                                /* extern */
s16 func_8002B628();                                /* extern */
s32 func_8002B6C4(s16);                             /* extern */
? func_8004A808(?, s32 *, s16 (*)[], s32 (*)[]);    /* extern */
? func_8004ADBC(s16, s32);                          /* extern */
s32 func_800E5D14(?, s32, ?);                       /* extern */
? func_800E5F18(s32);                               /* extern */
? func_800E6500(s32 *, s32);                        /* extern */
s32 func_800E6754(s32, s32);                        /* extern */
? func_800E6CB4(s32, s32, ?);                       /* extern */
? func_800EB20C(s32, void *, s32);                  /* extern */

void func_8004A108(s32 arg0, u16 arg1) {
    s32 sp40;
    s32 sp48;
    s32 sp4C;
    s32 sp50;
    ...
    temp_s7 = func_800E5D14(0x80012490, 0x14 * 0x12, 0x10);
    sp84 = func_800E5D14(0x8001249C, (s16) sp60 * 4, 0x10);
    sp88 = func_800E5D14(0x800124A8, (s16) sp60 * 2, 0x10);
    var_s1_2 = 0;
    sp80 = func_800E5D14(0x800124B4, 0x14 * 8, 0x10);
    if ((s16) sp60 > 0) {
        var_v1 = 0 << 0x10;
        do {
    ...
    func_8004ADBC(func_8002B628(), temp_s7);
    sp70 = 9;
    if (func_80027C4C() == 2) {
        sp70 = 1;
    }
    ...
    if ((sp60 << 0x10) > 0) {
        ...
        do {
            ...
            temp_v0_3 = func_8001622C(0x80115318, ((*temp_s0 * 0xA0) + arg0)->unk60);
            var_v0_3 = var_s3 + 1;
            if ((u32) (temp_v0_3->unk2 - 7) >= 2U) {
                if ((u8) *(u8 *)0x801156A7 < 3U) {
                    var_v1_2 = (*temp_s0 * 0xA0) + arg0;
                    goto block_15;
                }
                temp_v1 = *temp_s0;
                if (temp_v1 == *(s32 *)0x801142AC) {
...
block_15:
                ...
                if ((var_s6 == 1) && ((temp_a1 = ((s32) (var_s3 << 0x10) >> 0xF) + sp88, temp_a0 = temp_s5->unk98, temp_v1_2 = ((*temp_a1 * 0xA0) + arg0)->unk88, var_s6 = 0, ((temp_a0 < temp_v1_2) == 0)) || ((var_v0_3 = var_s3 + 1, (temp_a0 == 0)) && (temp_v1_2 > 0)))) {
                    ...
                    func_8004A808(8, &sp10[0], (s16 (*)[]) &sp30[0], (s32 (*)[]) &sp10[0]);
                    var_s1_4 = 0;
                    var_v0_5 = 0 << 0x10;
                    do {
...
loop_33:
                    ...
                    var_s1_6 = 0;
                    func_800E6500(&sp40, func_8002B6C4(*(((s32) (var_s3 << 0x10) >> 0xF) + sp88)));
                    temp_s5->unk8C = sp40;
                    temp_s5->unk90 = sp44;
                    temp_s5->unk94 = sp48;
                    temp_s5->unk98 = sp4C;
                    temp_s5->unk9C = sp50;
                    func_800EB20C(sp80, temp_s5, 0x14 * 8);
                    var_v1_3 = 0 << 0x10;
                    do {
                        temp_v1_4 = var_v1_3 >> 0x10;
                        func_800EB20C(((sp70 + temp_v1_4) * 0x14) + temp_s7, sp80 + ((&sp30[0])[temp_v1_4] * 0x14), 0x14);
    ...
    if (sp68 == 1) {
        func_800E6CB4(temp_s7, (func_8002B628() * 0x154) + 0x80115E38, 0x154);
    }
    var_s1_7 = 0;
loop_42:
    if (var_s1_7 < 2) {
        if ((sp + (var_s1_7 * 4))->unk58 != 0) {
            ...
            do {
                ...
                if ((temp_s2->unkC == ((var_s1_7 * 0xA0) + arg0)->unk88) && (func_800E6754(temp_s7 + (temp_s0_2 - 0x14), func_8002B6C4(var_s1_7)) == 0)) {
                    *(0x800528D0 + (s32) var_s4) = 1;
                    temp_s2->unkC = 0;
                }
                var_s3_2 += 1;
                var_s4 += 4;
