/* NFS4-R-JPN CHANGED @800B908C | base 800B8604 Stats_ExtrapolateOpponentTimes__Fi */
/* callers: HandlePullOver__13AIHigh_Player, Sim_ProcessPause__Fv, Stats_TrackEndGame__Fv */
s32 func_800B8BDC(void *, void *, s32);             /* extern */
s32 func_800EB21C(s32, void *, s32);                /* extern */

void func_800B908C(s32 arg0, s32 arg2) {
    s32 temp_a0;
    s32 temp_a0_3;
    s32 temp_a0_4;
    s32 temp_a0_5;
    ...
    var_a2 = arg2;
    var_s2 = 0;
    var_s1 = (void **)0x80110AF8;
loop_1:
    if (var_s2 < *(s32 *)0x8013D8E0) {
        var_a1 = *var_s1;
        if (var_a1->unk390 != 2) {
            ...
            temp_lo = (s32) (var_a2 * ((*(s32 *)0x8013D8A8 * (void *)0x80114290->unk4) + var_a1->unk34C)) / var_a0;
            if (0 != 0) {
            ...
            if ((void *)0x80114290->unk1C == var_s2) {
                if (0 != 0) {
block_15:
                    (*var_s1)->unk390 = 2;
                } else {
block_16:
        ...
        if (arg0 == 1) {
            ...
            if (temp_a0 != 2) {
                ...
                temp_v1_2 = *var_s1;
                if ((temp_v1_2->unk390 != temp_a0) && ((void *)0x80114290->unk1C == var_s2)) {
                    if (0 != 0) {
            ...
            (*var_s1)->unk3D0 = func_800B8BDC(*var_s1, var_a1, var_a2);
            temp_v1_3 = *var_s1;
            temp_v1_3->unk3D4 = (s32) temp_v1_3->unk364;
            var_a1 = NULL;
            if ((void *)0x80114290->unk4 > 0) {
                do {
                    temp_v1_4 = *var_s1 + ((s32) var_a1 * 4);
                    temp_v1_4->unk3D8 = (s32) temp_v1_4->unk368;
                    var_a1 += 1;
                } while ((s32) var_a1 < (void *)0x80114290->unk4);
            }
        }
        (*var_s1)->unk3D0 = func_800B8BDC(*var_s1, var_a1);
        (*var_s1)->unk3D0 = func_800B8BDC(*var_s1);
        temp_v1_5 = *var_s1;
        ...
        if ((void *)0x80114290->unk4 > 0) {
            do {
                ...
                var_a1_3 += 1;
            } while (var_a1_3 < (void *)0x80114290->unk4);
        }
        var_s1 += 4;
        var_s2 += 1;
        goto loop_1;
    ...
    var_s2_2 = 0;
    var_s1_2 = (void **)0x80110B1C;
loop_42:
    if (var_s2_2 < *(s32 *)0x8013D8E4) {
        temp_a1 = *var_s1_2;
        if (temp_a1->unk390 != 2) {
            ...
            temp_s0 = (s32) (var_a2_2 * ((*(void *)0x8013D8A8 * (void *)0x80114290->unk4) + temp_a1->unk34C)) / var_a0_2;
            if ((0 == 0) && ((*(void **)0x80110AF8)->unk390 != 2)) {
                (*var_s1_2)->unk364 = (s32) (temp_s0 + ((s32) ((void *)0x80114290->unk4 * func_800EB21C(var_a0_2, temp_a1, var_a2_2)) / 128));
            } else {
                (*var_s1_2)->unk364 = temp_s0;
            }
            (*var_s1_2)->unk390 = 2;
        }
        (*var_s1_2)->unk3D0 = func_800B8BDC(*var_s1_2);
        temp_v1_12 = *var_s1_2;
        ...
        if ((void *)0x80114290->unk4 > 0) {
            do {
                ...
                var_a1_4 += 1;
            } while (var_a1_4 < (void *)0x80114290->unk4);
        }
        temp_a1_2 = *var_s1_2;
        temp_a0_4 = ((s32) temp_a1_2->unk3D4 / (s32) (void *)0x80114290->unk4) - (func_800EB21C((s32) var_a0_3, (void *) var_a1_4) / 48);
        ...
        if ((void *)0x80114290->unk4 > 0) {
            do {
                ...
                var_a1_5 += 1;
            } while (var_a1_5 < (void *)0x80114290->unk4);
        }
        var_s1_2 += 4;
        var_s2_2 += 1;
        goto loop_42;
    ...
    var_t0 = 0;
    if (0 == 0) {
        temp_t4 = *(s32 *)0x8013D8D8;
        var_t1 = (void **)0x80110AB0;
loop_70:
        var_a2_3 = 1;
        if (var_t0 < temp_t4) {
            var_a1_6 = 0;
            if (temp_t4 > 0) {
                var_a3 = (void **)0x80110AB0;
                do {
                    ...
                    var_a1_6 += 1;
                    var_a3 += 4;
                } while (var_a1_6 < *(void *)0x8013D8D8);
            }
            temp_v0_5 = *var_t1;
            var_t1 += 4;
            var_t0 += 1;
