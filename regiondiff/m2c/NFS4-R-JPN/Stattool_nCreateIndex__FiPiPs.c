/* NFS4-R-JPN CHANGED @8004A808 | base 8004A868 Stattool_nCreateIndex__FiPiPs */
...
void func_8004A808(s32 arg0, s32 *arg1, s16 *arg2) {
    s16 *var_t2;
    s16 *var_v1;
    s16 temp_t3;
    s16 var_s0;
    ...
    var_s0 = 0;
    temp_a0 = func_800E5D14(0x800124CC, (arg0 + 1) * 4, 0x10);
    if (arg0 > 0) {
        var_a2 = temp_a0;
        var_a1 = arg1;
        var_v1 = arg2;
