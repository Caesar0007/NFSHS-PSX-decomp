/* NFS4-R-UK-ES-IT REGION-ONLY @80075F28 */
...
s32 func_800E4F00(s32, s8);                         /* extern */
...
void func_80075F28(s32 arg0) {
    ...
    temp_v1 = arg0 * 0x50;
    temp_s7 = temp_v1 + 0x8010F5B0;
    temp_s2 = *(0x8010F5B0 + temp_v1);
    if (temp_s2 != NULL) {
        var_s1 = 0;
        if (temp_s2->unk260 & 0x200) {
            ...
            temp_s1 = func_800E4F00(temp_s2->unk108, ((temp_s2->unk8 << 5) + *(s32 *)0x8013DAE0)->unkF);
            temp_s0 = func_800E4F00(temp_s2->unk10C, ((temp_s2->unk8 << 5) + *(void *)0x8013DAE0)->unk10);
            var_s1 = temp_s1 + temp_s0 + func_800E4F00(temp_s2->unk110, ((temp_s2->unk8 << 5) + *(void *)0x8013DAE0)->unk11);
            if (*(s32 *)0x80114500 != 0) {
                var_s1 = -var_s1;
            }
        }
        if ((temp_s2->unk390 != 2) && (((temp_v1_2 = (void *)0x801144D0->unk0, (temp_v1_2 != 1)) && (temp_v1_2 != 5)) || (!((*(void **)0x80110D38)->unk260 & 0x200) && ((*(s32 *)0x8013DB20 != 2) || !(((void **)0x80110000 + 0xD38)->unk4->unk260 & 0x200))) || ((temp_s2->unk260 & 0x204) != 4)) && (temp_s2->unk460 == 0) && (temp_s2->unk278 == 0) && (var_s1 < 0)) {
            var_s0 = temp_s2 + 0xA0;
            if (temp_s2->unk17C == 0) {
                var_a0 = var_s0;
                if (temp_s2->unk78C == 0) {
                    ...
                    if ((temp_v1_3 >= 0x40) && !(temp_v1_3 & 0x1F) && ((temp_v1_3 < 0x94) || (*(s32 *)0x8013EC48 != 0))) {
                        var_s0 = temp_s2 + 0xA0;
...
block_24:
        ...
        if (*(s32 *)0x8013D994 != 0) {
            if (*(s32 *)0x801144DC == 1) {
                ...
                if (((arg0 * 0x110) + 0x8011059C)->unk70 == 0) {
                    goto block_30;
                }
                var_s5 = func_800754C8(0x8010F718, var_s0);
            }
        } else {
block_30:
            var_s5 = 0;
        }
        temp_s1_2 = func_80075440(0x8010F718, temp_s2 + 0xA0);
        if (func_800E4FDC(func_80075648(0x8010F718, temp_s2), temp_s1_2) <= 0x10000) {
            var_s3 = -0x10000;
            if (func_800E4FDC(func_80075648(0x8010F718, temp_s2), temp_s1_2) >= 0xFFFF0000) {
                goto block_35;
            }
        } else {
block_35:
            var_s3 = 0x10000;
            if (func_800E4FDC(func_80075648(0x8010F718, temp_s2), temp_s1_2) <= 0x10000) {
                var_s3 = func_800E4FDC(func_80075648(0x8010F718, temp_s2), temp_s1_2);
            }
        }
        var_v0 = temp_s1_2;
        if (temp_s1_2 < 0) {
        ...
        temp_v0 = func_8007571C(0x8010F718, temp_s2, var_a2);
            ...
            if (var_s3_2 >= 0) {
                ...
                do {
                    ...
                    if (((temp_v1_4 == 5) || (temp_v1_4 == 3)) && (var_s0_2 >= 0)) {
                        ...
                        if ((var_s0_2 < 0) && ((void *)0x801144D0->unkC != 1) && (temp_v1_5 = var_s1_2->unk7A0, (temp_v1_5 != 0xA)) && (temp_v1_5 != 8)) {
                            func_800754C8(0x8010F718, temp_s2 + 0x1A0);
                        }
