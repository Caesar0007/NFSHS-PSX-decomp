/* NFS4-R-UK-ES-IT CHANGED @80047F48 | base 80047AD8 DrawForeground__14tScreenMemcard */
...
void func_80047F48(void *arg0) {
    ...
    var_a0_2 = 0x38;
    do {
        func_8004EF68(var_a0_2, 0, 0, 0, (s32) var_a0, 0, 0);
        var_s0 += 1;
