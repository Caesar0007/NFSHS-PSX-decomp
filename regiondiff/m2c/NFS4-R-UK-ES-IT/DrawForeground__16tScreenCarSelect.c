/* NFS4-R-UK-ES-IT CHANGED @8003CB64 | base 8003C7D8 DrawForeground__16tScreenCarSelect */
? func_80015E78(?, s8);                             /* extern */
? func_80020F54(s32, s16, s16, s32, s32, s32);      /* extern */
s32 func_800237E4(?, void *);                       /* extern */
? func_800370D0(void *);                            /* extern */
? func_80037170(void *);                            /* extern */
? func_8003ACE4(s8 *, s16, s16, s32, s32, s32, s32, s32, s32); /* extern */
? func_8003B058(void *, s32);                       /* extern */
? func_8003BB78(void *, s16, s16, s16, s32, s32, s32 *, s32 *, s32 *, s32 *, s32 *); /* extern */
? func_8003C830(void *, ?, ?);                      /* extern */
? func_8003C844(void *, ?);                         /* extern */
s32 func_8004BDF8(s32, s32);                        /* extern */
? func_8004EF68(?, ?, ?, ?, s32, s32, ? *);         /* extern */
...
void func_8003CB64(void *arg0) {
    ...
    case 1:
        ...
        if (((void *)0x801158E4->unk4 == 2) && ((void *)0x801158E4->unk122 == 0) && (func_800237E4(0xD, temp_a1) != 0)) {
            temp_v1_3 = *(void **)0x800522E8;
...
block_9:
    ...
    do {
        ...
        if (temp_a0 != NULL) {
            if (temp_a0->unk16 != *(0x8005283C + (s32) (temp_a2_2 + (arg0->unk11C * 4)))) {
                temp_a0->unk14 = -1;
                var_v0_4 = var_s0 + 1;
...
block_35:
            temp_v1_5 = *(0x8005283C + (s32) (temp_a2_2 + (arg0->unk11C * 4)));
            if (temp_v1_5 >= 0) {
...
block_37:
    ...
    var_v0_5 = 1 << 0x10;
    do {
        func_8003B058(arg0, (arg0 + (var_v0_5 >> 0xE))->unk10C);
    ...
    if ((*(0x80053300 + ((*(void *)0x80051DB0)->unk22C * 4)))->unk8D8 != 0) {
        func_8003C830(arg0, 0, 0);
        func_800370D0(arg0 + 0x304);
        arg0->unk37C = (s32) *(s32 *)0x8013EFB8;
    }
    func_8003C844(arg0, 0);
    if ((u32) ((u16) arg0->unk11C - 5) >= 2U) {
        *(s32 *)0x80051B50 = 0;
        arg0->unk39C = (s32) (arg0->unk39C + 3);
        func_8003ACE4(&sp30, 0x13A, 0x54, 0x40800000, 0xC0F00000, (s32) arg0->unk374, 1, arg0->unk39C, 0);
    } else {
        sp120 = 0;
        sp124 = 0;
        sp128 = 0;
        ...
        if ((temp_t0 >= 0) && (spF1 >= 0)) {
            ...
            var_s2 = *(0x80051F58 + (((func_800B9F3C(temp_s4, temp_a1_4) * 6) + 0x80051EA8)->unk4 * 4));
            if (temp_s1 < 0x80U) {
                var_a1 = 0x80 - temp_s1;
                goto block_52;
            }
...
block_52:
                var_s2 = func_8004BDF8(var_s2, var_a1);
            }
            temp_s0_2 = func_800B9F1C(temp_s4);
            temp_s1_2 = func_800B9F5C(temp_s4);
            func_80020F54(temp_s0_2, temp_s1_2, func_800B9F7C(temp_s4), var_s2, 0, 0);
        }
        sp104 = 0x551E00;
        sp114 = arg0->unk28;
        ...
        if ((arg0->unk3A & 1) && (var_t1 < 0x80)) {
            func_8004EF68(0xA, 0x200, 0, 0, var_t1, 0, &sp100);
        }
...
loop_61:
        ...
        (void *)0x800534B0->unk0 = 0;
        if ((s16) var_a1_2 >= 7) {
            var_a1_2 -= 5;
            (void *)0x800534B0->unk0 = 0x04000000;
        }
        temp_v0_7 = var_a1_2 + 1;
        var_a2 = temp_v0_7;
        temp_v1_7 = (void *)0x800534B0->unk0;
        (void *)0x800534B0->unk4 = temp_v1_7;
        if (temp_v0_7 >= 7) {
            var_a2 = var_a1_2 - 4;
            (void *)0x800534B0->unk4 = (s32) (temp_v1_7 + 0x04000000);
        }
        temp_v0_8 = var_a2 + 1;
        var_a3 = temp_v0_8;
        temp_v1_8 = (void *)0x800534B0->unk4;
        (void *)0x800534B0->unk8 = temp_v1_8;
        if (temp_v0_8 >= 7) {
            var_a3 = var_a2 - 4;
            (void *)0x800534B0->unk8 = (s32) (temp_v1_8 + 0x04000000);
        }
        temp_v0_9 = var_a3 + 1;
        var_t1_2 = temp_v0_9;
        temp_v1_9 = (void *)0x800534B0->unk8;
        (void *)0x800534B0->unkC = temp_v1_9;
        if (temp_v0_9 >= 7) {
            var_t1_2 = var_a3 - 4;
            (void *)0x800534B0->unkC = (s32) (temp_v1_9 + 0x04000000);
        }
        func_8003BB78(arg0, (s16) var_a1_2, var_a2, var_a3, (s32) var_t1_2, var_t0, &sp118, &sp11C, &sp120, &sp124, &sp128);
        *(void *)0x80051B50 = 1;
        temp_s1_3 = func_800F3E38(func_800F6BAC(sp118), 0x37800000);
        func_8003ACE4(&sp30, (s16) sp120, (s16) sp124, temp_s1_3, func_800F3E38(func_800F6BAC(sp11C), 0x37800000), (s32) arg0->unk374, 1, sp128, 0);
        if ((temp_v0 != 0) && ((u32) (func_800E8DF8() - arg0->unk390) >= 0x281U) && (arg0->unk394 == 0) && (spF1 >= 0)) {
            arg0->unk394 = 1;
            func_80015E78(0, spF1);
        }
    }
    if ((*(void **)0x80053300)->unk8D8 == 0) {
        ...
        if ((temp_v1_10 == arg0->unk378) && (temp_v1_10 == 0) && ((*(void *)0x8013EFB8 - arg0->unk37C) >= 0x81)) {
            ...
            func_8003C830(arg0, var_a1_3, 0);
            func_80037170(arg0 + 0x304);
        }
    }
}
