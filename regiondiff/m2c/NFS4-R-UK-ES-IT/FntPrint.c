/* NFS4-R-UK-ES-IT CHANGED @800F79BC | base 800F7034 FntPrint */
s32 func_800EA8BC(s32, s32, s32);                   /* extern */

s32 func_800F79BC(s32 arg0, s32 arg1, s32 arg2, s32 arg3) {
    s32 *sp210;
    s32 **var_s0;
    s32 temp_a2;
    s32 temp_v0;
    ...
    var_a1 = arg1;
    sp210 = &arg1;
    if ((arg0 < 0) || (arg0 >= *(s32 *)0x801372F4)) {
        temp_v0 = *(s32 *)0x801372F8;
        var_s3 = arg0;
        arg0 = temp_v0;
        if (((temp_v0 * 0x30) + 0x80130000)->unk7198 == 0) {
            goto block_3;
        }
        goto block_5;
    }
...
loop_28:
                ...
                do {
                    ...
                    var_a1 += 1;
                    *var_s0 = (u8) *(*(s32 *)0x80137D00 + temp_v0_6);
                    if (var_a1 == 0) {
                        goto loop_28;
                    }
                    var_s0 -= 1;
            ...
            case 0x73:
                var_s0 = (s32 **) *sp210;
                sp210 += 4;
                var_a1 = func_800EA8BC((s32) var_s0, var_a1, temp_a2);
                goto block_37;
            }
        } else {
block_46:
