/* NFS4-R-UK-ES-IT CHANGED @80029370 | base 8002921C Front_InitTrack__FR9tFEStream */
/* callers: Front_BuildStream__FPi */
? func_80021CAC(?, u8, void *);                     /* extern */
s32 func_80021F08(?, s8);                           /* extern */
? func_800328C4(?, s32);                            /* extern */
? func_800E6EB4(s32, void *, ?);                    /* extern */
s32 func_800EB41C();                                /* extern */

void func_80029370(void *arg0) {
    u8 temp_v1;
    void *temp_a0;

    if ((void *)0x801158E4->unk4 == 2) {
        func_800328C4(0x80115DBC, arg0 + 0x2C0);
        func_800E6EB4(func_80021F08(0x80115D34, arg0->unk2C0), arg0 + 0x290, 0x30);
    } else {
        func_80021CAC(0x80115D34, ((void *)0x801158E4->unk46 + 0x801158E4)->unk23, arg0 + 0x290);
