/* NFS4-R-UK-ES-IT CHANGED @80034FF4 | base 80034E18 LoadGame__FsbT1 */
...
? func_80016C34(s32, ? *, s32);                     /* extern */
? func_80016D48(?, ? *, s32);                       /* extern */
? func_80018A18(? *);                               /* extern */
? func_80018ADC(? *);                               /* extern */
? func_80021C58(?, ? *);                            /* extern */
? func_80023820(? *);                               /* extern */
? func_800260E4(? *, s16);                          /* extern */
? func_8002613C(? *, ?);                            /* extern */
? func_800271AC(s16, u8);                           /* extern */
? func_800275D4();                                  /* extern */
? func_80033768(?, s32 *);                          /* extern */
...
s32 func_80034FF4(s16 arg0, s32 arg1, s32 arg2) {
    ? sp10;
    ? sp14;
    ? sp18;
    ? sp37C;
...
loop_11:
    func_80034608();
    sp1694 += 1;
    func_80034ACC(&sp1658, temp_s4, 1);
loop_12:
    if (func_80050770(temp_s4) == 0x15) {
        func_800DCED0();
        func_800F2CA4(0);
        goto loop_12;
    }
...
loop_15:
    if (var_s1 == 0) {
        func_800DCED0();
        temp_s0 = func_80050770(temp_s4);
        func_800E77DC(0);
        func_800F2CA4(0);
        switch (temp_s0) {
        case 22:
            func_8004FFA8(temp_s4, &sp1658, 0);
            break;
        case 15:
            if (func_80034530(&sp10) != 0) {
                ...
                if (arg1 == 0) {
                    if (temp_s5 == 0) {
                        ...
                        func_80033768(0x80115DBC, &sp558);
                        func_80021C58(0x80115D34, &sp548);
                        func_800E6EB4(&sp608, 0x80116078, 0xE9C);
                        func_80023820(&sp14);
                    } else {
                        func_800E5094(temp_s8 + 0x80115C48, &sp37C);
                    }
                    func_80016C34(0x80115558, &sp468, sp1698 >> 0x10);
                } else {
                    temp_s7->unk43C = sp14A4;
                    func_80016D48(0x80115558, &sp468, temp_s5);
                    func_800E5094(temp_s8 + 0x80115C48, &sp37C);
                    temp_s7->unk4C = sp558;
                }
                var_s2 = 0x28E;
                ...
                temp_s0_2 = func_80050B34(temp_s6 + 1);
...
block_35:
        ...
        case 16:
        case 23:
            temp_s0_4 = func_80050B34(temp_s6 + 1);
            func_80018ADC(*(void *)0x80051DB0 + 0x2D0);
            temp_s0_5 = *temp_s0_4;
            if (temp_s0_5 == -2) {
                goto block_31;
...
loop_36:
    ...
    if (arg2 != 0) {
        if (*(void *)0x80052308 == 0) {
            func_80018ADC(*(void *)0x80051DB0 + 0x2D0);
            func_80018ADC(*(void *)0x80051DB0 + 0x238);
            temp_s0_6 = *(void *)0x80051DB0 + 0x238;
            temp_s0_6->unk90 = func_800B9F1C(var_s2 + (s16) (u16) sp1688);
            func_80018A18(*(void *)0x80051DB0 + 0x238);
loop_43:
            temp_a0 = *(void *)0x80051DB0;
            if ((temp_a0->unk2BC ^ 1) != 0) {
                func_80013924(temp_a0);
                goto loop_43;
            }
            func_80013924(temp_a0);
        }
    }
    func_800271AC((s16) (u16) sp1688, ((s16) (u16) sp1688 + 0x801158E4)->unk362);
    if (arg1 == 0) {
