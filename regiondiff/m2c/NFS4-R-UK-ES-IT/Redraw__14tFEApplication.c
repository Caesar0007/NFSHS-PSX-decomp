/* NFS4-R-UK-ES-IT CHANGED @80013924 | base 8001373C Redraw__14tFEApplication */
...
? func_8001352C(void *);                            /* extern */
? func_80015B08(?);                                 /* extern */
? func_800188F8();                                  /* extern */
? func_8001B42C(void *, ?, s32 *, ? *);             /* extern */
? func_800262B0(s32, ?);                            /* extern */
? func_8002690C(s32);                               /* extern */
? func_8004DD3C(?, ?);                              /* extern */
...
void func_80013924(void *arg0) {
    ...
    if (((void *)0x8013FBD0->unk4 != 0) || ((void *)0x8013FBD0->unk24 != 0)) {
        ...
        if ((temp_a0 + (temp_a0->unk8 * 4))->unk10 == (temp_a1 + 0x2C)) {
            func_8001B42C(temp_a1 + 0xB0, 0, &sp20, &sp18);
        }
    } else {
        temp_a0_2 = *(void **)0x800522E8;
        temp_a0_2->unk2C = (s32) (temp_a0_2->unk2C & ~1);
    }
    if (*(u8 *)0x8013FBD4 != 0) {
        temp_a0_3 = *(void *)0x800522E8;
        temp_a0_3->unk0 = (s32) (temp_a0_3->unk0 | 1);
        temp_v1 = arg0->unk4;
        temp_v1_2 = (temp_v1 + (temp_v1->unk8 * 4))->unk10;
        sp24 = 0x400;
        if (temp_v1_2 == temp_a0_3) {
            func_8001B42C(temp_v1_2 + 0xB0, 0, &sp24, &sp18);
        }
    } else {
        temp_a0_4 = *(void *)0x800522E8;
