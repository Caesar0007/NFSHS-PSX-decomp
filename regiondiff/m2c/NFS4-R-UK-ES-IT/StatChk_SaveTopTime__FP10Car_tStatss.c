/* NFS4-R-UK-ES-IT CHANGED @8004A6D0 | base 8004A1B8 StatChk_SaveTopTime__FP10Car_tStatss */
/* callers: MenuExtended_FinishedPlayer1GetName__FR12tMenuCommand, MenuExtended_FinishedPlayer2GetName__FR12tMenuCommand */
void *func_8001647C(?, s16);                        /* extern */
s32 func_800280F0();                                /* extern */
s16 func_8002BACC();                                /* extern */
s32 func_8002BB68(s16);                             /* extern */
? func_8004ADD0(?, s32 *, s16 (*)[], s32 (*)[]);    /* extern */
? func_8004B384(s16, s32);                          /* extern */
...
void func_8004A6D0(s32 arg0, u16 arg1) {
    s32 sp40;
    s32 sp48;
    s32 sp4C;
    s32 sp50;
    ...
    func_8004B384(func_8002BACC(), temp_s7);
    sp70 = 9;
    if (func_800280F0() == 2) {
        sp70 = 1;
    }
    ...
    if ((sp60 << 0x10) > 0) {
        ...
        do {
            ...
            temp_v0_3 = func_8001647C(0x80115558, ((*temp_s0 * 0xA0) + arg0)->unk60);
            var_v0_3 = var_s3 + 1;
...
block_15:
                ...
                if ((var_s6 == 1) && ((temp_a1 = ((s32) (var_s3 << 0x10) >> 0xF) + sp88, temp_a0 = temp_s5->unk98, temp_v1_2 = ((*temp_a1 * 0xA0) + arg0)->unk88, var_s6 = 0, ((temp_a0 < temp_v1_2) == 0)) || ((var_v0_3 = var_s3 + 1, (temp_a0 == 0)) && (temp_v1_2 > 0)))) {
                    ...
                    func_8004ADD0(8, &sp10[0], (s16 (*)[]) &sp30[0], (s32 (*)[]) &sp10[0]);
                    var_s1_4 = 0;
                    var_v0_5 = 0 << 0x10;
                    do {
...
loop_33:
                    ...
                    var_s1_6 = 0;
                    func_800E6700(&sp40, func_8002BB68(*(((s32) (var_s3 << 0x10) >> 0xF) + sp88)));
                    temp_s5->unk8C = sp40;
                    temp_s5->unk90 = sp44;
                    temp_s5->unk94 = sp48;
                    temp_s5->unk98 = sp4C;
    ...
    if (sp68 == 1) {
        func_800E6EB4(temp_s7, (func_8002BACC() * 0x154) + 0x80116078, 0x154);
    }
    var_s1_7 = 0;
loop_42:
    if (var_s1_7 < 2) {
        if ((sp + (var_s1_7 * 4))->unk58 != 0) {
            ...
            do {
                ...
                if ((temp_s2->unkC == ((var_s1_7 * 0xA0) + arg0)->unk88) && (func_800E6954(temp_s7 + (temp_s0_2 - 0x14), func_8002BB68(var_s1_7)) == 0)) {
                    *(0x80053210 + (s32) var_s4) = 1;
                    temp_s2->unkC = 0;
                }
                var_s3_2 += 1;
                var_s4 += 4;
