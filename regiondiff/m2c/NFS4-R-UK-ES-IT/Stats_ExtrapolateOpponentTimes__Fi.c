/* NFS4-R-UK-ES-IT CHANGED @800B92DC | base 800B8604 Stats_ExtrapolateOpponentTimes__Fi */
/* callers: HandlePullOver__13AIHigh_Player, Sim_ProcessPause__Fv, Stats_TrackEndGame__Fv */
s32 func_800B8E2C(void *, void *, s32);             /* extern */
s32 func_800EB41C(s32, void *, s32);                /* extern */

void func_800B92DC(s32 arg0, s32 arg2) {
    s32 temp_a0;
    s32 temp_a0_3;
    s32 temp_a0_4;
    s32 temp_a0_5;
    ...
    var_a2 = arg2;
    var_s2 = 0;
    var_s1 = (void **)0x80110D38;
loop_1:
    if (var_s2 < *(s32 *)0x8013DB20) {
        var_a1 = *var_s1;
        if (var_a1->unk390 != 2) {
            ...
            temp_lo = (s32) (var_a2 * ((*(s32 *)0x8013DAE8 * (void *)0x801144D0->unk4) + var_a1->unk34C)) / var_a0;
            if (0 != 0) {
            ...
            if ((void *)0x801144D0->unk1C == var_s2) {
                if (0 != 0) {
block_15:
                    (*var_s1)->unk390 = 2;
                } else {
block_16:
        ...
        if (arg0 == 1) {
            ...
            if (temp_a0 != 2) {
                ...
                temp_v1_2 = *var_s1;
                if ((temp_v1_2->unk390 != temp_a0) && ((void *)0x801144D0->unk1C == var_s2)) {
                    if (0 != 0) {
            ...
            (*var_s1)->unk3D0 = func_800B8E2C(*var_s1, var_a1, var_a2);
            temp_v1_3 = *var_s1;
            temp_v1_3->unk3D4 = (s32) temp_v1_3->unk364;
            var_a1 = NULL;
            if ((void *)0x801144D0->unk4 > 0) {
                do {
                    temp_v1_4 = *var_s1 + ((s32) var_a1 * 4);
                    temp_v1_4->unk3D8 = (s32) temp_v1_4->unk368;
                    var_a1 += 1;
                } while ((s32) var_a1 < (void *)0x801144D0->unk4);
            }
        }
        (*var_s1)->unk3D0 = func_800B8E2C(*var_s1, var_a1);
        (*var_s1)->unk3D0 = func_800B8E2C(*var_s1);
        temp_v1_5 = *var_s1;
        ...
        if ((void *)0x801144D0->unk4 > 0) {
            do {
                ...
                var_a1_3 += 1;
            } while (var_a1_3 < (void *)0x801144D0->unk4);
        }
        var_s1 += 4;
        var_s2 += 1;
        goto loop_1;
    ...
    var_s2_2 = 0;
    var_s1_2 = (void **)0x80110D5C;
loop_42:
    if (var_s2_2 < *(s32 *)0x8013DB24) {
        temp_a1 = *var_s1_2;
        if (temp_a1->unk390 != 2) {
            ...
            temp_s0 = (s32) (var_a2_2 * ((*(void *)0x8013DAE8 * (void *)0x801144D0->unk4) + temp_a1->unk34C)) / var_a0_2;
            if ((0 == 0) && ((*(void **)0x80110D38)->unk390 != 2)) {
                (*var_s1_2)->unk364 = (s32) (temp_s0 + ((s32) ((void *)0x801144D0->unk4 * func_800EB41C(var_a0_2, temp_a1, var_a2_2)) / 128));
            } else {
                (*var_s1_2)->unk364 = temp_s0;
            }
            (*var_s1_2)->unk390 = 2;
        }
        (*var_s1_2)->unk3D0 = func_800B8E2C(*var_s1_2);
        temp_v1_12 = *var_s1_2;
        ...
        if ((void *)0x801144D0->unk4 > 0) {
            do {
                ...
                var_a1_4 += 1;
            } while (var_a1_4 < (void *)0x801144D0->unk4);
        }
        temp_a1_2 = *var_s1_2;
        temp_a0_4 = ((s32) temp_a1_2->unk3D4 / (s32) (void *)0x801144D0->unk4) - (func_800EB41C((s32) var_a0_3, (void *) var_a1_4) / 48);
        ...
        if ((void *)0x801144D0->unk4 > 0) {
            do {
                ...
                var_a1_5 += 1;
            } while (var_a1_5 < (void *)0x801144D0->unk4);
        }
        var_s1_2 += 4;
        var_s2_2 += 1;
        goto loop_42;
    ...
    var_t0 = 0;
    if (0 == 0) {
        temp_t4 = *(s32 *)0x8013DB18;
        var_t1 = (void **)0x80110CF0;
loop_70:
        var_a2_3 = 1;
        if (var_t0 < temp_t4) {
            var_a1_6 = 0;
            if (temp_t4 > 0) {
                var_a3 = (void **)0x80110CF0;
                do {
                    ...
                    var_a1_6 += 1;
                    var_a3 += 4;
                } while (var_a1_6 < *(void *)0x8013DB18);
            }
            temp_v0_5 = *var_t1;
            var_t1 += 4;
            var_t0 += 1;
