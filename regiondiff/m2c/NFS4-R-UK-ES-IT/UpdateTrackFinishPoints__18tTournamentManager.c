/* NFS4-R-UK-ES-IT CHANGED @80033068 | base 80032E30 UpdateTrackFinishPoints__18tTournamentManager */
/* callers: AdvanceToNextTrack__18tTournamentManager */
s16 func_800337B0();                                /* extern */
? func_800E6964(void *, s16, ?, ?);                 /* extern */

void func_80033068(void *arg0) {
    s16 temp_t0;
    s16 var_a3;
    s32 temp_a1;
    s32 temp_a2;
    ...
    if (((((temp_a1 + (arg0->unk4 * 0xC))->unk2 + arg0->unk8) * 0x54) + temp_a1)->unk29 != 0) {
        ...
        if (temp_t0 > 0) {
            ...
            do {
                if (var_a1->unk120 == 0) {
                    temp_v1 = (var_a3 * 0xA0) + 0x80110E34;
    ...
    func_800E6964(arg0 + 0x237, temp_t0, 1, 0x80032C88);
    var_a0_4 = 0;
    var_v0_2 = arg0;
    do {
        var_a0_4 += 1;
