/* NFS4-R-UK-SW CHANGED @80038DC8 | base 80038B68 DrawBackground__16tScreenPinkSlips */
? func_80021370(s16, s16, s16, ?, s32, s32);        /* extern */
? func_80021C94(s32, u8, s8 *);                     /* extern */
s16 func_80021FC4(s32, ?);                          /* extern */
? func_8002253C(void *);                            /* extern */
? func_80025EB8(void *, void *);                    /* extern */
? func_8002607C(void *, ?);                         /* extern */
? func_80039664(void *, s8 *);                      /* extern */
? func_80039710(void *);                            /* extern */
? func_8004C508(?, s16 *, ?);                       /* extern */
? func_8004DC40(?);                                 /* extern */
? func_8004EF24(?, ?, s32, s16, s32, s32, s32);     /* extern */
? func_8004F4F0(?, ?, ?, s32, s32);                 /* extern */
? func_8004F77C(s32, s16, s16, ?, s32, s32);        /* extern */
? func_80051740(s32, ? *);                          /* extern */
? func_8005179C(s32);                               /* extern */
s32 func_80051840(s32);                             /* extern */
s32 func_800518E8(s32, ?, u32);                     /* extern */
...
void func_80038DC8(void *arg0) {
    ...
    if (arg0->unk5C >= 0x64) {
        ...
        func_8004F4F0(0, 0x1E0, 0xDC, -func_800E4A18(func_800B9F1C(0x27E)) - 5, 7);
        var_s2 = 0;
    }
    sp20 = 0x15B;
    sp22 = 0x8F;
...
loop_3:
    ...
    if (var_s2 < (s32) (void *)0x801158E4->unk47) {
        ...
        if (var_a1 != 0) {
            temp_v0 = *(s32 *)0x80053440 + 1;
            *(s32 *)0x80053440 = temp_v0;
            if (temp_v0 >= 0x3D) {
                *(s32 *)0x80053440 = 0;
            }
            var_v1 = *(s32 *)0x80053440;
            ...
            if (temp_lo > 0) {
                ...
                func_8004EF24(0x38, 0, sp20 - 0x12, sp22, (s32) arg0->unk5C, 1, 0);
            }
            var_s0 = 2;
        }
        func_80021C94(0x80115D34, (var_s2 + 0x801158E4)->unk23, &sp28);
        (void *)0x801158E4->unk46 = (u8) var_s2;
        func_80021370(func_80021FC4(*(s32 *)0x800522A0 + 0xC88, -1), (s16) ((u16) sp20 + 0xA), (s16) ((u16) sp22 + 3), 0, var_s0, 1);
        func_8004C508(-1, &sp20, 1);
        var_s2 += 1;
        sp22 = (u16) sp22 + 0xE;
        goto loop_3;
    }
    ...
    func_80021C94(0x80115D34, ((void *)0x801158E4->unk46 + 0x801158E4)->unk23, &sp28);
    func_80039664(arg0, &sp28);
    func_80025EB8(arg0, arg0 + 0x28);
    if ((arg0->unk2C != 0) && (arg0->unk80 >= 0)) {
        func_8002607C(arg0, 4);
        arg0->unk80 = 1;
    ...
    spA8 = temp_s0;
    if (func_80051840(arg0->unk68) != 0) {
        var_s3 = 0;
        if (func_800518E8(arg0->unk68, 0x200, (u32) (temp_s0 << 0x10) >> 0x10) != 0) {
...
loop_27:
        ...
        if ((u32) (*(void *)0x8013EFB8 - arg0->unk7C) >= 0x101U) {
            ...
            func_80051740(arg0->unk68, &sp58);
            var_s2_3 = 0xF0;
            func_8005179C(arg0->unk68);
        }
    }
    do {
        func_8004F77C(0x303030, var_s2_3, 0xF, 2, 0x81, 1);
        temp_v0_4 = var_s2_3 + 0x50;
        var_s2_3 = temp_v0_4;
    } while (temp_v0_4 < 0x1E0);
    var_s2_4 = 0x4F;
    do {
        func_8004F77C(0x202020, 0xA0, var_s2_4, 0x141, 1, 1);
    ...
    var_s2_5 = 0;
    do {
        func_8002253C(arg0 + ((var_s2_5 * 0x30) + 0x84));
