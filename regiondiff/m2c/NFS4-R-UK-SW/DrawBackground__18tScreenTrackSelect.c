/* NFS4-R-UK-SW CHANGED @80041A48 | base 80041600 DrawBackground__18tScreenTrackSelect */
...
void func_80041A48(void *arg0) {
    ...
    sp16 = 0xC;
    sp12 = 0xD0;
    func_8004C508(func_80021FC4(*(s32 *)0x800522A0 + 0xC88, -1), &sp10, 0);
    ...
    var_s6 = temp_s0_2;
    temp_v0 = func_80051840(arg0->unk64);
    if (temp_v0 == 1) {
        sp4C = 0xAA;
        sp48 = 0x200;
        sp4A = 0;
        ...
        if (func_800518E8(arg0->unk64, 0x200, (u32) (temp_s0_2 << 0x10) >> 0x10) != 0) {
        ...
        func_80051740(arg0->unk64, &sp50);
        func_8005179C(arg0->unk64);
    }
    if (arg0->unk70 > 0) {
