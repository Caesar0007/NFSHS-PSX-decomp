/* NFS4-R-UK-SW CHANGED @800236C4 | base 80023614 FECheat_ActivateCheat__FPc */
...
loop_1:
    ...
    if (var_s2 < 3) {
        var_v0 = var_a2;
loop_3:
        if (*(0x80051ED0 + (s32) var_v0) == *(&sp10 + var_a1)) {
            var_a1 += 1;
        ...
        temp_s0 = *(s32 *)0x80051D68 + 0x238;
        temp_s0->unk90 = func_800B9F1C(0x27B);
        func_80018A00(*(s32 *)0x80051D68 + 0x238);
        temp_s0_2 = (var_s2 * 0xC) + 0x80051ED0;
        var_s1 = 1;
