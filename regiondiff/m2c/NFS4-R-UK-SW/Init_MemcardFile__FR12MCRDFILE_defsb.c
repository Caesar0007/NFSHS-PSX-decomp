/* NFS4-R-UK-SW CHANGED @80034AB4 | base 800348A0 Init_MemcardFile__FR12MCRDFILE_defsb */
...
void func_80034AB4(void *arg0, s32 arg2) {
    ...
    if (arg2 != 0) {
        *(s8 *)0x800533B8 = 0;
        ...
        func_800E5094(0x800533B8, 0x8001168C);
    }
    arg0->unk4 = (void *) ((s8 *)0x80050000 + 0x33B8);
    arg0->unk8 = 0x1500;
    arg0->unkC = 0;
    arg0->unk10 = 0;
}
