/* NFS4-R-UK-SW CHANGED @8003C2D0 | base 8003BF90 ProcessInput__16tScreenCarSelect7tPlayerR13tInputKeyTypeR12tMenuCommand */
...
void func_8003C2D0(void *arg0, s32 *arg2) {
    ...
    if (*arg2 == 8) {
        ...
        if ((*(void **)0x80051D68)->unk22C == 0) {
            var_a0 = *(void **)0x800522A0 + 0x2018;
        } else {
            var_a0 = *(void *)0x800522A0 + 0x2078;
        }
        var_a0->unk4 = 0x10C;
