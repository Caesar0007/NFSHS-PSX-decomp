/* NFS4-R-UK-SW CHANGED @8001416C | base 80014014 RunDemoVideo__14tFEApplication */
...
void func_8001416C(void *arg0) {
    ...
    if (arg0->unk4 == (*(s32 *)0x800522A0 + 0xB0)) {
        func_8007B798(0x78);
        func_80015AF0(0);
        temp_v1 = arg0->unk4;
...
loop_2:
        ...
        *(u8 *)0x80051D64 = (s32) (5 - (s32) *(u8 *)0x80051D64);
        func_80013EB8(arg0);
