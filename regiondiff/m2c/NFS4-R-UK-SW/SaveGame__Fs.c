/* NFS4-R-UK-SW CHANGED @80034B34 | base 80034988 SaveGame__Fs */
...
loop_11:
    if (var_s3 == 0) {
        func_800DCED0();
        temp_s0_2 = func_80050728((s16) (u16) sp16C8);
        func_800E77DC(0);
        func_800F2CA4(0);
        ...
        if (temp_s0_3 < 0x16U) {
            ...
            case 8:
            case 9:
                temp_v1 = *func_80050AEC(((s32) (arg0 << 0x10) >> 0xE) + 1);
                var_s2 = 0x29E;
                if (temp_v1 != -3) {
                    var_s2 = 0x326;
                    if (temp_v1 == -1) {
...
loop_22:
    if (func_80050728((s16) (u16) sp16C8) != 0x16) {
        func_800DCED0();
        func_800F2CA4(0);
        goto loop_22;
    }
