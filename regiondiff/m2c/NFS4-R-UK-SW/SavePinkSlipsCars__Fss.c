/* NFS4-R-UK-SW CHANGED @800355EC | base 800353F0 SavePinkSlipsCars__Fss */
...
loop_4:
    if (var_s3 == 0) {
        func_800DCED0();
        temp_s0 = func_80050728((s16) (u16) sp1638);
        func_800E77DC(0);
        func_800F2CA4(0);
        switch (temp_s0) {                          /* switch 1 */
        case 22:                                    /* switch 1 */
            func_8004FF60((s16) (u16) sp1638, &sp1600, 0);
            break;
        case 15:                                    /* switch 1 */
...
loop_12:
                    if (func_80050728((s16) (u16) sp1638) == 0x15) {
...
loop_15:
                    if (var_s5 == 0) {
                        func_800DCED0();
                        temp_s0_2 = func_80050728((s16) (u16) sp1638);
                        func_800E77DC(0);
                        func_800F2CA4(0);
                        switch (temp_s0_2) {        /* switch 2 */
                        case 22:                    /* switch 2 */
                            if ((void *)0x800535B8->unk34 != 0) {
                                func_800502F4((s16) (u16) sp1638, &sp1600);
                            }
                            break;
                        case 12:                    /* switch 2 */
                            var_s5 = 1;
                        ...
                        case 13:                    /* switch 2 */
                        case 23:                    /* switch 2 */
                            func_80018AC4(*(s32 *)0x80051D68 + 0x2D0);
                            temp_v1 = *func_80050AEC(temp_s4 + 1);
                            var_s2 = 6;
                            if (temp_v1 != -3) {
                                var_s2 = 3;
                                if (temp_v1 == -1) {
            ...
            case 2:                                 /* switch 1 */
            case 16:                                /* switch 1 */
                temp_v1_2 = *func_80050AEC(temp_s4 + 1);
                var_s2 = 5;
                if (temp_v1_2 != -2) {
                    var_s2 = 2;
                    if (temp_v1_2 == -1) {
...
loop_31:
    if (func_80050728((s16) (u16) sp1638) != 0x16) {
        func_800DCED0();
        func_800F2CA4(0);
        goto loop_31;
    }
