/* NFS4-R-UK-SW CHANGED @80049D40 | base 80049840 StatChk_IsRecordLapTime__FP10Car_tStatssPs */
...
s16 func_8002BAB4(s16);                             /* extern */
? func_8004ADB8(s16, s16 *, s16 *, u16);            /* extern */
? func_8004B36C(s16, s16 *);                        /* extern */
s16 func_8004B418();                                /* extern */
s16 *func_800E5F14(?, s32, ?);                      /* extern */
? func_800E6118(s16 *);                             /* extern */
? func_800EB40C(? *, s16 *, ?);                     /* extern */

u16 func_80049D40(s32 arg0, s16 arg1, u16 *arg2) {
    ? sp10;
    s16 sp28;
    u16 sp30;
    s32 sp38;
...
loop_4:
        ...
        temp_v0 = func_80016464(0x80115558, temp_s0->unk60);
...
block_9:
    if ((s16) (u16) sp28 >= 2) {
        func_8004ADB8((s16) (u16) sp28, temp_s5, temp_s4, (u16) sp28);
    } else {
        *temp_s4 = 0;
    }
    var_a0 = 0;
...
loop_14:
    ...
    if ((var_s6 << 0x10) == 0) {
        ...
        func_8004B36C(func_8002BAB4(var_a0), temp_s8);
