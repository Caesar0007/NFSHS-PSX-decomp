/* NFS4-R-USA CHANGED @80075A30 | base 80075508 AudioClc_SoundPlayersCar__Fi */
...
void func_80075A30(s32 arg0, s32 arg1) {
    ...
    temp_v1 = arg1 * 0x38;
    temp_s3 = temp_v1 + 0x8010F60C;
    temp_s2 = *(0x8010F60C + temp_v1);
    temp_s0 = temp_s2 + 0xA0;
    if ((temp_s2 != NULL) && (temp_v0 = func_80075274(temp_s0, temp_s2 + 0xAC), (temp_v0 >= 0))) {
        temp_s0_2 = func_80075440(0x8010F6EC, temp_s0);
        if ((func_800E4FF0(func_80075648(0x8010F6EC, temp_s2), temp_s0_2) > 0x10000) || (func_800E4FF0(func_80075648(0x8010F6EC, temp_s2), temp_s0_2) >= 0xFFFF0000)) {
            if (func_800E4FF0(func_80075648(0x8010F6EC, temp_s2), temp_s0_2) <= 0x10000) {
                func_800E4FF0(func_80075648(0x8010F6EC, temp_s2), temp_s0_2);
            }
        }
        if (*(s32 *)0x8013D968 == 0) {
            var_s5 = 0;
        } else if (*(s32 *)0x801144B0 == 1) {
            var_s5 = 0x3FFF;
            if (arg0 == 0) {
                var_s5 = 0xC000;
            }
        } else {
            var_s5 = func_800754C8(0x8010F6EC, temp_s2 + 0xA0);
        }
        var_v0 = temp_s0_2;
        if (temp_s0_2 < 0) {
        ...
        if (saved_reg_gp->unkC0 != 0) {
            ...
            temp_v1_2 = ((arg0 * 0x50) + 0x8010F56C)->unk18->unk564;
