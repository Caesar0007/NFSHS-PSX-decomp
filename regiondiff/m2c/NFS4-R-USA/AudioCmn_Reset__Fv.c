/* NFS4-R-USA CHANGED @800775EC | base 80076BEC AudioCmn_Reset__Fv */
...
? func_800E78DC(s32, ?, ?);                         /* extern */
? func_800E80CC();                                  /* extern */
s32 func_800E88D8(? *);                             /* extern */
...
void func_800775EC(void) {
    ...
    if (saved_reg_gp->unk118 > 0) {
        var_s1_2 = 0;
        temp_s6 = func_800E8E0C() + 0x280;
loop_8:
        if ((var_s1_2 == 0) && (func_800E8E0C() < temp_s6)) {
            var_s1_2 = 1;
            func_8009B57C();
            func_800E77F0(0);
            if (func_800E88D8(&sp10) > 0x8000) {
                if ((void *)0x801144A4->unk0 == 1) {
                    var_s0_2 = 0;
                    do {
                ...
                var_s2 = 0;
                if ((void *)0x801144A4->unk48 == 1) {
                    var_s2 = 0;
                    if (func_80077300(1, 0, 0) == -1) {
                        var_s1_2 = 0;
                    }
                }
                var_s0_3 = (void *)0x801144A4;
loop_20:
                if (var_s2 < (void *)0x801144A4->unk3C4) {
...
loop_31:
        var_s1_3 = 0;
        if (((func_800E8E0C() < (temp_s0 + 0x40)) || (func_8007A9C4() <= 0) || (temp_s0_2 = func_8007AA48(), ((temp_s0_2 < func_8007A9C4()) != 0))) && (func_800E8E0C() < temp_s3)) {
            var_s1_3 = 1;
        }
        if (var_s1_3 != 0) {
            func_800E77F0(0);
