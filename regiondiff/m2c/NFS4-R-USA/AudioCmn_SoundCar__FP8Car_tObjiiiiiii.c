/* NFS4-R-USA CHANGED @800792E4 | base 800788BC AudioCmn_SoundCar__FP8Car_tObjiiiiiii */
...
s32 func_800E29CC(s32, s32, s32);                   /* extern */
s32 func_800E4F14(s32, s32);                        /* extern */
s32 func_800E4FF0(?, s32);                          /* extern */
? func_800E79BC(?, s32);                            /* extern */
...
void func_800792E4(void *arg0, s32 arg1, s32 arg2, s32 arg3, s32 arg4, s32 arg6, s32 arg7) {
    ...
    if (saved_reg_gp->unkFC != 0) {
        var_a0 = 0x08000000;
        if (((arg0->unk254 * 0x110) + 0x80110570)->unk70 == 0xC) {
            var_a0 = 0x10000000;
            var_a1 = 0x10000;
        } else {
            var_a1 = 0x20000;
        }
        var_v1 = func_800E4FF0(var_a0, arg1 + var_a1);
        if (var_v1 < 0) {
            var_v1 += 0xFFFF;
        }
        sp24 = var_v1 >> 0x10;
        ...
        sp28 = temp_v0;
        if (temp_v0 != 0) {
            if ((*(s32 *)0x801144B0 != 1) && ((u8) saved_reg_gp->unk131 < 0x64U)) {
        ...
        if (arg1 <= 0x45FFFF) {
            temp_lo = ((0x13240000 - func_800E4F14(arg1, arg1)) / 4900) * var_s0;
        ...
        case 12:                                    /* switch 1 */
            ...
            if (!(temp_hi & 0xFF) && (arg0->unk188 < 0x3333) && (saved_reg_gp->unk10C > 0)) {
                ...
                func_80078D5C((void *)0x8010FB6C->unk24, 0x1D, var_a2, var_s0_2 / 2, var_v0_4);
            }
            break;
        }
        if (saved_reg_gp->unk110 != 0) {
            temp_v1_5 = ((arg0->unk254 * 0x110) + 0x80110570)->unk70;
            if (temp_v1_5 >= 0) {
                var_s5_2 = 0;
                if (temp_v1_5 >= 2) {
                    var_s5_2 = 1;
...
block_71:
                *(0x8013F088 + temp_v0_3) = var_v0_5;
            }
            temp_a0_2 = arg0->unk254;
            var_s2_2 = *(0x8013F088 + (temp_a0_2 * 4));
            if (var_s2_2 >= 0x100) {
                var_s2_2 = 0xFF;
            }
            ...
            if (sp28 != 0) {
                ...
                var_s0_3 = func_800E29CC(temp_a0_2, temp_v0_3 + 0x8013F088, var_v1_3);
            }
            var_v0_7 = var_s0_3 >> 3;
            if (var_s0_3 >= 0x80) {
                var_s0_3 = 0x7F;
            ...
            if ((arg6 != 0) || (((arg0->unk254 * 0x110) + 0x80110570)->unk70 == 0xB)) {
            ...
            if (arg0->unk444 != 0) {
                ...
                if ((temp_v1_8 < (u8) arg0->unk442) && (temp_v1_8 != 1) && (var_s2_2 != 0)) {
                    ...
                    *(0x8013F088 + (arg0->unk254 * 4)) = var_s2_2;
                }
            }
            var_a3 = 0x7F;
            if (arg0->unk27C == 0) {
