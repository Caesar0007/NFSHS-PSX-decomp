/* NFS4-R-USA CHANGED @8007BF3C | base 8007B5A8 AudioEng_Set__Fiiiiiiii */
/* callers: AudioCmn_SoundCar__FP8Car_tObjiiiiiii */
s32 func_800E4F14(s32, s32, s16);                   /* extern */
...
void func_8007BF3C(u32 arg0, s32 arg1, s32 arg2, s32 arg3, s32 arg4, s32 arg5, s32 arg6, s32 arg7) {
    ...
    if (arg0 < 2U) {
        ...
        if ((temp_s1 != NULL) && ((temp_s1->unk11B != 0xF) || !((temp_s1->unk11A + 1) & 1))) {
            ...
            if (*(*(0x80110CA0 + temp_a0))->unk288 == 0x1C) {
                var_a0 = (arg2 >> 2) + 0xC000;
            } else {
                var_a0 = arg2 + 0x3333;
            }
            temp_s0->unk2 = (s16) ((s32) (temp_s1->unk6 * func_800E4F14(var_a0, arg5, (s16) var_a3)) >> 0xA);
            ...
            if (arg4 == 0) {
                ...
                if (*(s32 *)0x801144B0 == 1) {
                    ...
                    temp_s0->unk4 = 0;
                    temp_s0->unk6 = (s16) ((s32) (*(s32 *)0x8013D8F8 * 0x3FFF) >> 7);
                }
