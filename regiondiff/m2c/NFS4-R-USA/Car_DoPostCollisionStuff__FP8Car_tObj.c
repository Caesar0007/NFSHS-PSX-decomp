/* NFS4-R-USA CHANGED @8008A300 | base 800898DC Car_DoPostCollisionStuff__FP8Car_tObj */
...
void func_8008A300(void *arg0) {
    ...
    if (temp_v0 != 0) {
        arg0->unk1B4 = temp_v0;
        temp_v1 = arg0->unk194;
        arg0->unk1B8 = (s32) *(s32 *)0x8011F368;
        if (temp_v1 != 0) {
            arg0->unk1B0 = temp_v1;
        } else {
            arg0->unk1B0 = 0;
    ...
    var_v0_5 = func_800E4F14((s32) (temp_a0_2 + (temp_a0_2 >> 0x1F)) >> 1, arg0->unk464->unk14C);
    if (var_v0_5 < 0) {
        var_v0_5 = -var_v0_5;
    }
    ...
    arg0->unk84C = func_800E4F14(temp_a0_3, arg0->unk860);
    temp_a0_4 = -arg0->unk850;
    arg0->unk848 = temp_a0_4;
    temp_v0_2 = func_800E4F14(temp_a0_4, arg0->unk85C);
