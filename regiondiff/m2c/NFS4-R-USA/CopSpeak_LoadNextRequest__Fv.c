/* NFS4-R-USA CHANGED @8009B21C | base 8009A634 CopSpeak_LoadNextRequest__Fv */
...
s32 func_800EC778(s32);                             /* extern */
s32 func_800ECE48(s32, s32, s32, s32, s32, s32);    /* extern */
...
loop_1:
        ...
        if ((temp_a1 != saved_reg_gp->unkB60) && (((temp_a1 - (saved_reg_gp->unkB74 - 0x40)) & 0x3F) < 8)) {
            temp_s0_2 = (temp_a1 << 5) + 0x801131E8;
...
block_15:
                if ((saved_reg_gp->unkB80 == 0) || (func_8009B1EC(temp_s0_2) == 0) || (temp_v0 = temp_s0_2->unkC, (temp_v0 == 0)) || (temp_v0 >= 0x7FFD) || ((*(s32 *)0x8013E6D8 >= 2) && (*(s32 *)0x801182E8 == 3))) {
                    goto block_21;
                }
                ...
                if (temp_v0_2 >= 0) {
                    ...
                    *(temp_t0 + temp_v0_2) = 0x4C494146;
                    temp_s0_2->unk14 = func_800ECE48(temp_s0_2->unk10, temp_s0_2->unk8, temp_t0 + temp_s0_2->unk4, temp_s0_2->unkC, 0x64, 0);
                    saved_reg_gp->unkB38 = (u8) (saved_reg_gp->unkB38 + 1);
                    var_v1 = 0;
                    if (func_800EC778(temp_s0_2->unk14) <= 0) {
block_25:
