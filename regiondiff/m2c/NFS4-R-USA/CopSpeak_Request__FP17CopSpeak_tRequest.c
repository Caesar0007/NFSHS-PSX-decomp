/* NFS4-R-USA CHANGED @8009B09C | base 8009A4C8 CopSpeak_Request__FP17CopSpeak_tRequest */
...
s32 func_8009B09C(void *arg0) {
    ...
    if (((temp_a3 - (saved_reg_gp->unkB70 - 0x40)) & 0x3F) < 0x21) {
        ...
        if ((var_v1 == saved_reg_gp->unkB64) || (temp_v0 = arg0->unk1E * 0x10, temp_a1 = temp_v0 + 0x80113168, (temp_a1->unk4 == 0)) || (temp_a1->unk8 == 0) || (temp_v1 = arg0->unk18, (temp_v1 < 0)) || (temp_a1->unkC < temp_v1)) {
            /* Duplicate return node #8. Try simplifying control flow for better match */
            return -1;
        }
        arg0->unk10 = (s32) *(0x80113168 + temp_v0);
        ...
        if (temp_v0_2 != 0) {
            ...
            temp_v0_4 = temp_v0_3 + 0x801131E8;
            *(0x801131E8 + temp_v0_3) = (s32) arg0->unk0;
