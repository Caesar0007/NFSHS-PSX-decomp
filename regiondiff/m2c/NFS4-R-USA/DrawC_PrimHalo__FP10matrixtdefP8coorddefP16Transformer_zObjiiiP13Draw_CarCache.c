/* NFS4-R-USA CHANGED @800C47B4 | base 800C3A30 DrawC_PrimHalo__FP10matrixtdefP8coorddefP16Transformer_zObjiiiP13Draw_CarCache */
/* callers: R3DCar_InsertCarFacetII__FP8Car_tObj, R3DCar_InsertCarFacetMenuII__FP8Car_tObji */
? func_800CD8B8(s32, void *, void *, void *, s32, s32, void *); /* extern */
? func_800E2538(?);                                 /* extern */
? func_800E2544(s32, s32);                          /* extern */

void func_800C47B4(void *arg0, void *arg1, void *arg2, s32 arg3, s32 arg4, s32 arg5, void *arg6) {
    s32 temp_a0;
    s32 temp_a1;
    s32 temp_s4;
    s32 temp_s8;
                ...
                if (arg6->unk88 >= temp_v1_2) {
                    ...
                    if (arg4 >= 0) {
                        ...
                        if (arg3 & 0x40) {
                            ...
                            if (!(var_v1_2 & 0x40)) {
                                temp_v0_6 = (void *)0x801207F8->unk30;
                                if (temp_s3->unk0 < 0) {
...
block_24:
                        ...
                        func_800CD8B8(var_a0, arg6 + 0xAC, arg6 + 0xB4, arg6 + 0xBC, (s32) temp_s3->unk0, arg6->unk3C, arg6);
...
block_29:
                                if (var_a0_2 < 7) {
                                    ...
                                    CTC2_TRY(temp_s6->unk18);
                                    CTC2_TRZ(temp_s6->unk1C);
                                    func_800CD8B8(var_a0_2 | 0x100, arg6 + 0xAC, arg6 + 0xB4, arg6 + 0xBC, (s32) temp_s3->unk0, arg6->unk3C, arg6);
                                }
                            }
                            break;
                        }
