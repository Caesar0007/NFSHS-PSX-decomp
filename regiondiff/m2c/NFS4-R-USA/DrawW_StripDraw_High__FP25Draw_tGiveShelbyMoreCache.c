/* NFS4-R-USA CHANGED @800C7C30 | base 800C6EB8 DrawW_StripDraw_High__FP25Draw_tGiveShelbyMoreCache */
/* callers: DrawW_DoTrough__FP13DRender_tViewP11tBuildEntry, DrawW_DoTrough__FP13DRender_tViewP11tBuildEntry */
? func_800C7288(void *, u16 *);                     /* extern */

void func_800C7C30(void *arg0) {
    u16 sp10;
    s8 sp12;
    s8 sp13;
    s8 sp14;
