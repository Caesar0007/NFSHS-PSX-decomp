/* NFS4-R-USA CHANGED @800644B4 | base 80063CC4 HighExecute__10AIHigh_Cop */
    ...
    case 1:                                         /* switch 1 */
        ...
        if (temp_v1_4 == 2) {
            ...
            if (var_v0_2 != NULL) {
                ...
                var_v1->unk4 = (s32) var_v0_2->unk4;
                if (*(s32 *)0x8013DAF4 == 2) {
                    var_v0_3 = func_80073998(*(void **)0x80110D0C, ((void **)0x80110000 + 0xD0C)->unk4);
                    if (var_v0_3 < 0) {
                        var_v0_3 = -var_v0_3;
                    }
                ...
                func_800736F0(*(s32 *)0x8013D8D8, &sp28);
                ...
                case 3:                             /* switch 2 */
                    ...
                    break;
                case 1:                             /* switch 2 */
                    temp_lo = *(s32 *)0x8013E3D4 * *(s32 *)0x8013E3DC;
                    *(s32 *)0x8013E3D8 = temp_lo;
                    *(void *)0x8013E3D4 = (s32) (temp_lo & 0xFFFF);
                    var_s3 = -1;
                    if (*(void *)0x801144D4 == 0) {
                        var_s3 = 1;
                    }
                    if (sp38 != 0) {
                        func_80066008(arg0, 0);
    ...
    case 2:                                         /* switch 1 */
        ...
        if (temp_v0_8 != 1) {
            ...
            if ((temp_v1_9 != 1) && (temp_v1_9 != 4) && (func_80065DA8(arg0, 1) != 0)) {
                ...
                temp_s0_2 = func_800704DC(func_800702E4(0x94), arg0->unk0, arg0->unk58->unk0, &sp28, ((arg0->unk68 * 0x14) + 0x8010DB00)->unk10, *(0x8010DC20 + (arg0->unk18 * 8)), ((arg0->unk18 * 8) + 0x8010DC20)->unk4, arg0->unk68, *(0x8010DB3C + (*(s32 *)0x801144AC * 4)));
                if (temp_v1_10 != NULL) {
...
block_211:
    ...
    case 4:                                         /* switch 1 */
        ...
        if (arg0->unk58 != NULL) {
            ...
            arg0->unk64 = -1;
            var_a0 = 0;
            if ((void *)0x8011F364->unk4 >= temp_s2->unk8C) {
                var_a0 = ~func_80065B94(arg0) != 0;
            }
            if (var_a0 != 0) {
                temp_s2->unk8C = (s32) ((void *)0x8011F364->unk4 + 0x3C0);
            }
            func_8005D218(arg0);
            var_s0_5 = 0;
            ...
            temp_v0_18 = temp_v0_17 + 0x8010DB00;
            var_a1 = 0;
            if (*(0x8010DB00 + temp_v0_17) < temp_s2->unk78) {
            ...
            if (var_a1 != 0) {
                func_8007074C(temp_s2, 1, ((arg0->unk68 * 0x14) + 0x8010DB00)->unkC);
            }
            var_s0_6 = 0;
...
block_130:
    ...
    case 3:                                         /* switch 1 */
        ...
        if (arg0->unk20 == 2) {
            ...
            var_s2 = 0;
            if (arg0->unk64 != -1) {
                if ((void *)0x8010E1A8->unk0 == 0) {
                    temp_v1_27 = *(void *)0x801144AC;
                    if (temp_v1_27 != 0) {
                        var_s0_7 = 0xE666;
                        if (temp_v1_27 == 1) {
                            var_s0_7 = 0xCCCC;
                    ...
                    temp_v0_28 = (arg0->unk64 << 5) + *(s32 *)0x8013DAB4;
                    temp_v1_28 = (arg0->unk64 << 5) + *(void *)0x8013DAB4;
                    temp_s0_8 = func_800E4F14((temp_v0_28->unk1E << 0xF) * ((u8) temp_v0_28->unk1D >> 4), var_s0_7, 1);
                    temp_v0_29 = func_800E4F14((temp_v1_28->unk1F << 0xF) * (temp_v1_28->unk1D & 0xF), var_s0_7);
                    temp_a1 = -temp_s0_8;
                    (void *)0x8010E1A8->unk8 = temp_a1;
                    (void *)0x8010E1A8->unkC = temp_v0_29;
                    (void *)0x8010E1A8->unk0 = 1;
                    (void *)0x8010E1A8->unk4 = (s32) arg0->unk64;
                    (void *)0x8010E1A8->unk10 = (s32) *(s32 *)0x8011F368;
                    func_8007E26C(arg0->unk64, temp_a1, temp_s0_8 + temp_v0_29, 0x80110000);
                }
            }
            *(s32 *)0x8013D864 = 1;
            if ((arg0->unk64 != -1) && ((void *)0x8010E1A8->unk4 == arg0->unk64)) {
                (void *)0x8010E1A8->unk10 = (s32) *(void *)0x8011F368;
            }
            if (arg0->unk28 != 0) {
                if (*(s32 *)0x8013EB04 != 0) {
                    *(void *)0x8013EB18 = func_800E5098(*(s32 *)0x8013EB18);
                    *(void *)0x8013EB04 = 0;
                    func_8005CF80(arg0, arg0 + 0x20);
                    *(void *)0x8013EB18 = func_800E5098(*(void *)0x8013EB18);
                    *(void *)0x8013EB04 = 1;
                } else {
                    func_8005CF80(arg0, arg0 + 0x20);
                }
            ...
            var_v1_2 = temp_s0_9->unk10->unk24 * *(s32 *)0x8013D8E8;
            if (var_v1_2 < 0) {
                var_v1_2 += 0xFFFF;
            }
            ...
            if (temp_v1_30 == 4) {
block_158:
                temp_s0_9->unk1C = func_800E4F14(temp_lo_2, var_a1_3);
            }
            func_80066094(arg0, &sp28);
            ...
            if (var_a1_4 > 0x31FFFF) {
                if (var_a1_4 <= 0x012BFFFF) {
                    ...
                    if (var_v1_3 > 0x471C7) {
                        temp_v0_31 = func_800E4FF0(temp_v0_30, arg0->unk58->unk0->unk564);
...
block_173:
                ...
                temp_s0_10 = func_800704DC(func_800702E4(0x94), arg0->unk0, arg0->unk58->unk0, &sp28, ((arg0->unk68 * 0x14) + 0x8010DB00)->unk10, *(0x8010DC20 + (arg0->unk18 * 8)), ((arg0->unk18 * 8) + 0x8010DC20)->unk4, arg0->unk68, *(0x8010DB3C + (*(void *)0x801144AC * 4)));
                if (temp_v1_31 != NULL) {
            ...
            if ((func_80065DA8(arg0, -3, 1) != 0) && (temp_v1_32 = arg0->unk20, (temp_v1_32 != 1)) && (temp_v1_32 != 4)) {
                ...
                temp_s0_11 = func_800704DC(func_800702E4(0x94), arg0->unk0, arg0->unk58->unk0, &sp28, ((arg0->unk68 * 0x14) + 0x8010DB00)->unk10, *(0x8010DC20 + (arg0->unk18 * 8)), ((arg0->unk18 * 8) + 0x8010DC20)->unk4, arg0->unk68, *(0x8010DB3C + (*(void *)0x801144AC * 4)));
                if (temp_v1_33 != NULL) {
    ...
    case 5:                                         /* switch 1 */
        ...
        arg0->unk64 = -1;
        var_s2_2 = 0;
        var_s0_8 = (void **)0x80110CC4;
loop_193:
        if (var_s2_2 < *(s32 *)0x8013DAEC) {
            temp_a1_3 = *var_s0_8;
            if ((*(0x8010D994 + (temp_a1_3->unk254 * 4)))->unk78 != 0) {
        ...
        temp_a2_3 = arg0->unk0;
        temp_a0_5 = (temp_a2_3->unk8 << 5) + *(void *)0x8013DAB4;
