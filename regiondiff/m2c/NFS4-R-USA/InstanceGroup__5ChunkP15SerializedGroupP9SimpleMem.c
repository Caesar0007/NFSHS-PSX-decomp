/* NFS4-R-USA CHANGED @8008BE88 | base 8008B3FC InstanceGroup__5ChunkP15SerializedGroupP9SimpleMem */
/* callers: Track_Init__FPc */
void *func_8009CC14(void *, ?, ?);                  /* extern */
s32 *func_8009CCC8(void *, ?, ?, ?);                /* extern */
s32 *func_8009CDA8(void *, void *, ?, s32);         /* extern */

void func_8008BE88(void *arg0, void *arg1, ? arg2) {
    s16 *var_a0;
    s16 temp_v0_4;
    s32 *temp_v0_2;
    s32 *temp_v0_5;
    ...
    temp_v0 = func_8009CC14(arg1, 0x1C, 0);
    ...
    if (*(s32 *)0x801144B0 != 1) {
        arg0->unk40 = func_8009CCC8(arg1, 3, arg2, 0);
        arg0->unk50 = func_8009CCC8(arg1, 0xB, arg2, 0);
        goto block_34;
    }
    temp_s3 = func_8009CC14(arg1, 0xB, 0);
    temp_s1 = func_8009CC14(arg1, 3, 0);
    if (temp_s3 != NULL) {
        var_a2 = 0;
        var_a1 = temp_s3 + 0x10;
loop_4:
...
block_13:
        ...
        if (var_a2 != 0) {
            temp_v0_2 = func_8009CDA8(arg1, temp_s3, arg2, var_a2 * 0x14);
...
block_24:
        ...
        temp_v0_5 = func_8009CDA8(arg1, temp_s1, arg2, var_a3);
...
block_34:
        ...
        if (temp_v0_6 != NULL) {
            ...
            if (temp_a1 > 0) {
                do {
                    if (var_a0_3->unk2 == 5) {
                        *(void *)0x8013E7B8 = (s32) (*(s32 *)0x8013E7B8 + 1);
                    }
                    var_v1_3 += 1;
    ...
    arg0->unk44 = func_8009CCC8(arg1, 0x15, arg2, 0);
    arg0->unk54 = func_8009CCC8(arg1, 0xA, arg2, 0);
    arg0->unk4C = func_8009CCC8(arg1, 5, arg2, 0);
    arg0->unk48 = func_8009CCC8(arg1, 6, arg2, 0);
    arg0->unk58 = func_8009CCC8(arg1, 9, arg2, 0);
    temp_v0_7 = func_8009CC14(arg1, 0x17, 0);
    temp_s0 = func_8009CC14(temp_v0_7, 0x1B, 0) + 0x10;
    ...
    temp_v0_8 = func_8009CCC8(temp_v0_7, 0x19, arg2, 0) + 4;
    ...
    arg0->unk38 = func_8009CCC8(temp_v0_7, 0x1A, arg2, 0);
    arg0->unk3C = func_8009CCC8(temp_v0_7, 0x25, arg2, 0);
    arg0->unk6C = func_8009CCC8(temp_v0_7, 0x18, arg2, 0);
    arg0->unk5C = func_8009CCC8(temp_v0_7, 0x27, arg2, 0);
    arg0->unk60 = func_8009CCC8(temp_v0_7, 0x28, arg2, 0);
    arg0->unk64 = func_8009CCC8(temp_v0_7, 0x29, arg2, 0);
}
