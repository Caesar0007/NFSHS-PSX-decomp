/* NFS4-R-USA CHANGED @800A4A6C | base 800A3F08 NFS4_LoadPerps__Fv */
/* callers: Nfs2_GameModuleStartUp__FPi */
? func_800E50A8(? *, ?, s32, s32);                  /* extern */
? func_800E612C(u32 *, s32);                        /* extern */
u32 *func_800E63D4(? *, ?);                         /* extern */
...
void func_800A4A6C(void) {
    ...
    if ((void *)0x801144A4->unk1AC > 0) {
        if (((void *)0x801144A4->unkC != 1) && ((void *)0x801144A4->unk18 <= 0)) {
            var_a3 = 0x800567AC;
        } else {
            var_a3 = 0x800567B8;
        }
        func_800E50A8(&sp10, 0x8013E570, (void *)0x80117720->unk94, var_a3);
        temp_s0 = func_800E63D4(&sp10, 0x10);
        func_800E50A8(&sp10, 0x8013E570, *(s32 *)0x801177B4, 0x800567C4);
        var_a1 = (void *)0x801144A4;
        var_t3 = (s32 *)0x80114660;
        var_t4 = 0;
        temp_s1 = func_800E63D4(&sp10, 0x10);
        temp_t1 = *temp_s1;
        var_t0 = &(temp_s0 + 0xC)[temp_s0->unk0] + (temp_s0->unk4 * 0x14) + ((void *)0x801144A4->unk1B0 * 0x2C);
        if ((void *)0x801144A4->unk1AC > 0) {
            temp_t2 = temp_s1 + 4;
            var_a2 = (void *)0x801144A4 + 0x1C8;
            var_a3_2 = var_t0 + 1;
            do {
                var_a0 = 0;
                if (temp_t1 != 0) {
...
block_13:
                ...
                *var_t3 = (s32) (((var_v0_2 + var_a0) * 0x44) + temp_t2)->unk1;
                ...
                var_a1 = (void *) (temp_a1 < (void *)0x801144A4->unk1AC);
                var_a2 += 0x34;
            } while (var_a1 != NULL);
        }
        func_800E612C(temp_s0, (s32) var_a1);
        func_800E612C(temp_s1);
    }
}
