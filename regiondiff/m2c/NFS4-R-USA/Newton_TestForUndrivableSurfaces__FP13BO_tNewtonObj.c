/* NFS4-R-USA CHANGED @800A3990 | base 800A2E84 Newton_TestForUndrivableSurfaces__FP13BO_tNewtonObj */
...
void func_800A3990(void *arg0) {
    ...
    var_s6 = 0;
    sp80 = 0;
    func_800E4F04(&sp10, 0, 0xC);
    sp20 = arg0->unk168;
    sp24 = arg0->unk16C;
    sp28 = arg0->unk170;
    func_800E4F04(&sp40, 0, 0xC);
    var_v0 = (s32 *)0x801153EC;
    var_v1 = arg0 + 8;
    do {
...
loop_5:
    if (var_s2 < 4) {
        ...
        sp54 += sp44;
        sp58 += sp48;
        func_800804E8(&sp50, 0x801153EC, 1, sp44);
        temp_a0 = (void *)0x801153EC->unk5A;
        if (temp_a0 != 0) {
            func_800A37A4(temp_a0, &sp10, arg0 + 8);
            sp14 = 0;
            func_8009E698(&sp10);
            var_s6 = 1;
        } else if (func_800A3930(arg0, 0x801153EC, var_s2) != 0) {
            var_v1_2 = (s32 *)0x80115470;
            var_v0_2 = (void *)0x801153EC;
            do {
                ...
                var_v0_2 += 0x10;
                var_v1_2 += 0x10;
            } while (var_v0_2 != (void *)0x8011546C);
            *var_v1_2 = *(s32 *)0x8011546C;
            sp60 = sp50;
            sp64 = sp54;
            sp68 = sp58;
            temp_v0 = func_8008074C(&sp50, temp_s4, 0x801153EC, &sp80);
            var_v0_3 = 1;
            var_s6 = 2;
            if (temp_v0 != 1) {
                if (temp_v0 == 2) {
...
block_17:
            ...
            if (var_v0_4 != 0) {
                ...
                sp64 += sp14;
                sp68 += sp18;
                func_800804E8(&sp60, 0x80115470, 1, sp14);
                if (func_800A3930(arg0, 0x80115470, var_s2) != 0) {
                    if (temp_v0 & 0xC) {
                        var_a0_3 = 4;
                        if (temp_v0 & 4) {
                            var_a2 = arg0 + 8;
...
block_31:
                        ...
                        var_v1_3 = (s32 *)0x80115470;
                        var_v0_5 = (s32 *)0x801153EC;
                        do {
                        ...
                        *var_v1_3 = *var_v0_5;
                        ...
                        var_a3 = 0;
                        if (func_800A3930(arg0, 0x80115470, var_s2) != 0) {
                            var_a2_2 = (void *)0x801153F4;
                            sp38 = 0;
                            sp34 = 0;
                            sp30 = 0;
loop_36:
                            if (var_a3 < 4) {
                                if ((void *)0x801153EC->unk78 != 0) {
                                    sp70 = var_a2_2->unk0;
                                    sp74 = var_a2_2->unk4;
                                    sp78 = var_a2_2->unk8;
                                    var_a2_2 += 0xC;
                                } else {
                                    temp_v0_2 = ((void *)0x801153EC->unk0 << 5) + *(s32 *)0x8013DAB4;
                                    sp70 = temp_v0_2->unk0;
                                    sp74 = temp_v0_2->unk4;
                                    sp78 = temp_v0_2->unk8;
                                    var_a2_2 += 0xC;
...
loop_49:
                        if (var_a3_2 < 4) {
                            if ((void *)0x801153EC->unk78 != 0) {
                                ...
                                temp_v0_4 = ((void *)0x801153EC->unk0 << 5) + *(void *)0x8013DAB4;
                                sp70 = temp_v0_4->unk0;
                                sp74 = temp_v0_4->unk4;
                                sp78 = temp_v0_4->unk8;
                                var_a2_3 += 0xC;
