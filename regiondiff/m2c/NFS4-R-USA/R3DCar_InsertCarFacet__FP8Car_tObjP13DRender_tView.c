/* NFS4-R-USA CHANGED @800B0868 | base 800AFBD0 R3DCar_InsertCarFacet__FP8Car_tObjP13DRender_tView */
/* callers: R3DCar_InsertCarFacetZ__FP8Car_tObjP13DRender_tView */
? func_8009E850(s32 *, s32 *, s32 *);               /* extern */
? func_800A3198(void *, s32);                       /* extern */
? func_800B078C(void *, ?);                         /* extern */
? func_800B07EC(void *, s32);                       /* extern */
? func_800B0840(s32 *, s32 *);                      /* extern */
? func_800E28EC(void *, void *, ?, void *, s32);    /* extern */
s32 func_800E4F14(s32, ?);                          /* extern */
s32 func_800E4FF0(s32, s32);                        /* extern */
? func_800EB508(s32 *, s32);                        /* extern */
? func_800EB56C(s32 *, s32);                        /* extern */
? func_800EB5D0(s32 *, s32);                        /* extern */
? func_800EB834(s32 *, s32 *, s32 *, s32);          /* extern */
s32 func_800EDE84(s32, s32, s32, s32);              /* extern */

void func_800B0868(void *arg0, void *arg1) {
    s32 sp18;
    s32 sp1C;
    s32 sp20;
    s32 sp28;
    ...
    if (temp_s7 < 0x1C) {
        temp_v0 = *(0x80117AFC + temp_s7);
        sp1B8 = (s32) temp_v0;
        if (temp_v0 < 0) {
            sp1B8 = ((s32) (((*(s32 *)0x801144E0 * 0xC) + 0x8010F138)->unk4 + 1) >> 1) ^ 1;
        }
    }
    if (*(s32 *)0x801144D0 != 0) {
        sp1B8 ^= 1;
...
block_19:
        ...
        if (temp_s6 != 0) {
            if (arg0->unk570 & 2) {
                ...
                arg0->unk8BA = 0U;
                if (!(temp_a1 & 2)) {
                    func_800B07EC(arg0, (temp_a1 & 4) == 0);
                }
            }
        }
        ...
        sp108 = temp_a1_2;
        saved_reg_gp->unkE4C = (s16) (0x1000 - (func_800EDE84(temp_a0_2, temp_a1_2, temp_a2_2, temp_a3) >> 4));
        temp_s0 = arg0 + 0xF0;
        if (temp_s7 < 0x1C) {
            func_800B0840(temp_s0, &sp78);
            if (sp1B8 != 0) {
                sp78 = -sp78;
                sp80 = -sp80;
                sp7C = -sp7C;
            ...
            func_800EB5D0(&sp28, arg0->unk84C);
            func_800EB508(&sp138, arg0->unk848 + 0x64);
            func_8009E850(&sp28, &sp138, &sp28);
            func_8009E850(&sp28, temp_s0, &sp28);
            func_800EB5D0(&sp110, var_s3);
            ...
            func_800EB5D0(&sp28, arg0->unk84C);
            func_800EB508(&spF0, arg0->unk848);
        ...
        if (((void *)0x8011F37C->unk8 == 0) && ((void *)0x8011F37C->unk10 == 0)) {
            var_a1_3 = 0;
            if (temp_s7 == 0x1C) {
...
loop_75:
                if (var_a1_3 < 2) {
                    if (temp_a3_2 != 2) {
                        ...
                        var_a0_3 = (s32) arg0->unk420 >> (8 - (void *)0x801182E4->unk4);
                    }
                    if (var_a1_3 != 0) {
...
block_83:
                        ...
                        if (temp_v1_3 != 1) {
                            ...
                            if (temp_a3_2 != 2) {
                                ...
                                var_a0_3 = temp_lo << ((void *)0x801182E4->unk4 + 7);
                            }
                        }
                    }
...
block_90:
        ...
        if (temp_a0_3 > 0x1E0000) {
            temp_v0_2 = func_800E4FF0(var_s0 << 0x10, func_800E4F14(temp_a0_3, 0x888));
            temp_a0_4 = temp_v0_2;
...
loop_106:
            if (var_s4 < 0x39) {
                var_a1_4 = (s8) *(0x80117898 + (s32) var_a0_4);
...
loop_164:
            if (var_s4 < 0x39) {
                var_a1_5 = (s8) *(0x80117898 + (s32) var_a0_5);
                if (var_a1_5 != 0x12) {
...
block_172:
        ...
        var_s4_2 = 0;
        temp_a2_3 = **(0x80117BC0 + (s32) ((temp_s7 * 4) + (sp1B4 * 0xC8)));
        sp1BC = arg1 + 0x44;
        sp18 = temp_a2_3->unk4;
        sp1C = temp_a2_3->unk8;
        var_s6 = 0;
...
loop_179:
        if (var_s4_2 < 0x39) {
            temp_a2_4 = *(*(0x80117BC0 + (s32) ((temp_s7 * 4) + (sp1B4 * 0xC8))) + (var_s4_2 * 4));
            if ((temp_a2_4->unk2 != 0) && (*(0x80117B64 + var_s4_2) != 0)) {
                if (var_s4_2 >= 0x2F) {
                    var_a1_6 = (arg0 + (*(0x801179F0 + ((var_s4_2 - 0x2F) * 2)) * 0x30))->unk2B4;
                    if (var_a1_6 > 0) {
                        if (var_a1_6 >= 0x1EB9) {
                            var_a1_6 = 0x1EB8;
                        }
...
block_236:
                        func_800B0840(var_a0_7, saved_reg_gp->unkE30 + var_s6);
                        goto block_237;
                    case 0x35:                      /* switch 5 */
                        func_800EB508(&spF0, arg0->unkD4);
                        var_a1_8 = arg0 + 0xF0;
                    ...
                    case 0x25:                      /* switch 5 */
                        ...
                        func_800EB5D0(&spF0, -(var_v0_19 * 0x38));
block_233:
                        var_a1_8 = &sp78;
                        goto block_234;
                    case 0x26:                      /* switch 5 */
                        ...
                        func_800EB5D0(&sp160, var_a1_9);
                        func_800EB508(&sp188, temp_s1);
                        var_a0_8 = &sp160;
                        var_a1_10 = &sp188;
block_232:
                    ...
                    case 0x28:                      /* switch 5 */
                        ...
                        func_800EB508(&sp138, var_lo);
                        if (var_s0_2 > 0) {
                            var_s0_2 = -var_s0_2;
                        }
                        func_800EB56C(&sp160, var_s0_2 * (var_s1 >> 1));
                        var_a0_8 = &sp138;
                        var_a1_10 = &sp160;
                        goto block_232;
                    default:                        /* switch 5 */
...
block_237:
        ...
        temp_s1_2 = arg1 + 0x44;
        temp_s0_3 = arg1 + 0x38;
        func_800E28EC(temp_s1_2, temp_s0_3, 1, arg0 + 0xA0, 0x8013E674);
        if ((saved_reg_gp->unkE44 != 0) && (arg0->unk90 == 0)) {
            func_800A3198(arg0, *(s32 *)0x8011F368);
            func_800E28EC(temp_s1_2, temp_s0_3, 4, arg0 + 0x1E8, 0x80117BA0);
            saved_reg_gp->unkE40 = 1;
        } else {
            saved_reg_gp->unkE40 = 0;
        }
        if (((void *)0x8011F37C->unk8 == 0) && ((void *)0x8011F37C->unk10 == 0)) {
            if (*(void *)0x8013E6D8 != 2) {
                arg0->unkC8 = (u16) (arg0->unkC8 + arg0->unk422);
            } else {
                arg0->unkC8 = (u16) (arg0->unkC8 + ((s32) arg0->unk420 >> (0x12 - *(s32 *)0x801182E8)));
            }
        }
        temp_a0_5 = *(s32 *)0x8013EAE0;
        var_s4_3 = 0;
        if (temp_a0_5 > 0) {
            var_v1_4 = *(s16 **)0x8013EAD8;
loop_250:
        ...
        temp_a0_6 = *(s32 *)0x8013EAE4;
        arg0->unkCA = var_s4_3;
        var_s4_4 = 0;
        if (temp_a0_6 > 0) {
            var_v1_5 = *(s16 **)0x8013EADC;
loop_254:
