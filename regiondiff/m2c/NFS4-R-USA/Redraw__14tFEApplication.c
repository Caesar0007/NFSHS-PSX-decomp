/* NFS4-R-USA CHANGED @80013894 | base 8001373C Redraw__14tFEApplication */
...
? func_8001349C(void *);                            /* extern */
? func_80015A70(?);                                 /* extern */
? func_80018860();                                  /* extern */
? func_8001B390(void *, ?, s32 *, ? *);             /* extern */
? func_8002620C(s32, ?);                            /* extern */
? func_80026868(s32);                               /* extern */
void *func_800BEB84(s32, s32);                      /* extern */
? func_800BEDAC(s32);                               /* extern */
? func_800BEE9C(s32);                               /* extern */
? func_800BF044();                                  /* extern */
? func_800BF0F0();                                  /* extern */
? func_800EEC70(s32 *, s16 *, s32 *, ?);            /* extern */

void func_80013894(void *arg0) {
    s16 sp10;
    u16 sp12;
    s16 sp14;
    u16 sp16;
    ...
    func_80015A70(0);
    func_800BF044();
    func_800BEDAC(*(s32 *)0x8013E6B0);
    temp_s5 = func_800BEB84(*(s32 *)0x8013E6B0, *(s32 *)0x8013EA9C);
    if (arg0->unk8 != 0) {
        temp_v0 = *(u32 *)0x8013EF6C;
        var_s4 = (u32) (temp_v0 + (temp_v0 >> 0x1F)) >> 1;
    } else {
        var_s4 = (u32) (u16) *(void *)0x8013EF6C;
    }
    func_80018860();
    func_8001349C(arg0);
    if (((void *)0x8013FBA4->unk4 != 0) || ((void *)0x8013FBA4->unk24 != 0)) {
        temp_a1 = *(void *)0x80051EE0;
        temp_a1->unk2C = (s32) (temp_a1->unk2C | 1);
        temp_a0 = arg0->unk4;
        sp20 = 0x200;
        if ((temp_a0 + (temp_a0->unk8 * 4))->unk10 == (temp_a1 + 0x2C)) {
            func_8001B390(temp_a1 + 0xB0, 0, &sp20, &sp18);
        }
    } else {
        temp_a0_2 = *(void **)0x80051EE0;
        temp_a0_2->unk2C = (s32) (temp_a0_2->unk2C & ~1);
    }
    if (*(u8 *)0x8013FBA8 != 0) {
        temp_a0_3 = *(void *)0x80051EE0;
        temp_a0_3->unk0 = (s32) (temp_a0_3->unk0 | 1);
        temp_v1 = arg0->unk4;
        temp_v1_2 = (temp_v1 + (temp_v1->unk8 * 4))->unk10;
        sp24 = 0x400;
        if (temp_v1_2 == temp_a0_3) {
            func_8001B390(temp_v1_2 + 0xB0, 0, &sp24, &sp18);
        }
    } else {
        temp_a0_4 = *(void *)0x80051EE0;
    ...
    *temp_a2 = (*temp_a2 & 0xFF000000) | ((s32) temp_a0_5 & 0xFFFFFF);
    func_800EEC70(temp_a0_5, &sp10, temp_a2, 0xFFFFFF);
    var_v0 = var_s4 << 0x10;
    do {
        arg0->unk22C = var_s3;
...
block_30:
        ...
        *temp_a2_2 = (*temp_a2_2 & 0xFF000000) | ((s32) temp_a0_9 & 0xFFFFFF);
        func_800EEC70(temp_a0_9, &sp10, temp_a2_2, 0xFF000000);
        temp_v0_2 = var_s3 - 1;
        var_s3 = temp_v0_2;
        var_v0 = var_s4 << 0x10;
    } while (!(temp_v0_2 & 0x8000));
    arg0->unk22C = temp_s6;
    func_800BEE9C(*(void *)0x8013E6B0);
    func_800BF0F0();
}
