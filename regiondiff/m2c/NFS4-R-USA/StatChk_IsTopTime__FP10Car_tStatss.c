/* NFS4-R-USA CHANGED @8004A194 | base 80049D0C StatChk_IsTopTime__FP10Car_tStatss */
...
s32 func_8004A194(void *arg0, s16 arg1) {
    ...
    var_s7 = 0;
    temp_s3 = func_80028004();
    func_800E4F04(&sp10, 0, 8);
    func_800E4F04(&sp18, 0, 8);
    func_800E4F04(&sp20, 0, 8);
    temp_s8 = func_800E5F28(0x80012488, 0x168, 0x10);
    sp30 = func_800E5F28(0x80012494, arg1 * 4, 0x10);
    var_a0 = 0;
    temp_s2 = func_800E5F28(0x800124A0, arg1 * 2, 0x10);
    sp28 = arg1;
    if (arg1 > 0) {
        var_v1 = 0 << 0x10;
        do {
...
loop_6:
    if ((var_s1 << 0x10) < ((u16) sp28 << 0x10)) {
        ...
        temp_a0 = func_800163E4(0x8011552C, ((var_s1 * 0xA0) + arg0)->unk60);
        if (!(temp_a1 & 0x200)) {
            if ((u32) (temp_a0->unk2 - 7) >= 2U) {
                if (((u8) *(u8 *)0x801158BB < 3U) && (temp_a1 & 4) && (temp_v1->unk80 == 2)) {
                    var_s7 = 1;
                }
                if (var_s7 == 1) {
        ...
        func_800E612C(temp_s8, temp_a1);
        func_800E612C(sp30);
        func_800E612C(temp_s2);
        return 0;
    }
    if (sp10 != 0) {
        if (sp14 != 0) {
