/* NFS4-R-USA CHANGED @80032F80 | base 80032E30 UpdateTrackFinishPoints__18tTournamentManager */
/* callers: AdvanceToNextTrack__18tTournamentManager */
s16 func_800336C8();                                /* extern */
? func_800E6978(void *, s16, ?, ?);                 /* extern */

void func_80032F80(void *arg0) {
    s16 temp_t0;
    s16 var_a3;
    s32 temp_a1;
    s32 temp_a2;
    ...
    if (((((temp_a1 + (arg0->unk4 * 0xC))->unk2 + arg0->unk8) * 0x54) + temp_a1)->unk29 != 0) {
        ...
        if (temp_t0 > 0) {
            ...
            do {
                if (var_a1->unk120 == 0) {
                    temp_v1 = (var_a3 * 0xA0) + 0x80110E08;
    ...
    func_800E6978(arg0 + 0x237, temp_t0, 1, 0x80032BA0);
    var_a0_4 = 0;
    var_v0_2 = arg0;
    do {
        var_a0_4 += 1;
