/* NFS4-R-USA REGION-ONLY @8009B57C */
...
void func_8009B57C(void) {
    ...
    if (saved_reg_gp->unkB68 != -1) {
        var_a1 = (void *)0x801131C8->unk18;
        if (var_a1 == -1) {
            var_a1 = (void *)0x801131C8->unk8 + 0x4000;
        }
        func_80077300((void *)0x801131C8->unk1E, var_a1, 1);
        if (func_800EDC94(saved_reg_gp->unkB68) < 5) {
            temp_v1 = saved_reg_gp->unkB64;
            if (temp_v1 != saved_reg_gp->unkB60) {
                temp_a0 = (temp_v1 << 5) + 0x801131E8;
                if ((temp_a0->unk1E == 3) && (temp_a0->unk18 == 0x13) && ((void *)0x801131C8->unk0 == 0)) {
                    temp_a0->unk18 = 0x14;
                }
            }
    ...
    if ((temp_a1 == saved_reg_gp->unkB60) || (temp_v0_2 = temp_a1 << 5, ((temp_v0_2 + 0x801131E8)->unk1D != 0)) || (temp_a2 = saved_reg_gp->unkB64, temp_v0_3 = temp_a2 << 5, temp_a0_3 = temp_v0_3 + 0x801131E8, (*(0x801131E8 + temp_v0_2) != *(0x801131E8 + temp_v0_3))) || (temp_a0_3->unk1E < 0) || (temp_a0_3->unk1D != 0) || (((temp_a1 - (temp_a2 - 0x40)) & 0x3F) >= 0x11)) {
