/* NFS4-R-USA CHANGED @800E50A8 | base 800E44BC sprintf */
...
s32 func_800EA8D0(s32, s8, s8 *);                   /* extern */
s32 func_800FED34(s32, ?, s32);                     /* extern */
? func_800FED44(s32, s32, s32);                     /* extern */

s16 func_800E50A8(s32 arg0, s8 *arg1, s32 arg2, s32 arg3) {
    u32 sp210;
    s32 sp214;
    s32 sp218;
    s32 *sp220;
...
loop_2:
        var_v0 = arg0 + var_s2;
        if (var_a1 == 0x25) {
            sp210 = (void *)0x8012477C->unk0;
            sp214 = (void *)0x8012477C->unk4;
            sp218 = (void *)0x8012477C->unk8;
loop_4:
            temp_a2 = arg1;
            arg1 = temp_a2 + 1;
            var_a1 = temp_a2->unk1;
...
block_110:
                ...
                func_800FED44(var_a0_2, (s32) var_s1, var_s0);
                var_s2 += var_s0;
                if (var_s0 < sp214) {
                    do {
                        *(arg0 + var_s2) = 0x20;
...
block_80:
            ...
            case 39:
                ...
                if ((sp210 >> 2) & 1) {
                    ...
                    var_s0 = func_800EA8D0((s32) var_s1, var_a1, temp_a2);
                } else {
                    temp_v0_5 = func_800FED34((s32) var_s1, 0, sp218);
