/* NFS4-R-AU REGIONAL CANDIDATE -- full base TU + regional edits.
 * DrawCar: PAL delta (carX/carY locals, carY=y-8, empty-slot else-arm
 * calls REGION-ONLY func_80012F6C) -- sealed pre-W84; rebuilt from the
 * 43-line partial candidate onto the full TU (W85 corpus maintenance)
 * so the hidden-changed SetDialog rows can be hosted here. */
