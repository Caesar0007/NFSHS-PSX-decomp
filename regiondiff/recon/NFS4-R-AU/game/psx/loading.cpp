...
/* [NFS4-R-AU/FR-DE/UK-ES-IT/UK-SW REGIONAL DELTA] the PAL builds run a 256-line
   display: both Draw_SetEnvironment calls below pass a screen height of 0x100
   instead of the NTSC 0xf0 (the only change in this function -- AUDIT_LO16
   insn 32 / insn 68, `li a1,240` -> `li a1,256`). */
