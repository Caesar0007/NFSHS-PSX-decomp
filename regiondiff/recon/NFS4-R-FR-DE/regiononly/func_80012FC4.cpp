/* NFS4-R-FR-DE region-only car-render setup helper @0x80012FC4. */
struct RDAT_80012FC4_Locals {
...
extern "C" const unsigned int RDAT_80012FC4_TextLead
    __attribute__((section(".text"))) = 0;

extern "C" void func_80012FC4(void *object, int screenX, int screenY,
                                int tableIndex, int tableDelta, int angle,
                                float width, float height)
{
    RDAT_80012FC4_Locals locals;
    int *tableBase;
    int *tableEntry;
    void *matrix0;
    void *matrix1;
...
extern "C" const unsigned int RDAT_80012FC4_AlignedTail
