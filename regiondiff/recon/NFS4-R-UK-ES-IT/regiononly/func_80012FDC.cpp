/* NFS4-R-UK-ES-IT region-only car-render setup helper @0x80012FDC. */
struct RDAT_80012FDC_Locals {
...
extern "C" const unsigned int RDAT_80012FDC_TextLead
    __attribute__((section(".text"))) = 0;

extern "C" void func_80012FDC(void *object, int screenX, int screenY,
                                int tableIndex, int tableDelta, int angle,
                                float width, float height)
{
    RDAT_80012FDC_Locals locals;
    int *tableBase;
    int *tableEntry;
    void *matrix0;
    void *matrix1;
...
extern "C" const unsigned int RDAT_80012FDC_AlignedTail
