...
/* R-USA REGIONAL VARIANT: retail adds a 10-word clear of a region-layout
 * table @0x8010F0B0 (R-USA VA; identity [INFERRED unidentified] -- not in
 * the base image) before the Purgatory::StartUp call, in BOTH free fns. */
extern "C" int RDAT_8010F0B0[];   /* R-USA @0x8010F0B0, 10+ words, bss */
