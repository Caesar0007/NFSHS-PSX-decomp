...
LONG:
  {
    ...
    if (carObj->carInfo->carType != 0x1c) {
      if ((carObj->render).currentRoll > 0x140000) {
        (carObj->render).currentRoll = 0x140000;
      }
      else if ((carObj->render).currentRoll < -0x140000) {
        (carObj->render).currentRoll = -0x140000;
      }
      if ((carObj->render).currentPitch > 0xa0000) {
        (carObj->render).currentPitch = 0xa0000;
      }
      else if ((carObj->render).currentPitch < -0xa0000) {
        (carObj->render).currentPitch = -0xa0000;
      }
    }
