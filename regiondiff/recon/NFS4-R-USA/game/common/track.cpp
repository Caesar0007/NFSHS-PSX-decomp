...
/* ---- R-USA regional-only additions (retail delta over the matched base) ----
 * The retail link adds a small helper pair around the track chunk-visibility
 * allocation (func_800A7788 / func_800A77C0, both REGION-ONLY) and an extra
 * post-load pass func_800BB2F4.  Names stay mechanical: these have no base
 * counterpart, so no semantic name is invented (regiondiff README naming). */
extern "C" void func_800A7788(int count);   /* REGION-ONLY @800A7788 (R-USA) */
extern "C" void func_800A77C0(void);        /* REGION-ONLY @800A77C0 (R-USA) */
extern "C" void func_800BB2F4(int arg0);    /* REGION-ONLY @800BB2F4 (R-USA) */

/* [INFERRED] identity TBD: retail-only gp cell (R-USA gp+0xF7C = 0x8013E7B8),
 * zeroed with Track_gSaveSurface/Track_gObjDefs and later biased by +42 to
 * size the func_800A7788 allocation.  TU-owned -> tentative def -> gp-rel. */
int RDAT_8013E7B8;
/* [INFERRED] identity TBD: retail-only cell at R-USA 0x801144E0, read
 * absolutely (unsized-array shape -> the oracle's separate-%hi-scratch load,
 * section 3.12 #5). */
extern "C" int RDAT_801144E0[];
...

{
  ...
  func_800A7788(RDAT_8013E7B8 + 0x2a);            /* R-USA delta */
  func_800BB2F4(RDAT_801144E0[0]);                /* R-USA delta */
  return;
}
