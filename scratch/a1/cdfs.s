...
loaddirinfo:
	...
	.def	next_entry;	.val	$L47;	.scl	6;	.type	0x0;	.endef
$L47:
	lbu	$2,0($16)
	#nop
	bne	$2,$0,$L48
...
$L51:
	...
	addu	$2,$2,1
	sw	$2,8($17)
	.def	test_entry_count;	.val	$L46;	.scl	6;	.type	0x0;	.endef
$L46:
	lbu	$3,0($16)
	lw	$2,8($17)
	#nop
	...
	.def	done;	.val	$L50;	.scl	6;	.type	0x0;	.endef
$L50:
	lw	$31,36($sp)
...
CdReadyHandler:
	...
	.mask	0x800f0000,-8
	.fmask	0x00000000,0
	.def	intr;	.val	17;	.scl	17;	.type	0x4;	.endef
...
$L125:
	...
	sw	$2,-32($16)
	#.set	novolatile
	.def	advance;	.val	$L96;	.scl	6;	.type	0x0;	.endef
$L96:
	lui	$4,%hi(CD_ctx) # high
	addiu	$17,$4,%lo(CD_ctx) # low
$L131:
