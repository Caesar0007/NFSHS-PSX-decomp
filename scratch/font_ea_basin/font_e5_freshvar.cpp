...

{
  ...
  ytop = y - *(signed char *)&ch->yoffset;
  ytop = ytop + 5;
  ytop = ytop - (height + *(signed char *)&ch->yoffset);
  ...
  *(u_long *)&prim->r0 = font_tint;
  ...
  prim->x0 = x, prim->y0 = ytop + height,
  prim->x1 = x + width, prim->y1 = ytop + height,
  prim->x2 = x, prim->y2 = ytop,
  prim->x3 = x + width, prim->y3 = ytop;
  return;
}
