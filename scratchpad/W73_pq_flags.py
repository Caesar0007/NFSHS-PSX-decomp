...
ASPSX = Path(__import__("os").environ.get("PQ_ASPSX", r"C:/Temp/psq43/PSSN/ASPSX.EXE"))
...
def main():
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        r = subprocess.run([str(cc1), "-quiet", "-O2", f"-G{gval}", *tu_extra,
                            *__import__("os").environ.get("PQ_CC1_FLAGS","").split(),
        ...
        r = subprocess.run([str(ASPSX)] + __import__("os").environ.get("PQ_ASPSX_FLAGS","").split() + ["-o", str(obj_out), str(s_out)],
