 ...
 */
#include "C:/Temp/nfs4-decomp/recon/game/common/replay_types.h"
#include "C:/Temp/nfs4-decomp/recon/game/common/replay_externs.h"
...

{
  ...
  for (i = 1; i >= 0; i--)
    *(int *)((char *)&Replay_ReplayCounter[1] + ((i - 1) << 2)) = 0;
