...
sys.argv = [sys.argv[0], 'C:/Temp/nfs4-decomp/build/psyq_g/nfs4_sym.txt'] + sys.argv[1:]
import importlib.util

spec = importlib.util.spec_from_file_location('stc', 'C:/Temp/nfs4-decomp/scratchpad/psyq_pipe/symtree_parse.py')
