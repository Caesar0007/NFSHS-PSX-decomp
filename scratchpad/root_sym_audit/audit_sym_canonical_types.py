...
def filter_exact_symbol_codegen_carriers(
    ...
    untyped_library_named_pair_views = {
        ...
        **{
        ...
        # AUDIOCLC.OBJ dereferences GameSetup_gData and Camera_gInfo although
        # their completed owner tags are absent from its linked graph. Keep
        # the full known retail layouts so every used field has its original
        # spelling and compiler MEM shape, and accept only these two exact
        # header/name/layout pairs. Pre-change source/tool backup: Git commit
        # 53de1ff6.
        ("audioclc_types.h", "AudioClc_GameSetupCodegenView"): (2600, (
            ("MOS", "INT", 0, "raceType", 0, (), ""),
            ("MOS", "INT", 0, "numLaps", 4, (), ""),
            ("MOS", "INT", 0, "skill", 8, (), ""),
            ("MOS", "INT", 0, "commMode", 12, (), ""),
            ...
            ("MOS", "INT", 0, "SceneStartLap", 216, (), ""),
            ("MOS", "INT", 0, "SceneEndLap", 220, (), ""),
            ("MOS", "STRUCT", 204, "userSetting", 224, (),
             "GameSetup_tUserSetting"),
            ("MOS", "INT", 0, "numPerps", 428, (), ""),
            ("MOS", "INT", 0, "stageOffset", 432, (), ""),
            ("MOS", "INT", 0, "perpArrests", 436, (), ""),
            ("MOS", "INT", 0, "finalPerpArrests", 440, (), ""),
            ...
            ("MOS", "INT", 0, "numOpponentRaceCars", 972, (), ""),
            ("MOS", "INT", 0, "opponentCarType", 976, (), ""),
            ("MOS", "ARY STRUCT", 1620, "carInfo", 980, (9,),
             "GameSetup_tCarData"),
        )),
        ("audioclc_types.h", "AudioClc_CameraInfoCodegenView"): (272, (
            ("MOS", "PTR STRUCT", 576, "anchor", 0, (), "BO_tNewtonObj"),
            ("MOS", "PTR STRUCT", 576, "target", 4, (), "BO_tNewtonObj"),
            ("MOS", "STRUCT", 12, "position", 8, (), "coorddef"),
            ("MOS", "STRUCT", 12, "relpos", 20, (), "coorddef"),
        ...
        # expansion. Pair-lock every carrier by owner, spelling, and complete
        # layout. Pre-change source/tool backup: Git commit 5a10413c.
        ("replay_types.h", "Replay_SimGlobalCodegenView"): (24, (
            ("MOS", "INT", 0, "gameStarted", 0, (), ""),
            ("MOS", "INT", 0, "gameTicks", 4, (), ""),
            ("MOS", "INT", 0, "time32Hz", 8, (), ""),
            ("MOS", "PTR STRUCT", 24, "schedule64Hz", 12, (),
        ...
        ("replay_types.h", "Replay_SimSystemCodegenView"): (28, (
            ("MOS", "INT", 0, "restartGame", 0, (), ""),
            ("MOS", "INT", 0, "endSimGame", 4, (), ""),
            ("MOS", "INT", 0, "pauseSim", 8, (), ""),
            ("MOS", "INT", 0, "keyRelease", 12, (), ""),
        ...
        ("replay_types.h", "Replay_InputResultsCodegenView"): (4, (
            ("MOS", "CHAR", 0, "steering", 0, (), ""),
            ("MOS", "UCHAR", 0, "gas", 1, (), ""),
            ("MOS", "UCHAR", 0, "brake", 2, (), ""),
            ("MOS", "UCHAR", 0, "flags", 3, (), ""),
        )),
        ("replay_types.h", "Replay_CameraInfoCodegenView"): (272, (
            ("MOS", "PTR STRUCT", 576, "anchor", 0, (), "BO_tNewtonObj"),
            ("MOS", "PTR STRUCT", 576, "target", 4, (), "BO_tNewtonObj"),
            ("MOS", "STRUCT", 12, "position", 8, (), "coorddef"),
            ("MOS", "STRUCT", 12, "relpos", 20, (), "coorddef"),
        ...
        ("replay.cpp", "PackedBuf33"): (33, (
            ("MOS", "ARY CHAR", 33, "b", 0, (33,), ""),
        )),
        ("replay.cpp", "PackedBuf32"): (32, (
            ("MOS", "ARY CHAR", 32, "b", 0, (32,), ""),
        )),
