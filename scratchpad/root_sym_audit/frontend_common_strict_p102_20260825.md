...
- Declaration-clean mapped functions: 637
- Missing SYM names: 0
- Extra source-local names: 752
...
- Explicit source-only codegen carriers: 170
...
### `DrawVideoWall__16tScreenCarSelects` (0x8003c118, screencarselect.cpp:844, map=exact)

- Extra source locals: `this_00`, `vtbl`

### `UpdateBrightness__16tScreenCarSelects` (0x8003c4b8, screencarselect.cpp:964, map=exact)

- Extra source locals: `brightness`, `destBrightness`, `sVar3`

### `DrawBackground__16tScreenCarSelect` (0x8003c53c, screencarselect.cpp:999, map=exact)

- Extra source locals: `bVar1`, `bright`, `valid`, `vtbl`

### `DrawForeground__16tScreenCarSelect` (0x8003c7d8, screencarselect.cpp:1103, map=exact)

- Extra source locals: `currentItemValue`, `fadeBase`, `overlayDirection`, `shapeFade`, `shapeTicks`, `textBase`, `validCarValue`

### `PreLoad__20tScreenCarSelectDuel` (0x8003d08c, screencarselect.cpp:1349, map=exact)

- Extra source locals: `buf_or_path`, `str`, `use_default`, `vtbl`

### `DrawVideoWall__20tScreenCarSelectDuels` (0x8003d364, screencarselect.cpp:1460, map=exact)

- Extra source locals: `vtbl`, `vw`

### `DrawOpponentVideoWall__20tScreenCarSelectDuels` (0x8003d4bc, screencarselect.cpp:1519, map=exact)

- Extra source locals: `this_00`, `vw_opp`

### `GetShapeInfo__20tScreenCarSelectDuelRsT1PPcT3` (0x8003d5e0, screencarselect.cpp:1555, map=exact)

- Extra source locals: `valid`, `vtbl`

### `DrawBackground__20tScreenCarSelectDuel` (0x8003d7f0, screencarselect.cpp:1636, map=exact)

- Extra source locals: `bVar1`, `bVar2`, `creditsTextVal`, `elapsed`, `sVar2`, `screenVtbl`, `screenVtbl2`, `vtbl`

### `DrawForeground__20tScreenCarSelectDuel` (0x8003de68, screencarselect.cpp:1791, map=exact)

- Extra source locals: `ci`, `sliderResult`, `vtbl`

### `DrawVideoWall__25tScreenCarSelectTwoPlayers` (0x8003e190, screencarselect.cpp:1916, map=exact)

- Extra source locals: `offset`, `sVar2`, `vtbl`

### `DrawBackground__25tScreenCarSelectTwoPlayer` (0x8003e4bc, screencarselect.cpp:2031, map=exact)
...
### `DoMemCardStuff__25tScreenPinkSlipsCarSelect` (0x8003ef14, screencarselect.cpp:2439, map=exact)
