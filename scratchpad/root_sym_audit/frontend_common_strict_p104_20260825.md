...
- Declaration-clean mapped functions: 640
- Missing SYM names: 0
- Extra source-local names: 746
...
- Explicit source-only codegen carriers: 172
...
### `DrawBackground__20tScreenCarSelectDuel` (0x8003d7f0, screencarselect.cpp:1618, map=exact)

- Extra source locals: `bVar1`, `bVar2`, `creditsTextVal`, `elapsed`, `sVar2`, `screenVtbl`, `screenVtbl2`, `vtbl`

### `DrawForeground__20tScreenCarSelectDuel` (0x8003de68, screencarselect.cpp:1773, map=exact)

- Extra source locals: `ci`, `sliderResult`, `vtbl`

### `DrawVideoWall__25tScreenCarSelectTwoPlayers` (0x8003e190, screencarselect.cpp:1898, map=exact)

- Extra source locals: `offset`, `sVar2`, `vtbl`

### `DrawBackground__25tScreenCarSelectTwoPlayer` (0x8003e4bc, screencarselect.cpp:2013, map=exact)
...
### `DoMemCardStuff__25tScreenPinkSlipsCarSelect` (0x8003ef14, screencarselect.cpp:2421, map=exact)
