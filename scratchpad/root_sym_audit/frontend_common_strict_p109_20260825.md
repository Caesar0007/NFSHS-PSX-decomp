...
- Declaration-clean mapped functions: 645
- Missing SYM names: 0
- Extra source-local names: 736
...
- Explicit source-only codegen carriers: 180
...
### `Front_InitPlayerCars__FR9tFEStream` (0x80028098, front.cpp:1239, map=exact)

- Extra source locals: `pcVar3`, `ptVar6`, `pvVar4`, `sVar2`, `uVar1`

### `Front_InitTourneyTraffic__FR9tFEStream` (0x8002845c, front.cpp:1357, map=exact)

- Extra source locals: `maxTraffic`, `tourn`

### `Front_InitOpponentCars__FR9tFEStream` (0x800285d0, front.cpp:1476, map=exact)

- Extra source locals: `numRacers`, `numRacers2`, `pvVar5`

### `Front_InitMissions__FR9tFEStream` (0x80028b64, front.cpp:1649, map=exact)

- Extra source locals: `cVar1`, `cVar2`, `cVar3`, `cVar5`, `iVar4`

### `Front_InitTrack__FR9tFEStream` (0x8002921c, front.cpp:1873, map=exact)

- Extra source locals: `iVar1`, `pTrack`, `src`

### `Front_AppendPlayerCarData__FPiR9tFEStream` (0x80029618, front.cpp:2026, map=exact)

- Extra source locals: `iVar1`, `uVar2`

### `Front_AppendOpponentData__FPiR9tFEStream` (0x80029afc, front.cpp:2189, map=exact)

- Extra source locals: `bVar1`, `iVar2`, `ptVar3`

### `Front_AppendCopData__FPiR9tFEStream` (0x80029e30, front.cpp:2281, map=exact)

- Extra source locals: `iVar2`, `ptVar1`, `slot`

### `Front_AppendPerpData__FPiR9tFEStream` (0x8002a084, front.cpp:2367, map=exact)

- Extra source locals: `carManagerPtr`, `iVar2`, `piVar3`, `ptVar1`

### `Front_AppendTrafficData__FPiR9tFEStream` (0x8002a31c, front.cpp:2455, map=exact)

- Extra source locals: `ptVar1`, `traffic`

### `Front_BuildStream__FPi` (0x8002a738, front.cpp:2631, map=exact)

- Extra source locals: `iVar3`, `uVar6`

### `PlayerName__Fi` (0x8002b9fc, front.cpp:3193, map=exact)

- Extra source locals: `name_len`, `s`, `wordnum`

### `PlayerNameMixedCase__Fi` (0x8002ba88, front.cpp:3235, map=exact)
