...
- Declaration-clean mapped functions: 647
- Missing SYM names: 0
- Extra source-local names: 732
...
### `Front_AppendOpponentData__FPiR9tFEStream` (0x80029afc, front.cpp:2192, map=exact)

- Extra source locals: `bVar1`, `iVar2`, `ptVar3`

### `Front_AppendCopData__FPiR9tFEStream` (0x80029e30, front.cpp:2284, map=exact)

- Extra source locals: `iVar2`, `ptVar1`, `slot`

### `Front_AppendPerpData__FPiR9tFEStream` (0x8002a084, front.cpp:2370, map=exact)

- Extra source locals: `carManagerPtr`, `iVar2`, `piVar3`, `ptVar1`

### `Front_AppendTrafficData__FPiR9tFEStream` (0x8002a31c, front.cpp:2458, map=exact)

- Extra source locals: `ptVar1`, `traffic`

### `Front_BuildStream__FPi` (0x8002a738, front.cpp:2634, map=exact)

- Extra source locals: `iVar3`, `uVar6`

### `PlayerName__Fi` (0x8002b9fc, front.cpp:3196, map=exact)

- Extra source locals: `name_len`, `s`, `wordnum`

### `PlayerNameMixedCase__Fi` (0x8002ba88, front.cpp:3238, map=exact)
