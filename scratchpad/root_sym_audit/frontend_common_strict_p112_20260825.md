...
- Declaration-clean mapped functions: 648
- Missing SYM names: 0
- Extra source-local names: 730
...
### `Front_BuildStream__FPi` (0x8002a738, front.cpp:2640, map=exact)

- Extra source locals: `iVar3`, `uVar6`

### `PlayerName__Fi` (0x8002b9fc, front.cpp:3202, map=exact)

- Extra source locals: `name_len`, `s`, `wordnum`

### `PlayerNameMixedCase__Fi` (0x8002ba88, front.cpp:3244, map=exact)
