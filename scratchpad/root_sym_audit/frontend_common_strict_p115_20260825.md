...
- Declaration-clean mapped functions: 652
- Missing SYM names: 0
- Extra source-local names: 718
...
### `Front_AppendCopData__FPiR9tFEStream` (0x80029e30, front.cpp:2277, map=exact)

- Extra source locals: `iVar2`, `ptVar1`, `slot`

### `Front_AppendPerpData__FPiR9tFEStream` (0x8002a084, front.cpp:2363, map=exact)

- Extra source locals: `carManagerPtr`, `iVar2`, `piVar3`, `ptVar1`

### `Front_BuildStream__FPi` (0x8002a738, front.cpp:2633, map=exact)
