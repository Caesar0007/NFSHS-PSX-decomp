...
- Declaration-clean mapped functions: 653
- Missing SYM names: 0
- Extra source-local names: 715
...
- Explicit source-only codegen carriers: 186
...
### `Front_InitMissions__FR9tFEStream` (0x80028b64, front.cpp:1658, map=exact)

- Extra source locals: `cVar1`, `cVar2`, `cVar3`, `cVar5`, `iVar4`

### `Front_AppendCopData__FPiR9tFEStream` (0x80029e30, front.cpp:2280, map=exact)

- Extra source locals: `iVar2`, `ptVar1`, `slot`

### `Front_AppendPerpData__FPiR9tFEStream` (0x8002a084, front.cpp:2366, map=exact)

- Extra source locals: `carManagerPtr`, `iVar2`, `piVar3`, `ptVar1`

### `Front_BuildStream__FPi` (0x8002a738, front.cpp:2636, map=exact)
