...
- Declaration-clean mapped functions: 654
- Missing SYM names: 0
- Extra source-local names: 711
...
- Explicit source-only codegen carriers: 188
...
### `Front_BuildStream__FPi` (0x8002a738, front.cpp:2638, map=exact)
