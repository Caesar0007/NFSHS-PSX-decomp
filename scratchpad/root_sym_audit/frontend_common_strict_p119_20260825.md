...
- Declaration-clean mapped functions: 656
- Missing SYM names: 0
- Extra source-local names: 701
...
### `Front_AppendCopData__FPiR9tFEStream` (0x80029e30, front.cpp:2271, map=exact)

- Extra source locals: `iVar2`, `ptVar1`, `slot`

### `Front_BuildStream__FPi` (0x8002a738, front.cpp:2629, map=exact)
