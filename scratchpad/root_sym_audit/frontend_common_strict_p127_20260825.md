...
- Declaration-clean mapped functions: 664
- Missing SYM names: 0
- Extra source-local names: 678
...
- Explicit source-only codegen carriers: 197
...
### `MenuExtended_ExitTourney__FR12tMenuCommand` (0x8002e18c, femenudefs.cpp:2503, map=exact)
...
### `__15tGlobalMenuDefs` (0x8002e3b8, femenudefs.cpp:3126, map=exact)
