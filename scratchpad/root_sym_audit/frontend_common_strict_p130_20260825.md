...
- Declaration-clean mapped functions: 667
- Missing SYM names: 0
- Extra source-local names: 670
...
- Explicit source-only codegen carriers: 200
...
### `Stattool_CheckForHumanCar__FP10Car_tStats` (0x8004aec4, stattool.cpp:269, map=exact)
