...
- Declaration-clean mapped functions: 674
- Missing SYM names: 0
- Extra source-local names: 649
...
- Explicit restored inline-local mappings: 5
...
### `MenuExtended_ExitPinkSlipsEarly__FR12tMenuCommand` (0x8002e21c, femenudefs.cpp:2554, map=exact)

- Extra source locals: `dlgThis`, `fmt`, `iVar5`, `msg`, `pcVar4`, `ptVar2`, `sVar3`

### `__15tGlobalMenuDefs` (0x8002e3b8, femenudefs.cpp:3119, map=exact)
...
### `DrawBackground__25tScreenCarSelectTwoPlayer` (0x8003e4bc, screencarselect.cpp:1996, map=exact)
...
### `DoMemCardStuff__25tScreenPinkSlipsCarSelect` (0x8003ef14, screencarselect.cpp:2404, map=exact)
