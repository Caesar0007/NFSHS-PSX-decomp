...
- Declaration-clean mapped functions: 676
- Missing SYM names: 0
...
- Explicit restored inline-local mappings: 14
- Explicit restored macro-local mappings: 0
- Explicit source-only codegen carriers: 215
...
### `SetState__16tScreenCarSelecti` (0x8003b59c, screencarselect.cpp:403, map=exact)

- Extra source locals: `cVar1`, `ovl`, `t1`, `t2`

### `Initialize__16tScreenCarSelect` (0x8003bd88, screencarselect.cpp:674, map=exact)

- Extra source locals: `fadeTick`, `mdefs`, `sVar2`, `showroomTick`, `uVar6`, `valid`

### `ProcessInput__16tScreenCarSelect7tPlayerR13tInputKeyTypeR12tMenuCommand` (0x8003bf90, screencarselect.cpp:767, map=exact)

- Extra source locals: `lrItem`, `state2`, `tVar4`, `vtbl`

### `DrawBackground__16tScreenCarSelect` (0x8003c53c, screencarselect.cpp:1011, map=exact)

- Extra source locals: `bVar1`, `bright`, `valid`, `vtbl`

### `DrawForeground__16tScreenCarSelect` (0x8003c7d8, screencarselect.cpp:1101, map=exact)

- Extra source locals: `currentItemValue`, `fadeBase`, `overlayDirection`, `shapeFade`, `shapeTicks`, `textBase`, `validCarValue`

### `PreLoad__20tScreenCarSelectDuel` (0x8003d08c, screencarselect.cpp:1347, map=exact)

- Extra source locals: `buf_or_path`, `str`, `use_default`, `vtbl`

### `DrawBackground__20tScreenCarSelectDuel` (0x8003d7f0, screencarselect.cpp:1616, map=exact)

- Extra source locals: `bVar1`, `bVar2`, `creditsTextVal`, `elapsed`, `sVar2`, `screenVtbl`, `screenVtbl2`, `vtbl`

### `DrawBackground__25tScreenCarSelectTwoPlayer` (0x8003e4bc, screencarselect.cpp:1985, map=exact)
...
### `DoMemCardStuff__25tScreenPinkSlipsCarSelect` (0x8003ef14, screencarselect.cpp:2357, map=exact)
...
### `LoadTrophy__17tScreenTrophyRoom` (0x80040f2c, screentrophyroom.cpp:308, map=exact)
...
### `CalculatePrizes__23tScreenPinkSlipCongrats` (0x80048cdc, screencongrats.cpp:466, map=exact)

- Extra source locals: `base`, `player`, `speechId2`, `vtbl`

### `CalculatePrizes__23tScreenTournamentTrophy` (0x8004923c, screencongrats.cpp:695, map=exact)
