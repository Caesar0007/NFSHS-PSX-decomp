...
- Declaration-clean mapped functions: 678
- Missing SYM names: 0
- Extra source-local names: 635
...
- Explicit restored inline-local mappings: 15
...
### `DrawBackground__16tScreenCarSelect` (0x8003c53c, screencarselect.cpp:983, map=exact)

- Extra source locals: `bVar1`, `bright`, `valid`, `vtbl`

### `DrawForeground__16tScreenCarSelect` (0x8003c7d8, screencarselect.cpp:1073, map=exact)

- Extra source locals: `currentItemValue`, `fadeBase`, `overlayDirection`, `shapeFade`, `shapeTicks`, `textBase`, `validCarValue`

### `PreLoad__20tScreenCarSelectDuel` (0x8003d08c, screencarselect.cpp:1319, map=exact)
...
### `DoMemCardStuff__25tScreenPinkSlipsCarSelect` (0x8003ef14, screencarselect.cpp:2329, map=exact)
