...
- Declaration-clean mapped functions: 679
- Missing SYM names: 0
- Extra source-local names: 631
...
- Explicit source-only codegen carriers: 216
...
### `DrawForeground__16tScreenCarSelect` (0x8003c7d8, screencarselect.cpp:1074, map=exact)

- Extra source locals: `currentItemValue`, `fadeBase`, `overlayDirection`, `shapeFade`, `shapeTicks`, `textBase`, `validCarValue`

### `PreLoad__20tScreenCarSelectDuel` (0x8003d08c, screencarselect.cpp:1320, map=exact)

- Extra source locals: `buf_or_path`, `str`, `use_default`, `vtbl`

### `DrawBackground__20tScreenCarSelectDuel` (0x8003d7f0, screencarselect.cpp:1589, map=exact)

- Extra source locals: `bVar1`, `bVar2`, `creditsTextVal`, `elapsed`, `sVar2`, `screenVtbl`, `screenVtbl2`, `vtbl`

### `DrawBackground__25tScreenCarSelectTwoPlayer` (0x8003e4bc, screencarselect.cpp:1958, map=exact)
...
### `DoMemCardStuff__25tScreenPinkSlipsCarSelect` (0x8003ef14, screencarselect.cpp:2330, map=exact)
