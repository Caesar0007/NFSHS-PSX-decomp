...
- Declaration-clean mapped functions: 680
- Missing SYM names: 0
- Extra source-local names: 627
...
- Explicit source-only codegen carriers: 217
...
### `DrawBackground__20tScreenCarSelectDuel` (0x8003d7f0, screencarselect.cpp:1590, map=exact)

- Extra source locals: `bVar1`, `bVar2`, `creditsTextVal`, `elapsed`, `sVar2`, `screenVtbl`, `screenVtbl2`, `vtbl`

### `DrawBackground__25tScreenCarSelectTwoPlayer` (0x8003e4bc, screencarselect.cpp:1959, map=exact)
...
### `DoMemCardStuff__25tScreenPinkSlipsCarSelect` (0x8003ef14, screencarselect.cpp:2331, map=exact)
