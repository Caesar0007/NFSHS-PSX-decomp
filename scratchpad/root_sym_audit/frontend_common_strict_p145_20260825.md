...
- Declaration-clean mapped functions: 682
- Missing SYM names: 0
- Extra source-local names: 618
...
- Explicit source-only codegen carriers: 225
...
### `PlaceIcons__14tScreenMemcardii` (0x80046a0c, screenmemcard.cpp:361, map=exact)

- Extra source locals: `animFrame`, `icon`, `nfs4Icon`, `numIcons`, `savedY`, `tickFrame`, `tickPtr`

### `DrawBackground__14tScreenMemcard` (0x80047470, screenmemcard.cpp:731, map=exact)

- Extra source locals: `extraY`, `gouraudX`, `gouraudY`, `h`, `startX`, `startY`, `w`, `width`

### `Initialize__14tScreenMemcard` (0x80047c30, screenmemcard.cpp:925, map=exact)
