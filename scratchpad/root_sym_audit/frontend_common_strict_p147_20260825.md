...
- Declaration-clean mapped functions: 684
- Missing SYM names: 0
...
- Explicit source-only codegen carriers: 232
...
### `DrawBackground__18tScreenTournSelect` (0x8003fe5c, screentournselect.cpp:253, map=exact)
...
### `PlaceIcons__14tScreenMemcardii` (0x80046a0c, screenmemcard.cpp:369, map=exact)

- Extra source locals: `animFrame`, `icon`, `nfs4Icon`, `numIcons`, `savedY`, `tickFrame`, `tickPtr`

### `DrawBackground__14tScreenMemcard` (0x80047470, screenmemcard.cpp:739, map=exact)

- Extra source locals: `extraY`, `gouraudX`, `gouraudY`, `h`, `startX`, `startY`, `w`, `width`

### `Initialize__14tScreenMemcard` (0x80047c30, screenmemcard.cpp:933, map=exact)
