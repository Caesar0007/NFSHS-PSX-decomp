...
- Declaration-clean mapped functions: 691
- Missing SYM names: 0
- Extra source-local names: 581
...
- Explicit source-only codegen carriers: 252
...
### `Draw__24tMenuItemLeftRightSliderb` (0x800251e4, femenu.cpp:1292, map=exact)

- Extra source locals: `iVar2`, `pa_Var3`, `uVar1`, `wordnum`

### `ProcessInput__23tMenuItemGoToMenuButton7tPlayerR13tInputKeyTypeR12tMenuCommand` (0x800253a4, femenu.cpp:1365, map=exact)
