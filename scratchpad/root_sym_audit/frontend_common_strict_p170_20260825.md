...
- Declaration-clean mapped functions: 708
- Missing SYM names: 0
- Extra source-local names: 466
...
- Explicit source-only codegen carriers: 296
...
- `ProcessInput__17tUserNameMenuItem7tPlayerR13tInputKeyTypeR12tMenuCommand`: `character`, `column`, `command`, `fromPlayer`, `lastColumn`, `rowBase`, `rowOffset`, `selectedChar`, `soundId`, `stringLength`
- `Draw__17tUserNameMenuItemb`: `boxRight`, `columnx`, `menuStartY`, `right`, `row`, `selected`
