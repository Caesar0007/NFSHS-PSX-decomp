...
- Declaration-clean mapped functions: 731
- Missing SYM names: 0
- Extra source-local names: 356
...
- Explicit restored inline-local mappings: 23
- Explicit restored macro-local mappings: 0
- Explicit linkage-proven ABI parameters omitted from SYM: 18
- Explicit source-only codegen carriers: 312
