...
- Declaration-clean mapped functions: 736
- Missing SYM names: 0
- Extra source-local names: 328
...
### `GoNonInterlaced__7tScreen` (0x80025bf8, fescreen.cpp:76, map=exact)
