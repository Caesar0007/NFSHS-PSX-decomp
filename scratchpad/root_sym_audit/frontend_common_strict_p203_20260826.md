...
- Declaration-clean mapped functions: 738
- Missing SYM names: 0
- Extra source-local names: 311
...
### `MenuExtended_GoToTwoPlayerSingleRace__FR12tMenuCommand` (0x8002c288, femenudefs.cpp:250, map=exact)

- Extra source locals: `defs`, `dlgThis`, `ptVar1`, `sVar3`, `this_00`, `uVar2`

### `MenuExtended_GoToRace__FR12tMenuCommand` (0x8002cc98, femenudefs.cpp:935, map=exact)

- Extra source locals: `dlgThis`, `pcVar3`, `ptVar1`, `uVar2`, `wordnum`

### `MenuExtended_GoTo2PlayerRace__FR12tMenuCommand` (0x8002cdf4, femenudefs.cpp:1007, map=exact)

- Extra source locals: `dlgThis`, `pcVar3`, `ptVar1`, `uVar2`, `wordnum`

### `MenuExtended_GoToTournTrackInfo__FR12tMenuCommand` (0x8002cf40, femenudefs.cpp:1079, map=exact)

- Extra source locals: `fe`, `iVar6`, `iVar7`, `pcVar5`, `pp`, `ptVar1`, `ptVar2`, `ptVar3`, `sVar4`, `this_00`, `tm`, `tsaved`

### `MenuExtended_GoToSpecialEventTrackInfo__FR12tMenuCommand` (0x8002d0a8, femenudefs.cpp:1175, map=exact)
...
### `MenuExtended_FinishedPlayer1GetName__FR12tMenuCommand` (0x8002dc04, femenudefs.cpp:2069, map=exact)

- Extra source locals: `dlgThis`, `ptVar1`, `ptVar2`, `ptVar3`, `pvVar5`, `sVar4`

### `MenuExtended_AwardPinkSlipsCar__FR12tMenuCommand` (0x8002de74, femenudefs.cpp:2230, map=exact)

- Extra source locals: `dlgThis2`, `dlgThis3`, `pcVar5`, `playerNum`, `ptVar2`, `ptVar3`, `this_00`

### `MenuExtended_ExitPinkSlipsEarly__FR12tMenuCommand` (0x8002e21c, femenudefs.cpp:2536, map=exact)

- Extra source locals: `dlgThis`, `fmt`, `iVar5`, `msg`, `pcVar4`, `ptVar2`, `sVar3`

### `__15tGlobalMenuDefs` (0x8002e3b8, femenudefs.cpp:3102, map=exact)
...
- `MenuExtended_GoToTwoPlayerSingleRace__FR12tMenuCommand`: `nextMenu`, `screenState`
