...
- Declaration-clean mapped functions: 744
- Missing SYM names: 0
- Extra source-local names: 274
...
- Explicit source-only codegen carriers: 349
...
### `DrawCurrCredit__14tCreditManager` (0x80036084, fecredits.cpp:262, map=exact)
