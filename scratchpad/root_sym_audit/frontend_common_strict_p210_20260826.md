...
- Declaration-clean mapped functions: 747
- Missing SYM names: 0
- Extra source-local names: 250
...
- `GoNonInterlaced__7tScreen`: `envBytes`, `firstView`, `firstViewIndex`, `playerViewIndex`, `primaryHeight`, `secondView`, `secondViewIndex`, `secondaryHeight`, `viewTable`
