...
- Declaration-clean mapped functions: 749
- Missing SYM names: 0
- Extra source-local names: 243
...
### `MenuExtended_PurchaseUpgrade__Fi` (0x8002d64c, femenudefs.cpp:1641, map=exact)
...
### `MenuExtended_ExitPinkSlipsEarly__FR12tMenuCommand` (0x8002e21c, femenudefs.cpp:2558, map=exact)
