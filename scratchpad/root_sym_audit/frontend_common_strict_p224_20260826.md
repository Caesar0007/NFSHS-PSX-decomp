...
- Declaration-clean mapped functions: 759
- Missing SYM names: 0
- Extra source-local names: 189
...
- Explicit source-only codegen carriers: 415
...
### `DrawForeground__16tScreenCarSelect` (0x8003c7d8, screencarselect.cpp:1072, map=exact)

- Extra source locals: `currentItemValue`, `fadeBase`, `overlayDirection`, `shapeFade`, `shapeTicks`, `textBase`, `validCarValue`

### `DrawBackground__20tScreenCarSelectDuel` (0x8003d7f0, screencarselect.cpp:1588, map=exact)

- Extra source locals: `bVar1`, `bVar2`, `creditsTextVal`, `elapsed`, `sVar2`, `screenVtbl`, `screenVtbl2`, `vtbl`

### `DrawBackground__25tScreenCarSelectTwoPlayer` (0x8003e4bc, screencarselect.cpp:1957, map=exact)
