...
- Declaration-clean mapped functions: 761
- Missing SYM names: 0
- Extra source-local names: 174
...
- Explicit source-only codegen carriers: 429
...
### `GoNonInterlaced__7tScreen` (0x80025bf8, fescreen.cpp:78, map=exact)

- Extra source locals: `dispY`, `env`, `height`, `iVar1`, `iVar2`, `playerView`, `sVar3`, `view0`, `view1`, `views`

### `MenuExtended_GoToTournTrackInfo__FR12tMenuCommand` (0x8002cf40, femenudefs.cpp:1100, map=exact)

- Extra source locals: `fe`, `feUse`, `iVar6`, `iVar7`, `pcVar5`, `pp`, `ptVar1`, `ptVar2`, `ptVar3`, `sVar4`, `this_00`, `tm`, `tsaved`

### `MenuExtended_GoToSpecialEventTrackInfo__FR12tMenuCommand` (0x8002d0a8, femenudefs.cpp:1197, map=exact)

- Extra source locals: `fe`, `iVar6`, `iVar7`, `pcVar5`, `pp`, `ptVar1`, `ptVar2`, `ptVar3`, `sVar4`, `this_00`, `tm`, `tsaved`

### `MenuExtended_BuyCar__FR12tMenuCommand` (0x8002d4f8, femenudefs.cpp:1577, map=exact)

- Extra source locals: `command`, `dlgThis`, `lVar3`, `pcVar4`, `pp`, `ptVar1`, `sVar2`, `this_00`

### `MenuExtended_AwardPinkSlipsCar__FR12tMenuCommand` (0x8002de74, femenudefs.cpp:2281, map=exact)

- Extra source locals: `dlgThis2`, `dlgThis3`, `pcVar5`, `playerNum`, `ptVar2`, `ptVar3`, `this_00`

### `MenuExtended_ExitPinkSlipsEarly__FR12tMenuCommand` (0x8002e21c, femenudefs.cpp:2589, map=exact)
...
### `DrawBackground__26tScreenTournamentStandings` (0x80039b84, screenpost.cpp:319, map=exact)

- Extra source locals: `bonus`, `halfWidth`, `lastRacer`, `line`, `numRacers`, `tm`, `type`

### `DrawBackground__20tScreenCarSelectDuel` (0x8003d7f0, screencarselect.cpp:1605, map=exact)

- Extra source locals: `bVar1`, `bVar2`, `creditsTextVal`, `elapsed`, `sVar2`, `screenVtbl`, `screenVtbl2`, `vtbl`

### `DrawBackground__25tScreenCarSelectTwoPlayer` (0x8003e4bc, screencarselect.cpp:1974, map=exact)
...
### `ProcessInput__18tScreenTrackSelect7tPlayerR13tInputKeyTypeR12tMenuCommand` (0x8004200c, screentracks.cpp:422, map=exact)
...
### `DrawBackground__14tScreenMemcard` (0x80047470, screenmemcard.cpp:755, map=exact)
