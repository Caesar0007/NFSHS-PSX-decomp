...
- Declaration-clean mapped functions: 762
- Missing SYM names: 0
- Extra source-local names: 167
...
- Explicit source-only codegen carriers: 434
...
### `ProcessInput__18tScreenTrackSelect7tPlayerR13tInputKeyTypeR12tMenuCommand` (0x8004200c, screentracks.cpp:430, map=exact)
