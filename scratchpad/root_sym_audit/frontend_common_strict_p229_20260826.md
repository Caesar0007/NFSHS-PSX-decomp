...
- Declaration-clean mapped functions: 764
- Missing SYM names: 0
- Extra source-local names: 153
...
- Explicit linkage-proven ABI parameters omitted from SYM: 21
- Explicit source-only codegen carriers: 440
...
### `MenuExtended_ExitPinkSlipsEarly__FR12tMenuCommand` (0x8002e21c, femenudefs.cpp:2594, map=exact)
...
- `MenuExtended_AwardPinkSlipsCar__FR12tMenuCommand`: `dlgThis2`, `dlgThis3`, `playerNum`, `ptVar3`, `this_00`
