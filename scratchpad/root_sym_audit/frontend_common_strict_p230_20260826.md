...
- Declaration-clean mapped functions: 765
- Missing SYM names: 0
- Extra source-local names: 146
...
- Explicit source-only codegen carriers: 443
...
- `MenuExtended_ExitPinkSlipsEarly__FR12tMenuCommand`: `dlgThis`, `msg`, `ptVar2`
