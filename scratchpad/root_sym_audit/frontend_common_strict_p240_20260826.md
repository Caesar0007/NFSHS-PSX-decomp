...
- Declaration-clean mapped functions: 776
- Missing SYM names: 0
- Extra source-local names: 41
...
### `DrawBackground__25tScreenCarSelectTwoPlayer` (0x8003e4bc, screencarselect.cpp:1976, map=exact)
