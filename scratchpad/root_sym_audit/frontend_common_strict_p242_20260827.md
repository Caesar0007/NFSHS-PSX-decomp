...
- Declaration-clean mapped functions: 778
- Missing SYM names: 0
- Extra source-local names: 13
...
- Explicit source-only codegen carriers: 518
...
- `DrawBackground__25tScreenCarSelectTwoPlayer`: `elapsed`, `player`, `uploadReady`, `uploadY`, `vtbl`
