...
- Explicit source-only codegen carriers: 514
...
### `_._31tDialogMessageStringWithTimeout` (0x80015760, fedialog.h:66, map=header-owner)
...
### `_._29tMenuItemOptionsTwoItemChoice` (0x8001bf00, femenuextended.h:1276, map=abi-carrier)

- Mapping: explicit verify_asm-PASS deleting-destructor ABI carrier; the source function's `pThis`/`__in_chrg` parameters represent the retail member destructor's implicit ABI parameters.
- Extra source locals: `thisp`

### `_._31tMenuItemOptionsLeftRightChoice` (0x8001bf20, femenuextended.h:1287, map=abi-carrier)

- Mapping: explicit verify_asm-PASS deleting-destructor ABI carrier; the source function's `pThis`/`__in_chrg` parameters represent the retail member destructor's implicit ABI parameters.
- Extra source locals: `thisp`

### `Draw__27tMenuItemGoToMenuNFS4Buttonb` (0x8001bf40, femenuextended.h:1293, map=header-owner-signature)
...
### `TransitionIsFinished__32tBlankMenuItemGoToMenuNFS4Button` (0x800321c0, femenuoptions.h:3563, map=header-owner)

- Storage: SYM STAT vs source EXT

### `Draw__32tBlankMenuItemGoToMenuNFS4Buttoniib` (0x800321c8, femenuoptions.h:3580, map=header-owner-signature)

- Storage: SYM STAT vs source EXT

### `Draw__32tBlankMenuItemGoToMenuNFS4Buttonb` (0x800321d0, femenuoptions.h:3581, map=header-owner-signature)

- Storage: SYM STAT vs source EXT

### `_._32tBlankMenuItemGoToMenuNFS4Button` (0x800321d8, femenuoptions.h:3590, map=abi-carrier)

- Mapping: explicit verify_asm-PASS deleting-destructor ABI carrier; the source function's `pThis`/`__in_chrg` parameters represent the retail member destructor's implicit ABI parameters.
- Extra source locals: `thisp`
- Storage: SYM STAT vs source EXT

### `TransitionIsFinished__33tBlankMenuItemNFS4LeftRightChoice` (0x800321f8, femenuextended.h:3595, map=header-owner)

- Storage: SYM STAT vs source EXT

### `Draw__33tBlankMenuItemNFS4LeftRightChoiceiib` (0x80032200, femenuextended.h:3601, map=header-owner)

- Storage: SYM STAT vs source EXT

### `_._33tBlankMenuItemNFS4LeftRightChoice` (0x80032208, femenuextended.h:3610, map=abi-carrier)

- Mapping: explicit verify_asm-PASS deleting-destructor ABI carrier; the source function's `pThis`/`__in_chrg` parameters represent the retail member destructor's implicit ABI parameters.
- Extra source locals: `thisp`
- Storage: SYM STAT vs source EXT

### `DrawBackground__11tScreenMain` (0x800379c0, screenmain.cpp:389, map=exact)

- Extra source locals: `curMenu`

### `_._11tScreenMain` (0x80038b44, screenmain.h:915, map=abi-carrier)

- Mapping: explicit verify_asm-PASS deleting-destructor ABI carrier; the source function's `pThis`/`__in_chrg` parameters represent the retail member destructor's implicit ABI parameters.
- Extra source locals: `thisp`

### `_._16tScreenPinkSlips` (0x800397cc, screenpinkslips.h:390, map=abi-carrier)

- Mapping: explicit verify_asm-PASS deleting-destructor ABI carrier; the source function's `pThis`/`__in_chrg` parameters represent the retail member destructor's implicit ABI parameters.
- Extra source locals: `thisp`

### `_._24tScreenPinkSlipStandings` (0x8003a88c, screenpost.h:584, map=abi-carrier)

- Mapping: explicit verify_asm-PASS deleting-destructor ABI carrier; the source function's `pThis`/`__in_chrg` parameters represent the retail member destructor's implicit ABI parameters.
- Extra source locals: `thisp`

### `_._31tScreenTournamentStandings3item` (0x8003a8ac, screenpost.h:594, map=abi-carrier)

- Mapping: explicit verify_asm-PASS deleting-destructor ABI carrier; the source function's `pThis`/`__in_chrg` parameters represent the retail member destructor's implicit ABI parameters.
- Extra source locals: `thisp`

### `_._26tScreenTournamentStandings` (0x8003a8cc, screenpost.h:604, map=abi-carrier)
...
### `_._20tScreenCarSelectDuel` (0x8003f758, screencarselect.h:2830, map=abi-carrier)

- Mapping: explicit verify_asm-PASS deleting-destructor ABI carrier; the source function's `pThis`/`__in_chrg` parameters represent the retail member destructor's implicit ABI parameters.
- Extra source locals: `thisp`

### `_._17tScreenTrophyInfo` (0x800415e0, screentrophyinfo.h:227, map=abi-carrier)

- Mapping: explicit verify_asm-PASS deleting-destructor ABI carrier; the source function's `pThis`/`__in_chrg` parameters represent the retail member destructor's implicit ABI parameters.
- Extra source locals: `thisp`

### `_._18tScreenTrackSelect` (0x800421d4, screentracks.h:514, map=abi-carrier)

- Mapping: explicit verify_asm-PASS deleting-destructor ABI carrier; the source function's `pThis`/`__in_chrg` parameters represent the retail member destructor's implicit ABI parameters.
- Extra source locals: `thisp`

### `_._16tScreenTrackInfo` (0x80042628, screentrackinfo.h:126, map=abi-carrier)

- Mapping: explicit verify_asm-PASS deleting-destructor ABI carrier; the source function's `pThis`/`__in_chrg` parameters represent the retail member destructor's implicit ABI parameters.
- Extra source locals: `thisp`

### `_._19tScreenTrackRecords` (0x800430f8, screentrackrecords.h:295, map=abi-carrier)
...
### `_._12tScreenAudio` (0x800462fc, screenaudio.h:362, map=abi-carrier)

- Mapping: explicit verify_asm-PASS deleting-destructor ABI carrier; the source function's `pThis`/`__in_chrg` parameters represent the retail member destructor's implicit ABI parameters.
- Extra source locals: `thisp`

### `_._14tScreenMemcard` (0x80047e3c, screenmemcard.h:1061, map=abi-carrier)

- Mapping: explicit verify_asm-PASS deleting-destructor ABI carrier; the source function's `pThis`/`__in_chrg` parameters represent the retail member destructor's implicit ABI parameters.
- Extra source locals: `thisp`

### `_._25tScreenTournamentCongrats` (0x800497a0, screencongrats.h:988, map=abi-carrier)

- Mapping: explicit verify_asm-PASS deleting-destructor ABI carrier; the source function's `pThis`/`__in_chrg` parameters represent the retail member destructor's implicit ABI parameters.
- Extra source locals: `thisp`

### `_._23tScreenBeTheCopCongrats` (0x800497c0, screencongrats.h:996, map=abi-carrier)

- Mapping: explicit verify_asm-PASS deleting-destructor ABI carrier; the source function's `pThis`/`__in_chrg` parameters represent the retail member destructor's implicit ABI parameters.
- Extra source locals: `thisp`

### `_._23tScreenPinkSlipCongrats` (0x800497e0, screencongrats.h:1004, map=abi-carrier)

- Mapping: explicit verify_asm-PASS deleting-destructor ABI carrier; the source function's `pThis`/`__in_chrg` parameters represent the retail member destructor's implicit ABI parameters.
- Extra source locals: `thisp`

### `_._23tScreenTournamentTrophy` (0x80049800, screencongrats.h:1012, map=abi-carrier)

- Mapping: explicit verify_asm-PASS deleting-destructor ABI carrier; the source function's `pThis`/`__in_chrg` parameters represent the retail member destructor's implicit ABI parameters.
- Extra source locals: `thisp`

### `_._15tScreenCongrats` (0x80049820, screencongrats.h:1020, map=abi-carrier)

- Mapping: explicit verify_asm-PASS deleting-destructor ABI carrier; the source function's `pThis`/`__in_chrg` parameters represent the retail member destructor's implicit ABI parameters.
- Extra source locals: `thisp`

### `_._15tScreenUserName` (0x8004b7d4, screenusername.h:400, map=abi-carrier)
...
- `SetScreen__14tFEApplicationsP7tScreen`: `currentScreen`, `slotOffset`
...
- `MenuExtended_GoToDealer__FR12tMenuCommand`: `carSelectScreen`, `cmdType`, `commandPtr`, `menuDefinitions`, `state`
- `MenuExtended_GoToSeller__FR12tMenuCommand`: `carSelectScreen`, `cmdType`, `commandPtr`, `menuDefinitions`, `state`
...
- `DrawBackground__11tScreenMain`: `animationFrame`, `elapsedTicks`, `fadeComponent`, `nextAnimation`, `startMovie`, `videoY`
...
- `DrawBackground__26tScreenTournamentStandings`: `halfWidth`, `lastRacer`, `line`, `numRacers`, `type`
...
- `UpdateVideoWall__16tScreenCarSelectR8tCarInfo`: `country`
...
- `DrawBackground__18tScreenTournSelect`: `descriptionText`, `fe`, `number`, `shapeX`, `tournament`, `tvIdx`, `word`
...
- `DrawBackground__17tScreenTrophyInfo`: `currentTourn`, `fade`, `feTier`, `tourn`, `tournID`, `word`
