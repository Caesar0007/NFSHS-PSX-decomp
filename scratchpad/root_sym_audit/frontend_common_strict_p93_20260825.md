...
- Declaration-clean mapped functions: 623
- Missing SYM names: 0
- Extra source-local names: 780
...
- Explicit source-only codegen carriers: 165
...
### `TransitionOn__12tMenuOptions` (0x8001be00, femenuextended.cpp:1192, map=exact)

- Extra source locals: `iVar1`, `ptVar2`, `ptVar3`
...
### `UpdateTransition__7tScreen` (0x80026848, fescreen.cpp:640, map=exact)

- Extra source locals: `iVar2`, `iVar3`, `sVar1`

### `Front_Menu__F21tFront_ProcessingType` (0x80027af4, front.cpp:1022, map=exact)

- Extra source locals: `needCar`, `one`

### `Front_InitPlayerCars__FR9tFEStream` (0x80028098, front.cpp:1233, map=exact)

- Extra source locals: `pcVar3`, `ptVar6`, `pvVar4`, `sVar2`, `uVar1`

### `Front_InitTourneyTraffic__FR9tFEStream` (0x8002845c, front.cpp:1351, map=exact)

- Extra source locals: `maxTraffic`, `tourn`

### `Front_InitOpponentCars__FR9tFEStream` (0x800285d0, front.cpp:1470, map=exact)

- Extra source locals: `numRacers`, `numRacers2`, `pvVar5`

### `Front_InitMissions__FR9tFEStream` (0x80028b64, front.cpp:1643, map=exact)

- Extra source locals: `cVar1`, `cVar2`, `cVar3`, `cVar5`, `iVar4`

### `Front_InitTrack__FR9tFEStream` (0x8002921c, front.cpp:1867, map=exact)

- Extra source locals: `iVar1`, `pTrack`, `src`

### `Front_AppendPlayerCarData__FPiR9tFEStream` (0x80029618, front.cpp:2020, map=exact)

- Extra source locals: `iVar1`, `uVar2`

### `Front_AppendOpponentData__FPiR9tFEStream` (0x80029afc, front.cpp:2183, map=exact)

- Extra source locals: `bVar1`, `iVar2`, `ptVar3`

### `Front_AppendCopData__FPiR9tFEStream` (0x80029e30, front.cpp:2275, map=exact)

- Extra source locals: `iVar2`, `ptVar1`, `slot`

### `Front_AppendPerpData__FPiR9tFEStream` (0x8002a084, front.cpp:2361, map=exact)

- Extra source locals: `carManagerPtr`, `iVar2`, `piVar3`, `ptVar1`

### `Front_AppendTrafficData__FPiR9tFEStream` (0x8002a31c, front.cpp:2449, map=exact)

- Extra source locals: `ptVar1`, `traffic`

### `Front_BuildStream__FPi` (0x8002a738, front.cpp:2625, map=exact)

- Extra source locals: `iVar3`, `uVar6`

### `SetLicensePlate__Fv` (0x8002b7cc, front.cpp:3054, map=exact)

- Extra source locals: `fmt`, `s`

### `PlayerName__Fi` (0x8002b9fc, front.cpp:3192, map=exact)

- Extra source locals: `name_len`, `s`, `wordnum`

### `PlayerNameMixedCase__Fi` (0x8002ba88, front.cpp:3234, map=exact)

- Extra source locals: `name_len`, `s`, `wordnum`

### `MenuExtended_GoToTwoPlayerSingleRace__FR12tMenuCommand` (0x8002c288, femenudefs.cpp:235, map=exact)

- Extra source locals: `defs`, `dlgThis`, `ptVar1`, `sVar3`, `screenState`, `this_00`, `uVar2`

### `AskTheUserToSaveTheGame__Fv` (0x8002c41c, femenudefs.cpp:346, map=exact)

- Extra source locals: `dlgThis`, `is_cheater`

### `MenuExtended_TransitionFromPostGameToMainMenuAndSaveGame__FR12tMenuCommand` (0x8002c4b0, femenudefs.cpp:409, map=exact)

- Extra source locals: `iVar2`, `ptVar1`

### `MenuExtended_GoToCarSelect__FR12tMenuCommand` (0x8002c4fc, femenudefs.cpp:437, map=exact)

- Extra source locals: `dialog`, `nextMenu`, `screen`, `state`

### `MenuExtended_GoToDealer__FR12tMenuCommand` (0x8002c890, femenudefs.cpp:591, map=exact)

- Extra source locals: `cmdType`, `dlgThis`, `ptVar1`

### `MenuExtended_GoToSeller__FR12tMenuCommand` (0x8002c8f8, femenudefs.cpp:631, map=exact)

- Extra source locals: `cmdType`, `dlgThis`, `ptVar1`

### `GenericMenuSaveGame__Fi` (0x8002c9a0, femenudefs.cpp:696, map=exact)

- Extra source locals: `app`, `dlgThis`, `noInput`, `pcVar4`, `ret`

### `PinkSlipsPreSave__Fv` (0x8002cabc, femenudefs.cpp:754, map=exact)

- Extra source locals: `dlgThis`, `is_cheater`

### `MenuExtended_GoToBestOfOne__FR12tMenuCommand` (0x8002cb84, femenudefs.cpp:802, map=exact)

- Extra source locals: `ptVar1`, `pvVar2`

### `MenuExtended_GoToBestOfThree__FR12tMenuCommand` (0x8002cbe0, femenudefs.cpp:832, map=exact)

- Extra source locals: `ptVar1`, `pvVar2`

### `MenuExtended_GoToBestOfFive__FR12tMenuCommand` (0x8002cc3c, femenudefs.cpp:862, map=exact)

- Extra source locals: `ptVar1`, `pvVar2`

### `MenuExtended_GoToRace__FR12tMenuCommand` (0x8002cc98, femenudefs.cpp:891, map=exact)

- Extra source locals: `dlgThis`, `pcVar3`, `ptVar1`, `uVar2`, `wordnum`

### `MenuExtended_GoTo2PlayerRace__FR12tMenuCommand` (0x8002cdf4, femenudefs.cpp:963, map=exact)

- Extra source locals: `dlgThis`, `pcVar3`, `ptVar1`, `uVar2`, `wordnum`

### `MenuExtended_GoToTournTrackInfo__FR12tMenuCommand` (0x8002cf40, femenudefs.cpp:1035, map=exact)

- Extra source locals: `dlgThis`, `fe`, `iVar6`, `iVar7`, `pcVar5`, `pp`, `ptVar1`, `ptVar2`, `ptVar3`, `sVar4`, `this_00`, `tm`, `tsaved`

### `MenuExtended_GoToSpecialEventTrackInfo__FR12tMenuCommand` (0x8002d0a8, femenudefs.cpp:1132, map=exact)

- Extra source locals: `dlgThis`, `fe`, `iVar6`, `iVar7`, `pcVar5`, `pp`, `ptVar1`, `ptVar2`, `ptVar3`, `sVar4`, `this_00`, `tm`, `tsaved`

### `MenuExtended_EnterUserName__FR12tMenuCommand` (0x8002d214, femenudefs.cpp:1255, map=exact)

- Extra source locals: `bVar1`, `bVar2`, `dlgThis`, `ptVar3`, `ptVar4`

### `MenuExtended_SellCar__FR12tMenuCommand` (0x8002d3a0, femenudefs.cpp:1444, map=exact)

- Extra source locals: `bVar1`, `command`, `dlgThis`, `lVar4`, `lVar5`, `lVar6`, `pcVar7`, `pp`, `ptVar2`, `sVar3`, `this_00`

### `MenuExtended_BuyCar__FR12tMenuCommand` (0x8002d4f8, femenudefs.cpp:1548, map=exact)

- Extra source locals: `command`, `dlgThis`, `lVar3`, `pcVar4`, `pp`, `ptVar1`, `sVar2`, `this_00`

### `MenuExtended_PurchaseUpgrade__Fi` (0x8002d64c, femenudefs.cpp:1619, map=exact)

- Extra source locals: `dlgThis`, `lVar3`, `pcVar4`, `pp`, `ptVar1`, `sVar2`, `uVar5`

### `GenericMenuLoadGame__Fi` (0x8002d83c, femenudefs.cpp:1804, map=exact)

- Extra source locals: `app`, `mc`

### `MenuExtended_LoadGame__FR12tMenuCommand` (0x8002d8d0, femenudefs.cpp:1877, map=exact)

- Extra source locals: `command`, `dlgThis`, `framePadding`, `sVar1`

### `MenuExtended_TierFinished__FR12tMenuCommand` (0x8002d968, femenudefs.cpp:1912, map=exact)

- Extra source locals: `iVar1`, `ptVar2`

### `MenuExtended_PostGameMenu__FR12tMenuCommand` (0x8002db04, femenudefs.cpp:2020, map=exact)

- Extra source locals: `dlgThis`, `ptVar3`, `ptVar4`, `pvVar2`, `sVar1`

### `MenuExtended_FinishedPlayer1GetName__FR12tMenuCommand` (0x8002dc04, femenudefs.cpp:2079, map=exact)

- Extra source locals: `dlgThis`, `ptVar1`, `ptVar2`, `ptVar3`, `pvVar5`, `sVar4`

### `MenuExtended_FinishedPlayer2GetName__FR12tMenuCommand` (0x8002dd14, femenudefs.cpp:2130, map=exact)

- Extra source locals: `ptVar1`, `pvVar3`, `sVar2`

### `MenuExtended_AwardPinkSlipsCar__FR12tMenuCommand` (0x8002de74, femenudefs.cpp:2250, map=exact)

- Extra source locals: `dlgThis`, `dlgThis2`, `dlgThis3`, `pcVar5`, `playerNum`, `ptVar1`, `ptVar2`, `ptVar3`, `this_00`

### `MenuExtended_GoToGarage__FR12tMenuCommand` (0x8002e09c, femenudefs.cpp:2342, map=exact)

- Extra source locals: `dlgThis`, `ptVar1`, `this_00`

### `MenuExtended_ExitTourney__FR12tMenuCommand` (0x8002e18c, femenudefs.cpp:2509, map=exact)

- Extra source locals: `dlgThis`, `ptVar1`, `sVar2`

### `MenuExtended_ExitPinkSlipsEarly__FR12tMenuCommand` (0x8002e21c, femenudefs.cpp:2567, map=exact)

- Extra source locals: `dlgThis`, `fmt`, `iVar5`, `msg`, `pcVar4`, `ptVar2`, `sVar3`

### `MenuExtended_PinkSlipsContinue__FR12tMenuCommand` (0x8002e34c, femenudefs.cpp:2630, map=exact)

- Extra source locals: `bVar2`, `ptVar1`

### `__15tGlobalMenuDefs` (0x8002e3b8, femenudefs.cpp:3136, map=exact)
...
### `SavePinkSlipsCarsWithErrorDialogs__Fsss` (0x80035778, fememcard.cpp:933, map=exact)

- Extra source locals: `dialog`, `rc`
...
### `DrawBackground__24tScreenPinkSlipStandings` (0x8003a448, screenpost.cpp:464, map=exact)

- Extra source locals: `halfWidth`, `pixels`, `row`

### `DrawOverlay__16tScreenCarSelectP8tOverlay` (0x8003ad00, screencarselect.cpp:187, map=exact)

- Extra source locals: `flags`, `tournamentMoney`, `vtbl`, `xPos`, `yOffset`

### `SetState__16tScreenCarSelecti` (0x8003b59c, screencarselect.cpp:388, map=exact)

- Extra source locals: `cVar1`, `ovl`, `t1`, `t2`

### `GetShapeInfo__16tScreenCarSelectRsT1PPcT3` (0x8003bae0, screencarselect.cpp:563, map=exact)

- Extra source locals: `valid`, `vtbl`

### `Initialize__16tScreenCarSelect` (0x8003bd88, screencarselect.cpp:656, map=exact)

- Extra source locals: `fadeTick`, `mdefs`, `sVar2`, `showroomTick`, `uVar6`, `valid`

### `ProcessInput__16tScreenCarSelect7tPlayerR13tInputKeyTypeR12tMenuCommand` (0x8003bf90, screencarselect.cpp:749, map=exact)
...
- Extra source locals: `this_00`, `vtbl`

### `GetCar__16tScreenCarSelectR8tCarInfo` (0x8003c224, screencarselect.cpp:897, map=exact)

- Extra source locals: `count`, `uVar1`

### `UpdateBrightness__16tScreenCarSelects` (0x8003c4b8, screencarselect.cpp:968, map=exact)

- Extra source locals: `brightness`, `destBrightness`, `sVar3`

### `DrawBackground__16tScreenCarSelect` (0x8003c53c, screencarselect.cpp:1003, map=exact)

- Extra source locals: `bVar1`, `bright`, `valid`, `vtbl`

### `DrawForeground__16tScreenCarSelect` (0x8003c7d8, screencarselect.cpp:1107, map=exact)

- Extra source locals: `currentItemValue`, `fadeBase`, `overlayDirection`, `shapeFade`, `shapeTicks`, `textBase`, `validCarValue`

### `PreLoad__20tScreenCarSelectDuel` (0x8003d08c, screencarselect.cpp:1353, map=exact)

- Extra source locals: `buf_or_path`, `str`, `use_default`, `vtbl`

### `DrawVideoWall__20tScreenCarSelectDuels` (0x8003d364, screencarselect.cpp:1464, map=exact)

- Extra source locals: `vtbl`, `vw`

### `DrawOpponentVideoWall__20tScreenCarSelectDuels` (0x8003d4bc, screencarselect.cpp:1523, map=exact)

- Extra source locals: `this_00`, `vw_opp`

### `GetShapeInfo__20tScreenCarSelectDuelRsT1PPcT3` (0x8003d5e0, screencarselect.cpp:1559, map=exact)

- Extra source locals: `valid`, `vtbl`

### `DrawBackground__20tScreenCarSelectDuel` (0x8003d7f0, screencarselect.cpp:1640, map=exact)

- Extra source locals: `bVar1`, `bVar2`, `creditsTextVal`, `elapsed`, `sVar2`, `screenVtbl`, `screenVtbl2`, `vtbl`

### `DrawForeground__20tScreenCarSelectDuel` (0x8003de68, screencarselect.cpp:1795, map=exact)

- Extra source locals: `ci`, `sliderResult`, `vtbl`

### `DrawVideoWall__25tScreenCarSelectTwoPlayers` (0x8003e190, screencarselect.cpp:1920, map=exact)

- Extra source locals: `offset`, `sVar2`, `vtbl`

### `DrawBackground__25tScreenCarSelectTwoPlayer` (0x8003e4bc, screencarselect.cpp:2035, map=exact)
...
### `DoMemCardStuff__25tScreenPinkSlipsCarSelect` (0x8003ef14, screencarselect.cpp:2443, map=exact)
...
### `SetBrightness__18tScreenTrackSelects` (0x80041d68, screentracks.cpp:311, map=exact)

- Extra source locals: `curBrightness`, `iVar1`

### `ProcessInput__18tScreenTrackSelect7tPlayerR13tInputKeyTypeR12tMenuCommand` (0x8004200c, screentracks.cpp:419, map=exact)
...
### `DrawBackground__15tScreenCongrats` (0x8004813c, screencongrats.cpp:112, map=exact)

- Extra source locals: `spinTicks`, `vtbl`

### `CalculatePrizes__15tScreenCongrats` (0x800489b8, screencongrats.cpp:319, map=exact)

- Extra source locals: `carCXBits`, `carCYBits`

### `Initialize__15tScreenCongrats` (0x80048a2c, screencongrats.cpp:352, map=exact)

- Extra source locals: `tick`, `vtbl`

### `CalculatePrizes__23tScreenPinkSlipCongrats` (0x80048cdc, screencongrats.cpp:458, map=exact)

- Extra source locals: `base`, `player`, `speechId2`, `vtbl`

### `CalculatePrizes__23tScreenTournamentTrophy` (0x8004923c, screencongrats.cpp:687, map=exact)
...
### `StatChk_SaveTopTime__FP10Car_tStatss` (0x8004a1b8, statchk.cpp:426, map=exact)

- Extra source locals: `copyDst`, `uRecSz`
