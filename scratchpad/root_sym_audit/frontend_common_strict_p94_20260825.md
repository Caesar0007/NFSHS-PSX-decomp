...
- Declaration-clean mapped functions: 626
- Missing SYM names: 0
- Extra source-local names: 774
...
- Explicit source-only codegen carriers: 166
...
### `PlayerName__Fi` (0x8002b9fc, front.cpp:3187, map=exact)

- Extra source locals: `name_len`, `s`, `wordnum`

### `PlayerNameMixedCase__Fi` (0x8002ba88, front.cpp:3229, map=exact)
...
### `UpdateBrightness__16tScreenCarSelects` (0x8003c4b8, screencarselect.cpp:969, map=exact)

- Extra source locals: `brightness`, `destBrightness`, `sVar3`

### `DrawBackground__16tScreenCarSelect` (0x8003c53c, screencarselect.cpp:1004, map=exact)

- Extra source locals: `bVar1`, `bright`, `valid`, `vtbl`

### `DrawForeground__16tScreenCarSelect` (0x8003c7d8, screencarselect.cpp:1108, map=exact)

- Extra source locals: `currentItemValue`, `fadeBase`, `overlayDirection`, `shapeFade`, `shapeTicks`, `textBase`, `validCarValue`

### `PreLoad__20tScreenCarSelectDuel` (0x8003d08c, screencarselect.cpp:1354, map=exact)

- Extra source locals: `buf_or_path`, `str`, `use_default`, `vtbl`

### `DrawVideoWall__20tScreenCarSelectDuels` (0x8003d364, screencarselect.cpp:1465, map=exact)

- Extra source locals: `vtbl`, `vw`

### `DrawOpponentVideoWall__20tScreenCarSelectDuels` (0x8003d4bc, screencarselect.cpp:1524, map=exact)

- Extra source locals: `this_00`, `vw_opp`

### `GetShapeInfo__20tScreenCarSelectDuelRsT1PPcT3` (0x8003d5e0, screencarselect.cpp:1560, map=exact)

- Extra source locals: `valid`, `vtbl`

### `DrawBackground__20tScreenCarSelectDuel` (0x8003d7f0, screencarselect.cpp:1641, map=exact)

- Extra source locals: `bVar1`, `bVar2`, `creditsTextVal`, `elapsed`, `sVar2`, `screenVtbl`, `screenVtbl2`, `vtbl`

### `DrawForeground__20tScreenCarSelectDuel` (0x8003de68, screencarselect.cpp:1796, map=exact)

- Extra source locals: `ci`, `sliderResult`, `vtbl`

### `DrawVideoWall__25tScreenCarSelectTwoPlayers` (0x8003e190, screencarselect.cpp:1921, map=exact)

- Extra source locals: `offset`, `sVar2`, `vtbl`

### `DrawBackground__25tScreenCarSelectTwoPlayer` (0x8003e4bc, screencarselect.cpp:2036, map=exact)
...
### `DoMemCardStuff__25tScreenPinkSlipsCarSelect` (0x8003ef14, screencarselect.cpp:2444, map=exact)
