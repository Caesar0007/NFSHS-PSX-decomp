...
- Declaration-clean mapped functions: 627
- Missing SYM names: 0
- Extra source-local names: 772
...
- Explicit source-only codegen carriers: 167
...
### `CalculatePrizes__23tScreenPinkSlipCongrats` (0x80048cdc, screencongrats.cpp:457, map=exact)

- Extra source locals: `base`, `player`, `speechId2`, `vtbl`

### `CalculatePrizes__23tScreenTournamentTrophy` (0x8004923c, screencongrats.cpp:686, map=exact)
