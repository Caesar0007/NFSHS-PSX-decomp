...
- Declaration-clean mapped functions: 628
- Missing SYM names: 0
- Extra source-local names: 770
...
- Explicit source-only codegen carriers: 168
...
### `MenuExtended_TransitionFromPostGameToMainMenuAndSaveGame__FR12tMenuCommand` (0x8002c4b0, femenudefs.cpp:411, map=exact)

- Extra source locals: `iVar2`, `ptVar1`

### `MenuExtended_GoToCarSelect__FR12tMenuCommand` (0x8002c4fc, femenudefs.cpp:439, map=exact)

- Extra source locals: `dialog`, `nextMenu`, `screen`, `state`

### `MenuExtended_GoToDealer__FR12tMenuCommand` (0x8002c890, femenudefs.cpp:593, map=exact)

- Extra source locals: `cmdType`, `dlgThis`, `ptVar1`

### `MenuExtended_GoToSeller__FR12tMenuCommand` (0x8002c8f8, femenudefs.cpp:633, map=exact)

- Extra source locals: `cmdType`, `dlgThis`, `ptVar1`

### `GenericMenuSaveGame__Fi` (0x8002c9a0, femenudefs.cpp:698, map=exact)

- Extra source locals: `app`, `dlgThis`, `noInput`, `pcVar4`, `ret`

### `PinkSlipsPreSave__Fv` (0x8002cabc, femenudefs.cpp:756, map=exact)

- Extra source locals: `dlgThis`, `is_cheater`

### `MenuExtended_GoToBestOfOne__FR12tMenuCommand` (0x8002cb84, femenudefs.cpp:804, map=exact)

- Extra source locals: `ptVar1`, `pvVar2`

### `MenuExtended_GoToBestOfThree__FR12tMenuCommand` (0x8002cbe0, femenudefs.cpp:834, map=exact)

- Extra source locals: `ptVar1`, `pvVar2`

### `MenuExtended_GoToBestOfFive__FR12tMenuCommand` (0x8002cc3c, femenudefs.cpp:864, map=exact)

- Extra source locals: `ptVar1`, `pvVar2`

### `MenuExtended_GoToRace__FR12tMenuCommand` (0x8002cc98, femenudefs.cpp:893, map=exact)

- Extra source locals: `dlgThis`, `pcVar3`, `ptVar1`, `uVar2`, `wordnum`

### `MenuExtended_GoTo2PlayerRace__FR12tMenuCommand` (0x8002cdf4, femenudefs.cpp:965, map=exact)

- Extra source locals: `dlgThis`, `pcVar3`, `ptVar1`, `uVar2`, `wordnum`

### `MenuExtended_GoToTournTrackInfo__FR12tMenuCommand` (0x8002cf40, femenudefs.cpp:1037, map=exact)

- Extra source locals: `dlgThis`, `fe`, `iVar6`, `iVar7`, `pcVar5`, `pp`, `ptVar1`, `ptVar2`, `ptVar3`, `sVar4`, `this_00`, `tm`, `tsaved`

### `MenuExtended_GoToSpecialEventTrackInfo__FR12tMenuCommand` (0x8002d0a8, femenudefs.cpp:1134, map=exact)

- Extra source locals: `dlgThis`, `fe`, `iVar6`, `iVar7`, `pcVar5`, `pp`, `ptVar1`, `ptVar2`, `ptVar3`, `sVar4`, `this_00`, `tm`, `tsaved`

### `MenuExtended_EnterUserName__FR12tMenuCommand` (0x8002d214, femenudefs.cpp:1257, map=exact)

- Extra source locals: `bVar1`, `bVar2`, `dlgThis`, `ptVar3`, `ptVar4`

### `MenuExtended_SellCar__FR12tMenuCommand` (0x8002d3a0, femenudefs.cpp:1446, map=exact)

- Extra source locals: `bVar1`, `command`, `dlgThis`, `lVar4`, `lVar5`, `lVar6`, `pcVar7`, `pp`, `ptVar2`, `sVar3`, `this_00`

### `MenuExtended_BuyCar__FR12tMenuCommand` (0x8002d4f8, femenudefs.cpp:1550, map=exact)

- Extra source locals: `command`, `dlgThis`, `lVar3`, `pcVar4`, `pp`, `ptVar1`, `sVar2`, `this_00`

### `MenuExtended_PurchaseUpgrade__Fi` (0x8002d64c, femenudefs.cpp:1621, map=exact)

- Extra source locals: `dlgThis`, `lVar3`, `pcVar4`, `pp`, `ptVar1`, `sVar2`, `uVar5`

### `GenericMenuLoadGame__Fi` (0x8002d83c, femenudefs.cpp:1806, map=exact)

- Extra source locals: `app`, `mc`

### `MenuExtended_LoadGame__FR12tMenuCommand` (0x8002d8d0, femenudefs.cpp:1879, map=exact)

- Extra source locals: `command`, `dlgThis`, `framePadding`, `sVar1`

### `MenuExtended_TierFinished__FR12tMenuCommand` (0x8002d968, femenudefs.cpp:1914, map=exact)

- Extra source locals: `iVar1`, `ptVar2`

### `MenuExtended_PostGameMenu__FR12tMenuCommand` (0x8002db04, femenudefs.cpp:2022, map=exact)

- Extra source locals: `dlgThis`, `ptVar3`, `ptVar4`, `pvVar2`, `sVar1`

### `MenuExtended_FinishedPlayer1GetName__FR12tMenuCommand` (0x8002dc04, femenudefs.cpp:2081, map=exact)

- Extra source locals: `dlgThis`, `ptVar1`, `ptVar2`, `ptVar3`, `pvVar5`, `sVar4`

### `MenuExtended_FinishedPlayer2GetName__FR12tMenuCommand` (0x8002dd14, femenudefs.cpp:2132, map=exact)

- Extra source locals: `ptVar1`, `pvVar3`, `sVar2`

### `MenuExtended_AwardPinkSlipsCar__FR12tMenuCommand` (0x8002de74, femenudefs.cpp:2252, map=exact)

- Extra source locals: `dlgThis`, `dlgThis2`, `dlgThis3`, `pcVar5`, `playerNum`, `ptVar1`, `ptVar2`, `ptVar3`, `this_00`

### `MenuExtended_GoToGarage__FR12tMenuCommand` (0x8002e09c, femenudefs.cpp:2344, map=exact)

- Extra source locals: `dlgThis`, `ptVar1`, `this_00`

### `MenuExtended_ExitTourney__FR12tMenuCommand` (0x8002e18c, femenudefs.cpp:2511, map=exact)

- Extra source locals: `dlgThis`, `ptVar1`, `sVar2`

### `MenuExtended_ExitPinkSlipsEarly__FR12tMenuCommand` (0x8002e21c, femenudefs.cpp:2569, map=exact)

- Extra source locals: `dlgThis`, `fmt`, `iVar5`, `msg`, `pcVar4`, `ptVar2`, `sVar3`

### `MenuExtended_PinkSlipsContinue__FR12tMenuCommand` (0x8002e34c, femenudefs.cpp:2632, map=exact)

- Extra source locals: `bVar2`, `ptVar1`

### `__15tGlobalMenuDefs` (0x8002e3b8, femenudefs.cpp:3138, map=exact)
...
### `GetShapeInfo__16tScreenCarSelectRsT1PPcT3` (0x8003bae0, screencarselect.cpp:555, map=exact)

- Extra source locals: `valid`, `vtbl`

### `Initialize__16tScreenCarSelect` (0x8003bd88, screencarselect.cpp:648, map=exact)

- Extra source locals: `fadeTick`, `mdefs`, `sVar2`, `showroomTick`, `uVar6`, `valid`

### `ProcessInput__16tScreenCarSelect7tPlayerR13tInputKeyTypeR12tMenuCommand` (0x8003bf90, screencarselect.cpp:741, map=exact)

- Extra source locals: `lrItem`, `state2`, `tVar4`, `vtbl`

### `DrawVideoWall__16tScreenCarSelects` (0x8003c118, screencarselect.cpp:841, map=exact)

- Extra source locals: `this_00`, `vtbl`

### `UpdateBrightness__16tScreenCarSelects` (0x8003c4b8, screencarselect.cpp:961, map=exact)

- Extra source locals: `brightness`, `destBrightness`, `sVar3`

### `DrawBackground__16tScreenCarSelect` (0x8003c53c, screencarselect.cpp:996, map=exact)

- Extra source locals: `bVar1`, `bright`, `valid`, `vtbl`

### `DrawForeground__16tScreenCarSelect` (0x8003c7d8, screencarselect.cpp:1100, map=exact)

- Extra source locals: `currentItemValue`, `fadeBase`, `overlayDirection`, `shapeFade`, `shapeTicks`, `textBase`, `validCarValue`

### `PreLoad__20tScreenCarSelectDuel` (0x8003d08c, screencarselect.cpp:1346, map=exact)

- Extra source locals: `buf_or_path`, `str`, `use_default`, `vtbl`

### `DrawVideoWall__20tScreenCarSelectDuels` (0x8003d364, screencarselect.cpp:1457, map=exact)

- Extra source locals: `vtbl`, `vw`

### `DrawOpponentVideoWall__20tScreenCarSelectDuels` (0x8003d4bc, screencarselect.cpp:1516, map=exact)

- Extra source locals: `this_00`, `vw_opp`

### `GetShapeInfo__20tScreenCarSelectDuelRsT1PPcT3` (0x8003d5e0, screencarselect.cpp:1552, map=exact)

- Extra source locals: `valid`, `vtbl`

### `DrawBackground__20tScreenCarSelectDuel` (0x8003d7f0, screencarselect.cpp:1633, map=exact)

- Extra source locals: `bVar1`, `bVar2`, `creditsTextVal`, `elapsed`, `sVar2`, `screenVtbl`, `screenVtbl2`, `vtbl`

### `DrawForeground__20tScreenCarSelectDuel` (0x8003de68, screencarselect.cpp:1788, map=exact)

- Extra source locals: `ci`, `sliderResult`, `vtbl`

### `DrawVideoWall__25tScreenCarSelectTwoPlayers` (0x8003e190, screencarselect.cpp:1913, map=exact)

- Extra source locals: `offset`, `sVar2`, `vtbl`

### `DrawBackground__25tScreenCarSelectTwoPlayer` (0x8003e4bc, screencarselect.cpp:2028, map=exact)
...
### `DoMemCardStuff__25tScreenPinkSlipsCarSelect` (0x8003ef14, screencarselect.cpp:2436, map=exact)
