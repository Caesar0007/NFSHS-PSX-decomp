...
- Declaration-clean mapped functions: 633
- Missing SYM names: 0
- Extra source-local names: 760
...
### `GenericMenuLoadGame__Fi` (0x8002d83c, femenudefs.cpp:1793, map=exact)

- Extra source locals: `app`, `mc`

### `MenuExtended_LoadGame__FR12tMenuCommand` (0x8002d8d0, femenudefs.cpp:1866, map=exact)

- Extra source locals: `command`, `dlgThis`, `framePadding`, `sVar1`

### `MenuExtended_TierFinished__FR12tMenuCommand` (0x8002d968, femenudefs.cpp:1901, map=exact)

- Extra source locals: `iVar1`, `ptVar2`

### `MenuExtended_PostGameMenu__FR12tMenuCommand` (0x8002db04, femenudefs.cpp:2009, map=exact)

- Extra source locals: `dlgThis`, `ptVar3`, `ptVar4`, `pvVar2`, `sVar1`

### `MenuExtended_FinishedPlayer1GetName__FR12tMenuCommand` (0x8002dc04, femenudefs.cpp:2068, map=exact)

- Extra source locals: `dlgThis`, `ptVar1`, `ptVar2`, `ptVar3`, `pvVar5`, `sVar4`

### `MenuExtended_FinishedPlayer2GetName__FR12tMenuCommand` (0x8002dd14, femenudefs.cpp:2119, map=exact)

- Extra source locals: `ptVar1`, `pvVar3`, `sVar2`

### `MenuExtended_AwardPinkSlipsCar__FR12tMenuCommand` (0x8002de74, femenudefs.cpp:2239, map=exact)

- Extra source locals: `dlgThis`, `dlgThis2`, `dlgThis3`, `pcVar5`, `playerNum`, `ptVar1`, `ptVar2`, `ptVar3`, `this_00`

### `MenuExtended_GoToGarage__FR12tMenuCommand` (0x8002e09c, femenudefs.cpp:2331, map=exact)

- Extra source locals: `dlgThis`, `ptVar1`, `this_00`

### `MenuExtended_ExitTourney__FR12tMenuCommand` (0x8002e18c, femenudefs.cpp:2498, map=exact)

- Extra source locals: `dlgThis`, `ptVar1`, `sVar2`

### `MenuExtended_ExitPinkSlipsEarly__FR12tMenuCommand` (0x8002e21c, femenudefs.cpp:2556, map=exact)

- Extra source locals: `dlgThis`, `fmt`, `iVar5`, `msg`, `pcVar4`, `ptVar2`, `sVar3`

### `MenuExtended_PinkSlipsContinue__FR12tMenuCommand` (0x8002e34c, femenudefs.cpp:2619, map=exact)

- Extra source locals: `bVar2`, `ptVar1`

### `__15tGlobalMenuDefs` (0x8002e3b8, femenudefs.cpp:3125, map=exact)
