...
- Declaration-clean mapped functions: 840
- Missing SYM names: 0
- Extra source-local names: 1460
...
- Explicit source-only codegen carriers: 132
...
### `AILife_ReencarnateCopByLatPosAndRotation__FP8Car_tObjiiii` (0x800684d4, ailife.cpp:443, map=exact)
...
### `GetTimedAnimPosRot__10AnimScriptP8coorddefP10matrixtdef` (0x800745f8, anim.cpp:363, map=exact-signature)

- Extra source locals: `iVar1`

### `GetTimedAnimPosRot__10AnimScriptiP8coorddefP10matrixtdef` (0x80074624, anim.cpp:372, map=exact-signature)
...
### `BWorld_InitContexts__Fv` (0x8007e428, bworld.cpp:1055, map=exact)

- Extra source locals: `noClient`

### `BWorld_Init__Fv` (0x8007e5c8, bworld.cpp:1132, map=exact)
...
### `Render_RenderWorld__FP13DRender_tView` (0x800b32b8, render.cpp:140, map=exact)

- Extra source locals: `pvVar1`

### `Render_RenderPauseMenuView__Fv` (0x800b3430, render.cpp:211, map=exact)

- Extra source locals: `iVar1`

### `Render_Render__Fi` (0x800b34a8, render.cpp:236, map=exact)

- Extra source locals: `Player`, `ViewID`

### `StampImage__Fii` (0x800b38a8, render.cpp:385, map=exact)
