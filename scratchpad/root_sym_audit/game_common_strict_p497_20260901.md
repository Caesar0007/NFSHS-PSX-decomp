...
- Declaration-clean mapped functions: 863
- Missing SYM names: 0
- Extra source-local names: 1437
...
- Explicit source-only codegen carriers: 139
...
### `Sort__24AITrigger_TriggerManager` (0x80072e30, aitriger.cpp:281, map=exact)
...
### `Sched_Execute__FP15Sched_tSchedule` (0x800b6500, schedule.cpp:168, map=exact)
...
### `Sim_MainGameLoop__Fv` (0x800b6d4c, sim.cpp:347, map=exact)
