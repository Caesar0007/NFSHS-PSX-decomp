...
- Exact cross-build/canonical name recoveries: 21
- Explicit linkage-proven ABI parameters omitted from SYM: 13
- Explicit source-only codegen carriers: 616
...
### `_._15AIHigh_BasicCop` (0x8005cb4c, aihigh.h:584, map=header-owner)
...
### `Get__26AIDataRecord_CarTracking_ti` (0x8006d50c, aidatarecord.h:297, map=header-owner)

- Storage: SYM STAT vs source EXT

### `_._26AIDataRecord_CarTracking_t` (0x8006d514, aidatarecord.h:307, map=header-owner)

- Storage: SYM STAT vs source EXT

### `_._30AIDataRecord_CurveSpeedTable_t` (0x8006d534, aidatarecord.h:316, map=header-owner)

- Storage: SYM STAT vs source EXT

### `_._25AIDataRecord_TrackCurve_t` (0x8006d554, aidatarecord.h:325, map=header-owner)

- Storage: SYM STAT vs source EXT

### `_._23AIDataRecord_BestLine_t` (0x8006d574, aidatarecord.h:334, map=header-owner)

- Storage: SYM STAT vs source EXT

### `Execute__17AIState_NonActive` (0x80072750, aistate.h:3043, map=header-owner-va-copy)

- Storage: SYM STAT vs source EXT

### `_._17AIState_NonActive` (0x80072758, aistate.h:3064, map=abi-carrier)

- Mapping: explicit verify_asm-PASS deleting-destructor ABI carrier; the source function's `pThis`/`__in_chrg` parameters represent the retail member destructor's implicit ABI parameters.
- Storage: SYM STAT vs source EXT

### `TestForRelease__12AIState_Base` (0x80072830, aistate.h:3146, map=header-owner-va-copy)

- Storage: SYM STAT vs source EXT

### `_._12AIState_Base` (0x80072838, aistate.h:3169, map=abi-carrier)
...
- `Physics_AttenuateVelocity__FP8Car_tObjiP10matrixtdef`: `vy`, `vz`
...
- `AI_HandleShouldersAndOffRoad__FP8Car_tObj`: `sl`
- `AI_CalculateLaneSpeeds__FP8Car_tObj`: `forwardDistanceIntMeters`
...
- `AI_CalculateDesiredLatPosition__FP8Car_tObj`: `blockingCarNearby`, `laneWidth`
- `AI_CalculateAdjustedDesiredSpeed__FP8Car_tObj`: `adjustedSpeed`
...
- `DoProvokedAttack__15AIHigh_Opponent`: `iVar1`, `pCVar3`
...
- `AILife_RCPickSliceAndDirection__FP8Car_tObj`: `basisCar`, `basisCarIndex`
...
- `AIPhysic_SimplePhysics__FP8Car_tObj`: `v`
- `AIPhysic_SimplePhysics_LongVel__FP8Car_tObj`: `t`
- `AIPhysic_GetDesiredVector__FP8Car_tObj`: `t`, `v`
- `AIPhysic_OutOfControlPhysics__FP8Car_tObj`: `cfg`, `latvelcalcLookahead`, `r`
- `AIPhysic_GetRearEndDamageFactor__FP8Car_tObj`: `result`
- `AIPhysic_ChangeDirection__FP8Car_tObji`: `rampPos`, `sg`
- `AIPhysic_CheckForGripReduction__FP8Car_tObj`: `iVar1`, `iVar4`, `pers`
...
- `AudioCmn_SFX__Fi6s_typeT1iii`: `forceAmp`
- `AudioCmn_PlaySFX__Fiiiiii`: `bbase`, `chbase`, `lookup`, `nbase`, `pan`, `pbase`, `pch`, `r`, `slot`
- `AudioCmn_SoundCar__FP8Car_tObjiiiiiii`: `attenuation`, `clampedRoadNoiseAmp`, `currentGas`, `distanceScale`, `gasDelta`, `previousGas`, `rampedGas`, `roadProduct`, `rpmRatio`, `scaledAmplitude`, `tunnelFlag`
...
- `AudioTrk_Reset__Fv`: `neg1`, `pCVar2`, `puVar3`
- `AudioTrk_StartUp__Fv`: `neg1`
...
- `Camera_UpdateSimpleCam__Fi`: `sVar1`
- `Camera_UpdateBumperCam__Fi`: `mode`
- `Camera_UpdateTailCam__Fii`: `armPtr`, `armY`, `ax`, `first`, `flip`, `lookBehindBase`, `mode`, `offset`, `rev`, `second`, `slices`, `z`
- `Camera_UpdateHeliCam__Fii`: `armY`, `ax`, `mode`, `rev`, `second`, `z`
- `SetCameraZoom__Fii`: `gs`
- `Camera_UpdateTVCam__Fi`: `clampedHeight`, `lastIndex`
- `Camera_UpdateAnimCam__Fi`: `cVar1`, `cVar4`
- `Camera_UpdateBlimpCam__Fi`: `mode`
- `Camera_SetSplineCam__Fi`: `cameraDirection`, `slice`, `sliceStep`
...
- `Camera_NextMode__Fi`: `modeForRange`, `setupBase`, `setupOffset`, `splitBase`
...
- `Collide_TestWithPlane__FP13BO_tNewtonObjP8coorddefT1`: `relDotFull`
...
- `CopSpeak_PlayNextRequest__Fv`: `iVar3`, `next`
...
- `MPause_MusicLogic__Fc`: `bVar1`, `iVar3`
- `MPause_ControllerLogic__Fv`: `item`
- `MPause_Logic__Fv`: `newItem`, `oldItem`
- `MPause_EndPauseMenu__Fv`: `deviceSetup`
...
- `Newton_ApplyTheLawOfGravity__FP13BO_tNewtonObj`: `maxImpulse`
...
- `PauseMenu_MenuText__FsbT1`: `iVar1`
...
- `Physics_AttenuateVelocity__FP8Car_tObjiP10matrixtdef`: `x`
...
- `Physics_CalculateTireForces__FP8Car_tObjP23Physics_tWheelAccStruct`: `a`, `cap`, `minSlipAngle`, `xAcc`
- `Physics_CalculateRSControlDesiredPosition__FP8Car_tObjii`: `laneDelta`
- `Physics_Real__FP8Car_tObj`: `adjustedRpm`, `brakeCap`, `brakeLevel`, `fz`, `gasLevel`, `limitedBrakeAcc`, `lm`, `rsControl`, `sumZ`, `wheelMult`
...
- `Replay_StoringControllerData__FG15tControllerData`: `packedPtr`, `replayBuffer`, `source`
- `Replay_GetInput__Fi`: `counter`, `hasCameras`, `steering`
- `Sched_ExecuteCheck__FiiiiPiN24i`: `distanceTemp`
