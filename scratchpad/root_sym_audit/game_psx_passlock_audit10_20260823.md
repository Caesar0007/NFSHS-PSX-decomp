...
- Declaration-clean mapped functions: 303
- Missing SYM names: 0
- Extra source-local names: 709
...
- Explicit source-only codegen carriers: 131
...
### `Hud_BuildReplay__Fv` (0x800d7250, hud.cpp:4544, map=exact)

- Extra source locals: `pal`, `palL`, `tSs1`, `tSs1_2`, `tSs1_3`

### `Hud_NextPlayer__Fi` (0x800d754c, hud.cpp:4691, map=exact)

- Extra source locals: `carObj_00`, `iVar1`, `iVar4`, `uVar3`, `uVar5`

### `Hud_NextPlayerNameOrCarOrTime__Fi` (0x800d76b0, hud.cpp:4782, map=exact)

- Extra source locals: `carObj_00`, `iVar1`, `iVar2`, `iVar3`, `uVar4`

### `Hud_BlackThinBox__Fiiii` (0x800d7abc, hud.cpp:4936, map=exact)

- Extra source locals: `CORNERWIDTH`, `side_h`, `side_y`, `top_w`, `x_left`, `x_right`, `y_bottom`

### `Hud_Draw321Num__Fiiiiii` (0x800d7ca8, hud.cpp:4966, map=exact)

- Extra source locals: `arg4`, `arg5`, `by2`

### `Hud_Render321Go__Fv` (0x800d7e64, hud.cpp:5174, map=exact)

- Extra source locals: `flare_intensity_00`, `num_00`, `uVar1`, `y_00`

### `Hud_RenderHudView__Fv` (0x800d82d0, hud.cpp:5376, map=exact)

- Extra source locals: `cdshow`, `otmask`, `pal`, `pw`, `tagp`, `tpageOff`, `viewOff`, `viewp`, `ww2p1`

### `Hud_RenderTacView__Fv` (0x800d8c48, hud.cpp:5884, map=exact)

- Extra source locals: `dh`, `j4`, `pal`, `tp`

### `Hud_ParseTime__FiPc` (0x800d8d64, hud.cpp:5939, map=exact)

- Extra source locals: `centi_total`, `iVar1`, `min`, `sec`

### `Hud_Render__Fv` (0x800d9058, hud.cpp:5999, map=exact)

- Extra source locals: `iface`, `j`, `remain`

### `Hud_BustedOverlayOn__FiPcbs` (0x800d962c, hud.cpp:6180, map=exact)

- Extra source locals: `iVar2`, `iVar4`, `pcVar1`, `psVar3`

### `Hud_BTC_QuitOut__Fv` (0x800d9848, hud.cpp:6288, map=exact)
...
### `Night_SetWeatherColors__Fi` (0x800dbad4, night.cpp:984, map=exact)

- Extra source locals: `colorH`, `color_walk`, `wtbl`, `wtblp`

### `Night_SetEnviroment__FP13DRender_tView` (0x800dc0a8, night.cpp:1399, map=exact)
