...
- Declaration-clean mapped functions: 325
- Missing SYM names: 0
- Extra source-local names: 643
...
- Explicit source-only codegen carriers: 160
...
### `DrawW_DoLines__FP13DRender_tViewP11tBuildEntryP11Draw_DCache` (0x800ca204, draww.cpp:6621, map=exact)

- Extra source locals: `bVar1`, `m`, `m2`, `posX`, `posY`, `posZ`, `tx`, `ty`, `tz`

### `DrawW_BuildSpikeBelt__FP13DRender_tViewiP11Draw_DCache` (0x800ca520, draww.cpp:6801, map=exact)
...
### `Flare_TextureQuad__FPlP7CVECTORci` (0x800ce61c, flare.cpp:1683, map=exact)

- Extra source locals: `color_word`, `pkt_addr24`, `shape_p`

### `Flare_SingleColorOct__FP7DVECTORP7CVECTORiii` (0x800ce8b0, flare.cpp:1768, map=exact)

- Extra source locals: `iVar1`, `iVar4`, `pDVar3`, `pSVar2`

### `Flare_LensFlare__FP7DVECTORP15Draw_FlareCache` (0x800ceb6c, flare.cpp:1866, map=exact)

- Extra source locals: `addr24_0`, `colw`, `cp`, `otSize`, `otz`, `pkt24`, `pp`, `slot`, `vx0`, `vy0`

### `Flare_Sun__FP7SVECTORP15Draw_FlareCache` (0x800cf1d0, flare.cpp:2294, map=exact)
...
### `Hud_BustedOverlayOn__FiPcbs` (0x800d962c, hud.cpp:6137, map=exact)

- Extra source locals: `iVar2`, `iVar4`, `pcVar1`, `psVar3`

### `Hud_BTC_QuitOut__Fv` (0x800d9848, hud.cpp:6245, map=exact)

- Extra source locals: `name_tail`, `perp_idx`, `row_base`, `row_off`, `slot_i`

### `Hud_Perp_OverlayOff__Fi` (0x800d9950, hud.cpp:6288, map=exact)
