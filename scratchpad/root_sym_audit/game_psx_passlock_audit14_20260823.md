...
- Declaration-clean mapped functions: 329
- Missing SYM names: 0
- Extra source-local names: 626
...
### `DrawC_PrimClip__FP10matrixtdefP8coorddefP16Transformer_zObjP20Transformer_zOverlayiP13Draw_CarCache` (0x800c155c, drawc.cpp:3292, map=exact)
...
### `DrawC_DivideShadowPrim__FP7COORD16N30PUsN34P12Draw_tPixMapP13Draw_CarCache` (0x800c40dc, drawc.cpp:5260, map=exact)
