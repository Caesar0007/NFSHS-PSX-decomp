...
- Declaration-clean mapped functions: 355
- Missing SYM names: 0
- Extra source-local names: 501
...
- Explicit source-only codegen carriers: 198
...
### `Hud_RenderHudView__Fv` (0x800d82d0, hud.cpp:5335, map=exact)
...
### `Hud_Perp_OverlayOff__Fi` (0x800d9950, hud.cpp:6317, map=exact)
