...
- Declaration-clean mapped functions: 357
- Missing SYM names: 0
- Extra source-local names: 489
...
- Explicit source-only codegen carriers: 204
...
- Missing/extra global definitions: 0/61
...
### `DrawW_BuildCustomObjectFacets__FP13DRender_tViewP11Draw_DCacheP13Trk_SimObjectP5Groupi` (0x800c7b9c, draww.cpp:3617, map=exact)

- Extra source locals: `bVar7`, `buildResult`, `g`, `instData_p`, `objDef_p`, `pOVar5`, `t3`, `tc5`, `transMat`, `zo`

### `DrawObjectTransform__FP13DRender_tViewP11Draw_DCacheP10matrixtdefP13Trk_ObjectDefP8coorddefis` (0x800c7ebc, draww.cpp:4167, map=exact)

- Extra source locals: `drawResult`, `isCullable`, `m`, `mat_local`, `posX`, `posY`, `posZ`, `shapeDef_p`, `tX`, `tY`, `tZ`

### `DrawObjectSimple__FP13DRender_tViewP11Draw_DCacheP13Trk_ObjectDefP8coorddefi` (0x800c8214, draww.cpp:4293, map=exact)

- Extra source locals: `drawResult`, `isCullable`, `m`, `posX`, `posY`, `posZ`, `shapeDef_p`, `tX`, `tY`, `tZ`

### `Draw_kCtrlSkidmark__FP18Draw_tCtrlSkidmark` (0x800c909c, draww.cpp:5309, map=exact)
...
### `DrawW_DoLines__FP13DRender_tViewP11tBuildEntryP11Draw_DCache` (0x800ca204, draww.cpp:6733, map=exact)

- Extra source locals: `bVar1`, `m`, `m2`, `posX`, `posY`, `posZ`, `tx`, `ty`, `tz`

### `DrawW_BuildSpikeBelt__FP13DRender_tViewiP11Draw_DCache` (0x800ca520, draww.cpp:6913, map=exact)

- Extra source locals: `dof`, `p`, `q`, `sdG`, `so`, `vt`

### `Flare_CarShapedHalo__FiP7COORD16N21siP15Draw_FlareCache` (0x800ccb58, flare.cpp:653, map=exact)

- Extra source locals: `addr24_0`, `c`, `dtd`, `i`, `j`, `pkt24`, `slot`

### `Flare_Halo2__FP13DRender_tViewiiP8coorddefT3P15Draw_FlareCache` (0x800cd530, flare.cpp:909, map=exact)

- Extra source locals: `addr24_0`, `addr24_1`, `c`, `dtd`, `pkt24`, `sd`, `slot`

### `Flare_LensFlare__FP7DVECTORP15Draw_FlareCache` (0x800ceb6c, flare.cpp:1795, map=exact)
...
### `Hrz_BuildHorizon__FP13DRender_tView` (0x800d131c, hrzsku.cpp:2386, map=exact)
...
### `Hud_BuildGT4__FP8POLY_GT4P13HudPmx_tShapeiiUl` (0x800d2288, hud.cpp:429, map=exact)

- Extra source locals: `tpage_clut`, `tu2`, `uVar1`, `uVar2`, `uVar3`, `uv23_pack`, `w_h_pack`

### `Hud_BuildFT4__FP8POLY_FT4P13HudPmx_tShapeiiUli` (0x800d2334, hud.cpp:457, map=exact)

- Extra source locals: `tu2`, `tu3`, `tu4`, `tu5`, `uVar1`, `uVar2`, `uVar3`

### `Hud_BuildMirrorFT4__FP8POLY_FT4P13HudPmx_tShapeiiUli` (0x800d2424, hud.cpp:483, map=exact)

- Extra source locals: `tu2`, `tu3`, `tu4`, `tu5`, `uVar1`, `uVar2`, `uVar3`, `uVar4`

### `Hud_BuildMapMirrorFT4__FP8POLY_FT4P13HudPmx_tShapeiiUli` (0x800d2528, hud.cpp:512, map=exact)

- Extra source locals: `tu2`, `tu3`, `uVar1`, `uVar2`, `uVar3`, `uVar4`

### `Hud_BuildTimeSprites__FP4SPRTPcii` (0x800d2ef8, hud.cpp:880, map=exact)

- Extra source locals: `bVar3`, `bVar4`, `bVar5`, `cVar2`, `n`, `pcVar6`, `uVar7`

### `Hud_BuildTach__Fi` (0x800d3e94, hud.cpp:1685, map=exact)

- Extra source locals: `clutx`, `pal`, `pal2`, `tachNeedle_p`, `tp3`, `tp9`, `ts1`, `ts3`, `ts4`

### `Hud_BuildNumbers0__Fi` (0x800d4624, hud.cpp:2247, map=exact)

- Extra source locals: `eSprt`, `etime`, `last`, `p`, `pal_2`, `primAddr`, `y_2`

### `Hud_BuildNumbers__Fi` (0x800d4e70, hud.cpp:2798, map=exact)

- Extra source locals: `pal`, `pal_2`, `pal_3`, `xt`

### `Hud_BuildMapMarkers__Fi` (0x800d5ae8, hud.cpp:3283, map=exact)

- Extra source locals: `aiflags`, `car`, `cflags`, `mapx`, `pal`, `pktcell`

### `Hud_BuildWingmanInterface__Fi` (0x800d606c, hud.cpp:3577, map=exact)

- Extra source locals: `fc`, `iconRow`, `now`, `pal`, `two`, `xf`

### `Hud_BuildCdPlayer__Fii` (0x800d63dc, hud.cpp:3883, map=exact)

- Extra source locals: `arg1`, `bVar2`, `dxk`, `i`, `lt`, `lt4`, `scz`, `uVar5`, `wordId`

### `Hud_RenderHudView__Fv` (0x800d82d0, hud.cpp:5327, map=exact)

- Extra source locals: `cdshow`, `otmask`, `pal`, `pw`, `tagp`, `tpageOff`, `viewOff`, `viewp`, `ww2p1`

### `Hud_RenderTacView__Fv` (0x800d8c48, hud.cpp:5877, map=exact)

- Extra source locals: `dh`, `j4`, `pal`, `tp`

### `Hud_Perp_OverlayOff__Fi` (0x800d9950, hud.cpp:6309, map=exact)
...
### `RaceStatistics__Fv` (0x800d9fbc, overlays.cpp:459, map=exact)

- Extra source locals: `barH`, `barH8`, `colInset`, `colX`, `halfH`, `nh`, `one`, `pitch`, `posy`, `posyL`, `rowInset`, `sizeH16`, `titleX`, `titleY`
