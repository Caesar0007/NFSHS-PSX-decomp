...
- Declaration-clean mapped functions: 361
- Missing SYM names: 0
- Extra source-local names: 461
...
### `Hud_BuildTimeSprites__FP4SPRTPcii` (0x800d2ef8, hud.cpp:848, map=exact)

- Extra source locals: `bVar3`, `bVar4`, `bVar5`, `cVar2`, `n`, `pcVar6`, `uVar7`

### `Hud_BuildTach__Fi` (0x800d3e94, hud.cpp:1653, map=exact)

- Extra source locals: `clutx`, `pal`, `pal2`, `tachNeedle_p`, `tp3`, `tp9`, `ts1`, `ts3`, `ts4`

### `Hud_BuildNumbers0__Fi` (0x800d4624, hud.cpp:2215, map=exact)

- Extra source locals: `eSprt`, `etime`, `last`, `p`, `pal_2`, `primAddr`, `y_2`

### `Hud_BuildNumbers__Fi` (0x800d4e70, hud.cpp:2766, map=exact)

- Extra source locals: `pal`, `pal_2`, `pal_3`, `xt`

### `Hud_BuildMapMarkers__Fi` (0x800d5ae8, hud.cpp:3251, map=exact)

- Extra source locals: `aiflags`, `car`, `cflags`, `mapx`, `pal`, `pktcell`

### `Hud_BuildWingmanInterface__Fi` (0x800d606c, hud.cpp:3545, map=exact)

- Extra source locals: `fc`, `iconRow`, `now`, `pal`, `two`, `xf`

### `Hud_BuildCdPlayer__Fii` (0x800d63dc, hud.cpp:3851, map=exact)

- Extra source locals: `arg1`, `bVar2`, `dxk`, `i`, `lt`, `lt4`, `scz`, `uVar5`, `wordId`

### `Hud_RenderHudView__Fv` (0x800d82d0, hud.cpp:5295, map=exact)
...
### `Hud_Perp_OverlayOff__Fi` (0x800d9950, hud.cpp:6277, map=exact)
