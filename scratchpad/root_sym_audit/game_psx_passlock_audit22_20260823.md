...
- Declaration-clean mapped functions: 364
- Missing SYM names: 0
- Extra source-local names: 442
...
- Explicit source-only codegen carriers: 211
...
### `Flare_LensFlare__FP7DVECTORP15Draw_FlareCache` (0x800ceb6c, flare.cpp:1780, map=exact)
...
### `Hud_BuildTach__Fi` (0x800d3e94, hud.cpp:1647, map=exact)

- Extra source locals: `clutx`, `pal`, `pal2`, `tachNeedle_p`, `tp3`, `tp9`, `ts1`, `ts3`, `ts4`

### `Hud_BuildNumbers0__Fi` (0x800d4624, hud.cpp:2209, map=exact)

- Extra source locals: `eSprt`, `etime`, `last`, `p`, `pal_2`, `primAddr`, `y_2`

### `Hud_BuildNumbers__Fi` (0x800d4e70, hud.cpp:2805, map=exact)

- Extra source locals: `m2`, `pal`, `pal_2`, `pal_3`, `xm1`, `xt`

### `Hud_BuildMapMarkers__Fi` (0x800d5ae8, hud.cpp:3296, map=exact)

- Extra source locals: `aiflags`, `car`, `cflags`, `mapx`, `pal`, `pktcell`

### `Hud_BuildWingmanInterface__Fi` (0x800d606c, hud.cpp:3590, map=exact)

- Extra source locals: `fc`, `iconRow`, `now`, `pal`, `two`, `xf`

### `Hud_BuildCdPlayer__Fii` (0x800d63dc, hud.cpp:3896, map=exact)

- Extra source locals: `arg1`, `bVar2`, `dxk`, `i`, `lt`, `lt4`, `scz`, `uVar5`, `wordId`

### `Hud_RenderHudView__Fv` (0x800d82d0, hud.cpp:5340, map=exact)

- Extra source locals: `cdshow`, `otmask`, `pal`, `pw`, `tagp`, `tpageOff`, `viewOff`, `viewp`, `ww2p1`

### `Hud_RenderTacView__Fv` (0x800d8c48, hud.cpp:5890, map=exact)

- Extra source locals: `dh`, `j4`, `pal`, `tp`

### `Hud_Perp_OverlayOff__Fi` (0x800d9950, hud.cpp:6322, map=exact)
