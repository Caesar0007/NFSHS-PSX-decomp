...
- Declaration-clean mapped functions: 370
- Missing SYM names: 0
- Extra source-local names: 396
...
- Explicit source-only codegen carriers: 240
...
### `Hrz_BuildSky__Fv` (0x800d0a38, hrzsku.cpp:1369, map=exact)

- Extra source locals: `c0`, `hpb`, `slot`, `tag`

### `Hrz_BuildHorizon__FP13DRender_tView` (0x800d131c, hrzsku.cpp:2363, map=exact)
