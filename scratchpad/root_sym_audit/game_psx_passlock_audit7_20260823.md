...
- Declaration-clean mapped functions: 276
- Missing SYM names: 0
- Extra source-local names: 755
...
- Explicit source-only codegen carriers: 102
...
### `Night_NightCalc__FP6VECTORPsP25Draw_tGiveShelbyMoreCache` (0x800c5fb8, draww.cpp:1228, map=exact)

- Extra source locals: `lt`

### `DrawW_DrawQuad__FP25Draw_tGiveShelbyMoreCacheP8Trk_Quad` (0x800c64f8, draww.cpp:1453, map=exact)
...
### `DrawW_StripDraw_High__FP25Draw_tGiveShelbyMoreCache` (0x800c6eb8, draww.cpp:2251, map=exact)

- Extra source locals: `bVar1`, `pMaterial`, `pTVar4`, `sVar2`

### `DrawW_DoTrough__FP13DRender_tViewP11tBuildEntry` (0x800c6fa0, draww.cpp:2321, map=exact)
...
### `DrawW_WorldSetUpTranslation__FP8coorddefP6MATRIX` (0x800c75d8, draww.cpp:2931, map=exact)

- Extra source locals: `iVar1`, `iVar2`

### `DrawW_GetAnimationTime__FP15Trk_AnimateInst` (0x800c7644, draww.cpp:2965, map=exact)

- Extra source locals: `iVar2`, `tick`

### `DrawW_DoObjectAnimations__Fv` (0x800c7808, draww.cpp:3078, map=exact)

- Extra source locals: `iVar2`, `ppTVar1`, `table`, `time_00`

### `DrawW_BuildObjectFacets__FP13DRender_tViewP15ChunkObjectInfo` (0x800c78a8, draww.cpp:3113, map=exact)

- Extra source locals: `animType`, `clipRes`, `distSq`, `g`, `zo`

### `DrawW_BuildCustomObjectFacets__FP13DRender_tViewP11Draw_DCacheP13Trk_SimObjectP5Groupi` (0x800c7b9c, draww.cpp:3576, map=exact)

- Extra source locals: `bVar7`, `buildResult`, `g`, `instData_p`, `objDef_p`, `pOVar5`, `t3`, `tc5`, `transMat`, `zo`

### `DrawObjectTransform__FP13DRender_tViewP11Draw_DCacheP10matrixtdefP13Trk_ObjectDefP8coorddefis` (0x800c7ebc, draww.cpp:4126, map=exact)

- Extra source locals: `drawResult`, `isCullable`, `m`, `mat_local`, `posX`, `posY`, `posZ`, `shapeDef_p`, `tX`, `tY`, `tZ`

### `DrawObjectSimple__FP13DRender_tViewP11Draw_DCacheP13Trk_ObjectDefP8coorddefi` (0x800c8214, draww.cpp:4252, map=exact)

- Extra source locals: `drawResult`, `isCullable`, `m`, `posX`, `posY`, `posZ`, `shapeDef_p`, `tX`, `tY`, `tZ`

### `DrawW_BuildChunkObjectFacets__FP13DRender_tViewP15ChunkObjectInfo` (0x800c8508, draww.cpp:4414, map=exact)

- Extra source locals: `anim`, `t3`

### `ObjectClipped__FP13DRender_tViewiP8coorddefP25Draw_tGiveShelbyMoreCache` (0x800c8bd0, draww.cpp:4849, map=exact)

- Extra source locals: `iVar1`, `iVar2`, `pvVar3`

### `Draw_CircleClip__FP8coorddefT0i` (0x800c903c, draww.cpp:5236, map=exact)

- Extra source locals: `iVar1`, `iVar2`

### `Draw_kCtrlSkidmark__FP18Draw_tCtrlSkidmark` (0x800c909c, draww.cpp:5275, map=exact)
...
### `DrawW_SetUpSubdividFacet_Line__FP25Draw_tGiveShelbyMoreCache` (0x800c9620, draww.cpp:6062, map=exact)

- Extra source locals: `cw_a`, `cw_b`, `ts2`, `ts4`, `ts6`

### `DrawW_BuildChunkCenterLineFacets__FP5ChunkP5GroupP25Draw_tGiveShelbyMoreCacheP7COORD16` (0x800ca0a4, draww.cpp:6532, map=exact)

- Extra source locals: `bVar10`, `curLine`, `rn`

### `DrawW_DoLines__FP13DRender_tViewP11tBuildEntryP11Draw_DCache` (0x800ca204, draww.cpp:6639, map=exact)

- Extra source locals: `bVar1`, `m`, `m2`, `posX`, `posY`, `posZ`, `tx`, `ty`, `tz`

### `DrawW_BuildSpikeBelt__FP13DRender_tViewiP11Draw_DCache` (0x800ca520, draww.cpp:6819, map=exact)
...
### `Hud_BuildTimeSprites__FP4SPRTPcii` (0x800d2ef8, hud.cpp:933, map=exact)

- Extra source locals: `bVar3`, `bVar4`, `bVar5`, `cVar2`, `n`, `pcVar6`, `uVar7`

### `Hud_Init__Fv` (0x800d302c, hud.cpp:1047, map=exact)

- Extra source locals: `syc`, `sye`

### `Hud_InitTables__Fv` (0x800d39ec, hud.cpp:1289, map=exact)

- Extra source locals: `patVar1`

### `Hud_BuildTach__Fi` (0x800d3e94, hud.cpp:1722, map=exact)

- Extra source locals: `clutx`, `pal`, `pal2`, `tachNeedle_p`, `tp3`, `tp9`, `ts1`, `ts3`, `ts4`

### `Hud_BuildString__FPciiiib` (0x800d42c8, hud.cpp:1969, map=exact)

- Extra source locals: `as`, `iw1`, `iw2`, `iw3`, `iw4`, `iw5`

### `Hud_BuildNumbers0__Fi` (0x800d4624, hud.cpp:2284, map=exact)

- Extra source locals: `eSprt`, `etime`, `last`, `p`, `pal`, `pal_2`, `primAddr`, `y_2`

### `Hud_BuildNumbers__Fi` (0x800d4e70, hud.cpp:2835, map=exact)

- Extra source locals: `pal`, `pal_2`, `pal_3`, `xt`

### `Hud_InitMap__Fv` (0x800d5a48, hud.cpp:3088, map=exact)

- Extra source locals: `iVar4`

### `Hud_BuildMapMarkers__Fi` (0x800d5ae8, hud.cpp:3318, map=exact)

- Extra source locals: `aiflags`, `car`, `cflags`, `mapx`, `pal`, `pktcell`

### `Hud_BuildWingmanInterface__Fi` (0x800d606c, hud.cpp:3612, map=exact)

- Extra source locals: `fc`, `iconRow`, `now`, `pal`, `two`, `xf`

### `Hud_BuildCdPlayer__Fii` (0x800d63dc, hud.cpp:3918, map=exact)

- Extra source locals: `arg1`, `bVar2`, `dxk`, `i`, `lt`, `lt4`, `scz`, `uVar5`, `wordId`

### `Hud_BuildRadar__Fi` (0x800d6b48, hud.cpp:4329, map=exact)

- Extra source locals: `pal`, `tag`

### `Hud_BuildReplay__Fv` (0x800d7250, hud.cpp:4546, map=exact)

- Extra source locals: `pal`, `palL`, `tSs1`, `tSs1_2`, `tSs1_3`

### `Hud_NextPlayer__Fi` (0x800d754c, hud.cpp:4693, map=exact)

- Extra source locals: `carObj_00`, `iVar1`, `iVar4`, `uVar3`, `uVar5`

### `Hud_NextPlayerNameOrCarOrTime__Fi` (0x800d76b0, hud.cpp:4784, map=exact)

- Extra source locals: `carObj_00`, `iVar1`, `iVar2`, `iVar3`, `uVar4`

### `Hud_RenderMapView__Fv` (0x800d7838, hud.cpp:4855, map=exact)

- Extra source locals: `pal`, `tp`

### `Hud_BlackThinBox__Fiiii` (0x800d7abc, hud.cpp:4938, map=exact)

- Extra source locals: `CORNERWIDTH`, `side_h`, `side_y`, `top_w`, `x_left`, `x_right`, `y_bottom`

### `Hud_Draw321Num__Fiiiiii` (0x800d7ca8, hud.cpp:4968, map=exact)

- Extra source locals: `arg4`, `arg5`, `by2`

### `Hud_Render321Go__Fv` (0x800d7e64, hud.cpp:5176, map=exact)

- Extra source locals: `flare_intensity_00`, `num_00`, `uVar1`, `y_00`

### `Hud_RenderHudView__Fv` (0x800d82d0, hud.cpp:5378, map=exact)

- Extra source locals: `cdshow`, `otmask`, `pal`, `pw`, `tagp`, `tpageOff`, `viewOff`, `viewp`, `ww2p1`

### `Hud_RenderTacView__Fv` (0x800d8c48, hud.cpp:5886, map=exact)

- Extra source locals: `dh`, `j4`, `pal`, `tp`

### `Hud_ParseTime__FiPc` (0x800d8d64, hud.cpp:5941, map=exact)

- Extra source locals: `centi_total`, `iVar1`, `min`, `sec`

### `Hud_Render__Fv` (0x800d9058, hud.cpp:6001, map=exact)

- Extra source locals: `iface`, `j`, `remain`

### `Hud_PositionMap__Fv` (0x800d94c0, hud.cpp:6154, map=exact)

- Extra source locals: `track`

### `Hud_BustedOverlayOn__FiPcbs` (0x800d962c, hud.cpp:6184, map=exact)

- Extra source locals: `iVar2`, `iVar4`, `pcVar1`, `psVar3`

### `Hud_Reset__Fv` (0x800d97f0, hud.cpp:6266, map=exact)

- Extra source locals: `iVar2`, `psVar1`

### `Hud_BTC_QuitOut__Fv` (0x800d9848, hud.cpp:6294, map=exact)

- Extra source locals: `name_tail`, `perp_idx`, `row_base`, `row_off`, `slot_i`

### `Hud_Perp_OverlayOff__Fi` (0x800d9950, hud.cpp:6337, map=exact)
