...
- Declaration-clean mapped functions: 286
- Missing SYM names: 0
- Extra source-local names: 741
...
- Explicit source-only codegen carriers: 109
...
### `DrawW_DoObjectAnimations__Fv` (0x800c7808, draww.cpp:3076, map=exact)

- Extra source locals: `iVar2`, `ppTVar1`, `table`, `time_00`

### `DrawW_BuildObjectFacets__FP13DRender_tViewP15ChunkObjectInfo` (0x800c78a8, draww.cpp:3111, map=exact)

- Extra source locals: `animType`, `clipRes`, `distSq`, `g`, `zo`

### `DrawW_BuildCustomObjectFacets__FP13DRender_tViewP11Draw_DCacheP13Trk_SimObjectP5Groupi` (0x800c7b9c, draww.cpp:3574, map=exact)

- Extra source locals: `bVar7`, `buildResult`, `g`, `instData_p`, `objDef_p`, `pOVar5`, `t3`, `tc5`, `transMat`, `zo`

### `DrawObjectTransform__FP13DRender_tViewP11Draw_DCacheP10matrixtdefP13Trk_ObjectDefP8coorddefis` (0x800c7ebc, draww.cpp:4124, map=exact)

- Extra source locals: `drawResult`, `isCullable`, `m`, `mat_local`, `posX`, `posY`, `posZ`, `shapeDef_p`, `tX`, `tY`, `tZ`

### `DrawObjectSimple__FP13DRender_tViewP11Draw_DCacheP13Trk_ObjectDefP8coorddefi` (0x800c8214, draww.cpp:4250, map=exact)

- Extra source locals: `drawResult`, `isCullable`, `m`, `posX`, `posY`, `posZ`, `shapeDef_p`, `tX`, `tY`, `tZ`

### `DrawW_BuildChunkObjectFacets__FP13DRender_tViewP15ChunkObjectInfo` (0x800c8508, draww.cpp:4412, map=exact)

- Extra source locals: `anim`, `t3`

### `ObjectClipped__FP13DRender_tViewiP8coorddefP25Draw_tGiveShelbyMoreCache` (0x800c8bd0, draww.cpp:4847, map=exact)

- Extra source locals: `iVar1`, `iVar2`, `pvVar3`

### `Draw_kCtrlSkidmark__FP18Draw_tCtrlSkidmark` (0x800c909c, draww.cpp:5270, map=exact)
...
### `DrawW_SetUpSubdividFacet_Line__FP25Draw_tGiveShelbyMoreCache` (0x800c9620, draww.cpp:6057, map=exact)

- Extra source locals: `cw_a`, `cw_b`, `ts2`, `ts4`, `ts6`

### `DrawW_BuildChunkCenterLineFacets__FP5ChunkP5GroupP25Draw_tGiveShelbyMoreCacheP7COORD16` (0x800ca0a4, draww.cpp:6527, map=exact)

- Extra source locals: `bVar10`, `curLine`, `rn`

### `DrawW_DoLines__FP13DRender_tViewP11tBuildEntryP11Draw_DCache` (0x800ca204, draww.cpp:6634, map=exact)

- Extra source locals: `bVar1`, `m`, `m2`, `posX`, `posY`, `posZ`, `tx`, `ty`, `tz`

### `DrawW_BuildSpikeBelt__FP13DRender_tViewiP11Draw_DCache` (0x800ca520, draww.cpp:6814, map=exact)
...
### `Hud_FBuildF4__FiiiiiUlcc` (0x800d2984, hud.cpp:682, map=exact)
