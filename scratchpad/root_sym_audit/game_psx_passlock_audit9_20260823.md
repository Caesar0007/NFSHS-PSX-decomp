...
- Declaration-clean mapped functions: 292
- Missing SYM names: 0
- Extra source-local names: 731
...
- Explicit source-only codegen carriers: 117
...
### `DrawC_DivideShadowPrim__FP7COORD16N30PUsN34P12Draw_tPixMapP13Draw_CarCache` (0x800c40dc, drawc.cpp:5256, map=exact)

- Extra source locals: `iVar4`, `mhi`, `mlo`, `puVar6`, `puVar7`, `uVar1`, `uVar2`, `uVar3`, `uVar5`

### `DrawC_ShadowPrimClip__FP12Draw_tVertexP13Draw_CarCache` (0x800c42c4, drawc.cpp:5351, map=exact)

- Extra source locals: `u2`, `vt2`

### `DrawC_SpotPrims__FP10matrixtdefP8coorddefP13Draw_CarCache` (0x800c4800, drawc.cpp:5478, map=exact)

- Extra source locals: `color`, `pDVar7`, `puVar8`

### `DrawC_ShowroomPrims__FP10matrixtdefP8coorddefP13Draw_CarCache` (0x800c4b84, drawc.cpp:5608, map=exact)
...
### `DrawW_DrawQuad__FP25Draw_tGiveShelbyMoreCacheP8Trk_Quad` (0x800c64f8, draww.cpp:1452, map=exact)
...
### `DrawW_StripDraw_High__FP25Draw_tGiveShelbyMoreCache` (0x800c6eb8, draww.cpp:2250, map=exact)

- Extra source locals: `bVar1`, `pMaterial`, `pTVar4`, `sVar2`

### `DrawW_DoTrough__FP13DRender_tViewP11tBuildEntry` (0x800c6fa0, draww.cpp:2320, map=exact)
...
### `DrawW_DoObjectAnimations__Fv` (0x800c7808, draww.cpp:3075, map=exact)

- Extra source locals: `iVar2`, `ppTVar1`, `table`, `time_00`

### `DrawW_BuildObjectFacets__FP13DRender_tViewP15ChunkObjectInfo` (0x800c78a8, draww.cpp:3110, map=exact)

- Extra source locals: `animType`, `clipRes`, `distSq`, `g`, `zo`

### `DrawW_BuildCustomObjectFacets__FP13DRender_tViewP11Draw_DCacheP13Trk_SimObjectP5Groupi` (0x800c7b9c, draww.cpp:3573, map=exact)

- Extra source locals: `bVar7`, `buildResult`, `g`, `instData_p`, `objDef_p`, `pOVar5`, `t3`, `tc5`, `transMat`, `zo`

### `DrawObjectTransform__FP13DRender_tViewP11Draw_DCacheP10matrixtdefP13Trk_ObjectDefP8coorddefis` (0x800c7ebc, draww.cpp:4123, map=exact)

- Extra source locals: `drawResult`, `isCullable`, `m`, `mat_local`, `posX`, `posY`, `posZ`, `shapeDef_p`, `tX`, `tY`, `tZ`

### `DrawObjectSimple__FP13DRender_tViewP11Draw_DCacheP13Trk_ObjectDefP8coorddefi` (0x800c8214, draww.cpp:4249, map=exact)

- Extra source locals: `drawResult`, `isCullable`, `m`, `posX`, `posY`, `posZ`, `shapeDef_p`, `tX`, `tY`, `tZ`

### `DrawW_BuildChunkObjectFacets__FP13DRender_tViewP15ChunkObjectInfo` (0x800c8508, draww.cpp:4411, map=exact)

- Extra source locals: `anim`, `t3`

### `ObjectClipped__FP13DRender_tViewiP8coorddefP25Draw_tGiveShelbyMoreCache` (0x800c8bd0, draww.cpp:4846, map=exact)

- Extra source locals: `iVar1`, `iVar2`, `pvVar3`

### `Draw_kCtrlSkidmark__FP18Draw_tCtrlSkidmark` (0x800c909c, draww.cpp:5269, map=exact)
...
### `DrawW_SetUpSubdividFacet_Line__FP25Draw_tGiveShelbyMoreCache` (0x800c9620, draww.cpp:6056, map=exact)

- Extra source locals: `cw_a`, `cw_b`, `ts2`, `ts4`, `ts6`

### `DrawW_BuildChunkCenterLineFacets__FP5ChunkP5GroupP25Draw_tGiveShelbyMoreCacheP7COORD16` (0x800ca0a4, draww.cpp:6526, map=exact)

- Extra source locals: `bVar10`, `curLine`, `rn`

### `DrawW_DoLines__FP13DRender_tViewP11tBuildEntryP11Draw_DCache` (0x800ca204, draww.cpp:6633, map=exact)

- Extra source locals: `bVar1`, `m`, `m2`, `posX`, `posY`, `posZ`, `tx`, `ty`, `tz`

### `DrawW_BuildSpikeBelt__FP13DRender_tViewiP11Draw_DCache` (0x800ca520, draww.cpp:6813, map=exact)
...
### `Hrz_SetDitheringPrim__Fii` (0x800d09b0, hrzsku.cpp:1326, map=exact)

- Extra source locals: `prev_pkt_slot`, `prev_val`

### `Hrz_BuildSky__Fv` (0x800d0a38, hrzsku.cpp:1389, map=exact)

- Extra source locals: `c0`, `hpb`, `slot`, `tag`

### `Sky_RenderStars__FP13Draw_SkyCachei` (0x800d1160, hrzsku.cpp:1891, map=exact)

- Extra source locals: `pal`, `pkt24`, `slot`, `tag`

### `Hrz_BuildHorizon__FP13DRender_tView` (0x800d131c, hrzsku.cpp:2398, map=exact)
...
### `Hud_BuildF4o__FP7POLY_F4iiiiiUlScSc` (0x800d2794, hud.cpp:596, map=exact)

- Extra source locals: `uVar1`, `uVar2`, `uVar3`, `uVar4`

### `Hud_FBuildGT4__FP13HudPmx_tShapeiiUl` (0x800d2868, hud.cpp:620, map=exact)

- Extra source locals: `pkt_addr24`, `prev_hi`, `prev_pkt`

### `Hud_FBuildFT4__FP13HudPmx_tShapeiiUl` (0x800d28f4, hud.cpp:639, map=exact)

- Extra source locals: `pkt_addr24`, `prev_hi`, `prev_pkt`

### `Hud_BuildTimeSprites__FP4SPRTPcii` (0x800d2ef8, hud.cpp:927, map=exact)

- Extra source locals: `bVar3`, `bVar4`, `bVar5`, `cVar2`, `n`, `pcVar6`, `uVar7`

### `Hud_Init__Fv` (0x800d302c, hud.cpp:1041, map=exact)

- Extra source locals: `syc`, `sye`

### `Hud_BuildTach__Fi` (0x800d3e94, hud.cpp:1719, map=exact)

- Extra source locals: `clutx`, `pal`, `pal2`, `tachNeedle_p`, `tp3`, `tp9`, `ts1`, `ts3`, `ts4`

### `Hud_BuildString__FPciiiib` (0x800d42c8, hud.cpp:1966, map=exact)

- Extra source locals: `as`, `iw1`, `iw2`, `iw3`, `iw4`, `iw5`

### `Hud_BuildNumbers0__Fi` (0x800d4624, hud.cpp:2281, map=exact)

- Extra source locals: `eSprt`, `etime`, `last`, `p`, `pal`, `pal_2`, `primAddr`, `y_2`

### `Hud_BuildNumbers__Fi` (0x800d4e70, hud.cpp:2832, map=exact)

- Extra source locals: `pal`, `pal_2`, `pal_3`, `xt`

### `Hud_BuildMapMarkers__Fi` (0x800d5ae8, hud.cpp:3317, map=exact)

- Extra source locals: `aiflags`, `car`, `cflags`, `mapx`, `pal`, `pktcell`

### `Hud_BuildWingmanInterface__Fi` (0x800d606c, hud.cpp:3611, map=exact)

- Extra source locals: `fc`, `iconRow`, `now`, `pal`, `two`, `xf`

### `Hud_BuildCdPlayer__Fii` (0x800d63dc, hud.cpp:3917, map=exact)

- Extra source locals: `arg1`, `bVar2`, `dxk`, `i`, `lt`, `lt4`, `scz`, `uVar5`, `wordId`

### `Hud_BuildRadar__Fi` (0x800d6b48, hud.cpp:4328, map=exact)

- Extra source locals: `pal`, `tag`

### `Hud_BuildReplay__Fv` (0x800d7250, hud.cpp:4545, map=exact)

- Extra source locals: `pal`, `palL`, `tSs1`, `tSs1_2`, `tSs1_3`

### `Hud_NextPlayer__Fi` (0x800d754c, hud.cpp:4692, map=exact)

- Extra source locals: `carObj_00`, `iVar1`, `iVar4`, `uVar3`, `uVar5`

### `Hud_NextPlayerNameOrCarOrTime__Fi` (0x800d76b0, hud.cpp:4783, map=exact)

- Extra source locals: `carObj_00`, `iVar1`, `iVar2`, `iVar3`, `uVar4`

### `Hud_RenderMapView__Fv` (0x800d7838, hud.cpp:4854, map=exact)

- Extra source locals: `pal`, `tp`

### `Hud_BlackThinBox__Fiiii` (0x800d7abc, hud.cpp:4937, map=exact)

- Extra source locals: `CORNERWIDTH`, `side_h`, `side_y`, `top_w`, `x_left`, `x_right`, `y_bottom`

### `Hud_Draw321Num__Fiiiiii` (0x800d7ca8, hud.cpp:4967, map=exact)

- Extra source locals: `arg4`, `arg5`, `by2`

### `Hud_Render321Go__Fv` (0x800d7e64, hud.cpp:5175, map=exact)

- Extra source locals: `flare_intensity_00`, `num_00`, `uVar1`, `y_00`

### `Hud_RenderHudView__Fv` (0x800d82d0, hud.cpp:5377, map=exact)

- Extra source locals: `cdshow`, `otmask`, `pal`, `pw`, `tagp`, `tpageOff`, `viewOff`, `viewp`, `ww2p1`

### `Hud_RenderTacView__Fv` (0x800d8c48, hud.cpp:5885, map=exact)

- Extra source locals: `dh`, `j4`, `pal`, `tp`

### `Hud_ParseTime__FiPc` (0x800d8d64, hud.cpp:5940, map=exact)

- Extra source locals: `centi_total`, `iVar1`, `min`, `sec`

### `Hud_Render__Fv` (0x800d9058, hud.cpp:6000, map=exact)

- Extra source locals: `iface`, `j`, `remain`

### `Hud_PositionMap__Fv` (0x800d94c0, hud.cpp:6153, map=exact)

- Extra source locals: `track`

### `Hud_BustedOverlayOn__FiPcbs` (0x800d962c, hud.cpp:6183, map=exact)

- Extra source locals: `iVar2`, `iVar4`, `pcVar1`, `psVar3`

### `Hud_Reset__Fv` (0x800d97f0, hud.cpp:6265, map=exact)

- Extra source locals: `iVar2`, `psVar1`

### `Hud_BTC_QuitOut__Fv` (0x800d9848, hud.cpp:6293, map=exact)

- Extra source locals: `name_tail`, `perp_idx`, `row_base`, `row_off`, `slot_i`

### `Hud_Perp_OverlayOff__Fi` (0x800d9950, hud.cpp:6336, map=exact)
...
### `Night_SetEnviroment__FP13DRender_tView` (0x800dc0a8, night.cpp:1406, map=exact)
