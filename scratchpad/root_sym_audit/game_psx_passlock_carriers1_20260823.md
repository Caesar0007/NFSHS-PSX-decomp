...
- Declaration-clean mapped functions: 234
- Missing SYM names: 0
- Extra source-local names: 844
...
- Explicit source-only codegen carriers: 18
...
- Extra source locals: `iVar2`, `pDVar3`

### `Draw_StartRenderingView__Fi` (0x800be060, draw.cpp:347, map=exact)

- Extra source locals: `iVar1`

### `Draw_StopRenderingView__Fi` (0x800be118, draw.cpp:407, map=exact)

- Extra source locals: `pal`

### `Draw_StartFrameRender__Fv` (0x800be2c0, draw.cpp:488, map=exact)

- Extra source locals: `pDVar4`

### `Draw_StopFrameRender__Fv` (0x800be36c, draw.cpp:553, map=exact)
