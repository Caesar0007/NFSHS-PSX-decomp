...
- Declaration-clean mapped functions: 261
- Missing SYM names: 0
- Extra source-local names: 779
...
- Explicit source-only codegen carriers: 82
...
- Extra source locals: `controller`, `uVar3`
...
- `Force_Update__FP8Car_tObj`: `clamped`
- `Font_SetABR__Fi`: `y`
...
- `Texture_CheckForSharedPalette__FiPcP12Draw_tPixMapi`: `count`
