...
- Declaration-clean mapped functions: 263
- Missing SYM names: 0
...
- Explicit source-only codegen carriers: 92
...
- `Sfx_BuildSouffleFacet__FP13DRender_tViewP17Souffle_tISouffle`: `link`, `m`, `ot2`, `p0f`, `p1f`, `p2f`, `p3f`, `w`
