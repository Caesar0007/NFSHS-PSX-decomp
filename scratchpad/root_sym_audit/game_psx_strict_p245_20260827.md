...
Target: `C:\Temp\nfs4-sym-next-20260825\recon\game\psx`
...
- Declaration-clean mapped functions: 390
- Missing SYM names: 0
- Extra source-local names: 9
...
- Explicit source-only codegen carriers: 386
...
- Missing/extra global definitions: 0/54
...
- Explicit measured global array carriers: 11
- Explicit oracle-proven global type overrides: 0

## Review queue

### `DrawC_PrimStart__FP12Draw_tVertexP8Car_tObjiP13Draw_CarCache` (0x800bed44, drawc.cpp:658, map=exact)

- Extra source locals: `byteOffset`, `envMapOffset`, `ev`, `pos`

### `DrawObjectSimple__FP13DRender_tViewP11Draw_DCacheP13Trk_ObjectDefP8coorddefi` (0x800c8214, draww.cpp:4237, map=exact)

- Extra source locals: `offsetArg`

### `Hud_Init__Fv` (0x800d302c, hud.cpp:956, map=exact)

- Extra source locals: `g4`, `one`

### `Weather_Init__Fv` (0x800e2530, weather.cpp:511, map=exact)

- Extra source locals: `cameraWords`

### `Weather_DoWeather__FP13DRender_tView` (0x800e3a1c, weather.cpp:1507, map=exact)

- Extra source locals: `wdp`
...
- `DrawC_PrimClip__FP10matrixtdefP8coorddefP16Transformer_zObjP20Transformer_zOverlayiP13Draw_CarCache`: `envmapUV_dst`, `facetValue`, `ff`, `hi`, `overlayRaw`, `u1`, `u2`, `u2_00`, `uvk`, `vt1`, `vt2`, `vt2_00`
...
- `DrawObjectSimple__FP13DRender_tViewP11Draw_DCacheP13Trk_ObjectDefP8coorddefi`: `drawResult`, `isCullable`, `m`, `posX`, `posY`, `posZ`, `stack`, `tX`, `tY`, `tZ`
...
- `Weather_DoWeather__FP13DRender_tView`: `addr24`, `cm`, `deferred`, `mode`, `next`, `one`, `pal`, `palw`, `plb`
- `textnpixels`: `fontbase`
- `Fe3D_InitShowroom__Fv`: `cos_raw`, `iVar1`
...
- `night.cpp` extra definitions: `D_8013D9F4`, `D_8013DA50`, `D_8013DA8C`
...
- `weather.cpp` extra definitions: `Weather_gDrawnServer1`, `Weather_gPServer1`, `Weather_gPrevPServer1`, `Weather_gSplatInfoServer1`
