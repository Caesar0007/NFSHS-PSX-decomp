...
- Explicit source-only codegen carriers: 395
...
- Explicit source-only global/data-layout carriers: 15
...
- `Hrz_BuildHorizon__FP13DRender_tView`: `c1`, `ch`, `cw`, `fo`, `iVar15`, `iVar18`, `iv`, `m24`, `pSVar12`, `pal`, `pp`, `q`, `shape_idx`, `shape_visible`
...
- `Weather_Init__Fv`: `cameraWords`, `pmVar4`, `pmVar5`
...
- `hrzsku.cpp` explicit source-only global/data-layout carriers: `Hrz_gLightningPosInSky_pad`, `Hrz_gLightningPosInSky_vx`, `Hrz_gLightningPosInSky_vy`, `Hrz_gLightningPosInSky_vz`
- `loading.cpp` explicit source-only global/data-layout carriers: `D_8013D9D4`
- `night.cpp` explicit source-only global/data-layout carriers: `D_8013D9F4`, `D_8013DA50`, `D_8013DA8C`
- `overlays.cpp` explicit source-only global/data-layout carriers: `D_8013D99C`
- `platform.cpp` explicit source-only global/data-layout carriers: `D_8013DAA0`
- `textureprocess.cpp` explicit source-only global/data-layout carriers: `D_8013DB84`
- `weather.cpp` explicit source-only global/data-layout carriers: `Weather_gDrawnServer1`, `Weather_gPServer1`, `Weather_gPrevPServer1`, `Weather_gSplatInfoServer1`
