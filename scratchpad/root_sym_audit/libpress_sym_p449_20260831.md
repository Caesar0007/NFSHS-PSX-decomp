...
Target: `C:\Temp\nfs4-sym-next-20260825\recon\syslib\psx\libpress`
...
- Compact address-only data records mapped by exact name+VA: 4
- Mapped source global definitions: 4
- Special SYM vtable records mapped: 0/0
- Blob-backed object globals: 0
- Missing/extra global definitions: 0/14
...
- `table.c` compact address-only definitions: `CF2_DVLC`, `CF_DVLC`, `DCC_DVLC`, `DCL_DVLC`
- `libpress.c` extra definitions: `D0_BCR_ptr`, `D0_CHCR_ptr`, `D0_MADR_ptr`, `D1_BCR_ptr`, `D1_CHCR_ptr`, `D1_MADR_ptr`, `DPCR_ptr`, `MDEC0_ptr`, `MDEC1_ptr`, `_mdec_idcttab`, `_mdec_iqtab`
- `vlc.c` extra definitions: `_vlc_blksize`, `_vlc_end`, `_vlc_state`
