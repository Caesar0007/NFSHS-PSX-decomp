...
Target: `C:\Temp\nfs4-sym-next-20260825\recon\syslib\psx\libsn`
...
- Compact address-only data records mapped by exact name+VA: 2
- Mapped source global definitions: 2
...
- `sndef.c` compact address-only definitions: `_ramsize`, `_stacksize`
