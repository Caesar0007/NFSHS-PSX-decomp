/* syslib/psx/libcd/cdtables.c -- RECONSTRUCTED from nfs4-f.exe (.data materialised from the EXE).
 ...
 * inside extern {} (which only sets C naming), so without it the symbol is
