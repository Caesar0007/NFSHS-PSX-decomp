...
$Lvs2_36:
	...
	bne	$2,$0,$Lvs2_30
	.def	error;	.val	$Lvs2_29;	.scl	6;	.type	0x0;	.endef
$Lvs2_29:
 #APP
 #NO_APP
	lui	$2,%hi(_cdr) # high
...
$Lnosplit3_42:
	...
	subu	$2,$2,$17
	sltu	$2,$2,121
	beq	$2,$0,$Lnosplit3_52
	#.set	volatile
	lw	$2,0($16)
	#.set	novolatile
	#nop
	bne	$2,$0,$Lnosplit3_42
$Lnosplit3_39:
	la	$4,_cdr
 #APP
 #NO_APP
...
$L55:
	...
	slt	$3,$3,$2
	beq	$3,$0,$L63
	.def	reissue;	.val	$L61;	.scl	6;	.type	0x0;	.endef
$L61:
	.set	noreorder
	.set	nomacro
	jal	_read_issue
	...
	#.set	novolatile
	j	$L64
	.def	still;	.val	$L63;	.scl	6;	.type	0x0;	.endef
$L63:
	#.set	volatile
	lw	$16,-8($17)
	#.set	novolatile
	.def	check;	.val	$L64;	.scl	6;	.type	0x0;	.endef
$L64:
	.set	noreorder
	.set	nomacro
	bne	$19,$0,$L71
