...
$L184:
	...
	ori	$4,$4,0xffff
	li	$7,0x03ff0000		# 67043328
	la	$6,D_8013EAD8
	and	$2,$6,$5
	li	$3,0x08000000		# 134217728
	or	$2,$2,$3
	li	$16,-486539264			# 0xe3000000
	li	$17,-452984832			# 0xe5000000
	sw	$2,_blit_buf
	li	$2,-436207616			# 0xe6000000
	and	$5,$9,$5
...
$L212:
	lw	$3,GPU_GP1
	li	$2,0x04000000		# 67108864
	#.set	volatile
	sw	$2,0($3)
	#.set	novolatile
	lw	$3,GPU_GP0
	li	$2,0x01000000		# 16777216
	#.set	volatile
	sw	$2,0($3)
	#.set	novolatile
	lw	$2,GPU_GP0
...
$L358:
	...
	.lcomm	_q_saved_mask,4

	.lcomm	_drain_saved_mask,4

	.lcomm	_q_reset_mask,4

	.lcomm	_gpu_timeout_target,4

	.lcomm	_gpu_timeout_count,4
