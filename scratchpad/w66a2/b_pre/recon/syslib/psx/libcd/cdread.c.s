...
$Lvs7_36:
	...
	bne	$2,$0,$Lvs7_30
	.def	error;	.val	$Lvs7_29;	.scl	6;	.type	0x0;	.endef
$Lvs7_29:
 #APP
 #NO_APP
	lui	$2,%hi(_cdr) # high
...
$Lnosplit8_42:
	...
	subu	$2,$2,$17
	sltu	$2,$2,121
	beq	$2,$0,$Lnosplit8_52
	#.set	volatile
	lw	$2,0($16)
	#.set	novolatile
	#nop
	bne	$2,$0,$Lnosplit8_42
$Lnosplit8_39:
	la	$4,_cdr
 #APP
 #NO_APP
