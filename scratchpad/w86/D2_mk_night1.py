...
OLD = ('    /* W80 QTY_CMP_PRI dial: five zero-byte refs are the minimal whole-step crossing\n'
...
NEW = ('    /* W80 QTY_CMP_PRI dial: five zero-byte refs are the minimal whole-step crossing\n'
       '     * for tgt (7/18) over zn2 (3/4); four refs only tie at 0.7500 and stay FAIL.\n'
...
pathlib.Path('scratchpad/w86/D2_n1.txt').write_text(
    repr([('night 5 devices -> 1', [(OLD, NEW)])]))
print('ok')
