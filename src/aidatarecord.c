...
/* AIDataRecord_t collection + AccTable/CurveSpeedTable/TrackCurve/BestLine classes.
 * 21 standalone fns (the 5 trivial dtors/CarTracking::Get were inlined in the original). */
...
INCLUDE_ASM("asm/nonmatchings/main", CleanUp2__14AIDataRecord_t);
