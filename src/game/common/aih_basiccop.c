...
INCLUDE_ASM("asm/nonmatchings/main", Blockade_AddRoadFlare__FP8coorddef);
INCLUDE_ASM("asm/nonmatchings/main", Blockade_AddObject__FiP8coorddefi);
INCLUDE_ASM("asm/nonmatchings/main", PlacePointOnRoad__FiP8coorddef);
...
INCLUDE_ASM("asm/nonmatchings/main", ___15AIHigh_BasicCop);
