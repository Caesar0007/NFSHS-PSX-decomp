...
PER_TU_FLAGS = {
    "recon/frontend/common/screentracks.cpp": {"no_implement_inlines": True},   # FEVIRT-NII-PROBE
    "recon/frontend/common/fedialog.cpp": {"no_implement_inlines": True},   # FEVIRT-NII-PROBE
    ...
    "recon/game/common/replay.cpp": {"cc1plus_ver": "2.8.1-sn", "g_value": "8"},   # trial 2026-09-17: StatsTimer[2] bare-macro stores need it small
    ...
    "recon/game/common/anim.cpp":          {"g_value": "8"},
    ...
    "recon/syslib/psx/libapi/PAD.c":       {"g_value": "0"},   # Sony libapi: owns _init_pad_flag + pad MMIO pointers, .data @0x8013c338 (2026-09-19)
