...
| Per-object type records | `tagset_cmp.py` (per source file: retail vs ours STRTAG/UNTAG/ENTAG/TPDEF sets and per-kind order; `--core` lists the retail-universal core that `recon/nfs4_types.h` holds; `--file X` details one file) | `sym-match.md` |
